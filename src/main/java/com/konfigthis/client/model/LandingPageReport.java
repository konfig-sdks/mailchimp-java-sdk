...
import com.konfigthis.client.model.LandingPageReportTimeseries;
...
public class LandingPageReport {
  ...
  **/
  ...
  public LandingPageReport ecommerce(ReportingGetLandingPageReportResponseEcommerce ecommerce) {
  ...
  **/
   ...
   * @return the LandingPageReport instance itself
   */
  public LandingPageReport putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, landingPageReport.title) &&
        Objects.equals(this.id, landingPageReport.id) &&
        ...
        Objects.equals(this.additionalProperties, landingPageReport.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LandingPageReport
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LandingPageReport.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LandingPageReport is not found in the empty JSON string", LandingPageReport.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("timeseries") != null && !jsonObj.get("timeseries").isJsonNull()) {
        LandingPageReportTimeseries.validateJsonObject(jsonObj.getAsJsonObject("timeseries"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LandingPageReport.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LandingPageReport' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LandingPageReport> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LandingPageReport.class));

       return (TypeAdapter<T>) new TypeAdapter<LandingPageReport>() {
           @Override
           public void write(JsonWriter out, LandingPageReport value) throws IOException {
           ...
           @Override
           public LandingPageReport read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LandingPageReport instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LandingPageReport given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LandingPageReport
  * @throws IOException if the JSON string is invalid with respect to LandingPageReport
  */
  public static LandingPageReport fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LandingPageReport.class);
  }

 /**
  * Convert an instance of LandingPageReport to an JSON string
  *
  * @return JSON string
  */
