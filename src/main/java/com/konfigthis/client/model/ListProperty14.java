...
import com.konfigthis.client.model.SegmentOptionsProperty8;
...
public class ListProperty14 {
  ...
  private SegmentOptionsProperty8 segmentOpts;

  public ListProperty14() {
  }
  ...
  public ListProperty14 listId(String listId) {
  ...
  **/
  ...
  public ListProperty14 segmentOpts(SegmentOptionsProperty8 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty8 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty8 segmentOpts) {
   ...
   * @return the ListProperty14 instance itself
   */
  public ListProperty14 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty14 listProperty14 = (ListProperty14) o;
    return Objects.equals(this.listId, listProperty14.listId) &&
        Objects.equals(this.listIsActive, listProperty14.listIsActive) &&
        Objects.equals(this.listName, listProperty14.listName) &&
        Objects.equals(this.segmentText, listProperty14.segmentText) &&
        Objects.equals(this.recipientCount, listProperty14.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty14.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty14.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty14 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty14
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty14.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty14 is not found in the empty JSON string", ListProperty14.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty8.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty14.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty14>() {
           @Override
           public void write(JsonWriter out, ListProperty14 value) throws IOException {
           ...
           @Override
           public ListProperty14 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty14 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty14 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty14
  * @throws IOException if the JSON string is invalid with respect to ListProperty14
  */
  public static ListProperty14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty14.class);
  }

 /**
  * Convert an instance of ListProperty14 to an JSON string
  *
  * @return JSON string
  */
