...
public class EcommerceGetCartLineItem200Response {
  ...
  public EcommerceGetCartLineItem200Response() {
  }
  ...
  **/
  ...
  public EcommerceGetCartLineItem200Response productId(String productId) {
  ...
  **/
  ...
  public EcommerceGetCartLineItem200Response productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceGetCartLineItem200Response quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceGetCartLineItem200Response price(Double price) {
  ...
  public EcommerceGetCartLineItem200Response price(Integer price) {
  ...
  **/
   ...
   * @return the EcommerceGetCartLineItem200Response instance itself
   */
  public EcommerceGetCartLineItem200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceGetCartLineItem200Response ecommerceGetCartLineItem200Response = (EcommerceGetCartLineItem200Response) o;
    return Objects.equals(this.id, ecommerceGetCartLineItem200Response.id) &&
        Objects.equals(this.productId, ecommerceGetCartLineItem200Response.productId) &&
        Objects.equals(this.productTitle, ecommerceGetCartLineItem200Response.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceGetCartLineItem200Response.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceGetCartLineItem200Response.productVariantTitle) &&
        Objects.equals(this.quantity, ecommerceGetCartLineItem200Response.quantity) &&
        Objects.equals(this.price, ecommerceGetCartLineItem200Response.price) &&
        Objects.equals(this.links, ecommerceGetCartLineItem200Response.links)&&
        Objects.equals(this.additionalProperties, ecommerceGetCartLineItem200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceGetCartLineItem200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceGetCartLineItem200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceGetCartLineItem200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceGetCartLineItem200Response is not found in the empty JSON string", EcommerceGetCartLineItem200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceGetCartLineItem200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceGetCartLineItem200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceGetCartLineItem200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceGetCartLineItem200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceGetCartLineItem200Response>() {
           @Override
           public void write(JsonWriter out, EcommerceGetCartLineItem200Response value) throws IOException {
           ...
           @Override
           public EcommerceGetCartLineItem200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceGetCartLineItem200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceGetCartLineItem200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceGetCartLineItem200Response
  * @throws IOException if the JSON string is invalid with respect to EcommerceGetCartLineItem200Response
  */
  public static EcommerceGetCartLineItem200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceGetCartLineItem200Response.class);
  }

 /**
  * Convert an instance of EcommerceGetCartLineItem200Response to an JSON string
  *
  * @return JSON string
  */
