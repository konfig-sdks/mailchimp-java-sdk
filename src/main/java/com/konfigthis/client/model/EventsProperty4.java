...
public class EventsProperty4 {
  ...
  public EventsProperty4() {
  }

  public EventsProperty4 subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty4 unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty4 profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty4 cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty4 upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty4 campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty4 instance itself
   */
  public EventsProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty4 eventsProperty4 = (EventsProperty4) o;
    return Objects.equals(this.subscribe, eventsProperty4.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty4.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty4.profile) &&
        Objects.equals(this.cleaned, eventsProperty4.cleaned) &&
        Objects.equals(this.upemail, eventsProperty4.upemail) &&
        Objects.equals(this.campaign, eventsProperty4.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty4 is not found in the empty JSON string", EventsProperty4.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty4>() {
           @Override
           public void write(JsonWriter out, EventsProperty4 value) throws IOException {
           ...
           @Override
           public EventsProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty4
  * @throws IOException if the JSON string is invalid with respect to EventsProperty4
  */
  public static EventsProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty4.class);
  }

 /**
  * Convert an instance of EventsProperty4 to an JSON string
  *
  * @return JSON string
  */
