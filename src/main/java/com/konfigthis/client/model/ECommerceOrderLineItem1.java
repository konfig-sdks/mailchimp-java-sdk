...
public class ECommerceOrderLineItem1 {
  ...
  **/
  ...
  public ECommerceOrderLineItem1 price(Double price) {
  ...
  public ECommerceOrderLineItem1 price(Integer price) {
  ...
  **/
  ...
  public ECommerceOrderLineItem1 discount(Double discount) {
  ...
  public ECommerceOrderLineItem1 discount(Integer discount) {
  ...
  **/
   ...
   * @return the ECommerceOrderLineItem1 instance itself
   */
  public ECommerceOrderLineItem1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.productId, eCommerceOrderLineItem1.productId) &&
        ...
        Objects.equals(this.additionalProperties, eCommerceOrderLineItem1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceOrderLineItem1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceOrderLineItem1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceOrderLineItem1 is not found in the empty JSON string", ECommerceOrderLineItem1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceOrderLineItem1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceOrderLineItem1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceOrderLineItem1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceOrderLineItem1.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceOrderLineItem1>() {
           @Override
           public void write(JsonWriter out, ECommerceOrderLineItem1 value) throws IOException {
           ...
           @Override
           public ECommerceOrderLineItem1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceOrderLineItem1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceOrderLineItem1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceOrderLineItem1
  * @throws IOException if the JSON string is invalid with respect to ECommerceOrderLineItem1
  */
  public static ECommerceOrderLineItem1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceOrderLineItem1.class);
  }

 /**
  * Convert an instance of ECommerceOrderLineItem1 to an JSON string
  *
  * @return JSON string
  */
