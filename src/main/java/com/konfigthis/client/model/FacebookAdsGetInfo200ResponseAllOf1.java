...
public class FacebookAdsGetInfo200ResponseAllOf1 {
  ...
  public FacebookAdsGetInfo200ResponseAllOf1() {
  }

  public FacebookAdsGetInfo200ResponseAllOf1 isConnected(Boolean isConnected) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 hasAudience(Boolean hasAudience) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 hasContent(Boolean hasContent) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 channel(FacebookAdsGetInfo200ResponseAllOf1Channel channel) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 feedback(FacebookAdsGetInfoResponseAllOf2Feedback feedback) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 site(FacebookAdsGetInfo200ResponseAllOf1Site site) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 audience(FacebookAdsGetInfoResponseAllOf2Audience audience) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 budget(FacebookAdsGetInfo200ResponseAllOf1Budget budget) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf1 content(FacebookAdsGetInfoResponseAllOf2Content content) {
  ...
  **/
   ...
   * @return the FacebookAdsGetInfo200ResponseAllOf1 instance itself
   */
  public FacebookAdsGetInfo200ResponseAllOf1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FacebookAdsGetInfo200ResponseAllOf1 facebookAdsGetInfo200ResponseAllOf1 = (FacebookAdsGetInfo200ResponseAllOf1) o;
    return Objects.equals(this.isConnected, facebookAdsGetInfo200ResponseAllOf1.isConnected) &&
        Objects.equals(this.hasAudience, facebookAdsGetInfo200ResponseAllOf1.hasAudience) &&
        Objects.equals(this.hasContent, facebookAdsGetInfo200ResponseAllOf1.hasContent) &&
        Objects.equals(this.channel, facebookAdsGetInfo200ResponseAllOf1.channel) &&
        Objects.equals(this.feedback, facebookAdsGetInfo200ResponseAllOf1.feedback) &&
        Objects.equals(this.site, facebookAdsGetInfo200ResponseAllOf1.site) &&
        Objects.equals(this.audience, facebookAdsGetInfo200ResponseAllOf1.audience) &&
        Objects.equals(this.budget, facebookAdsGetInfo200ResponseAllOf1.budget) &&
        Objects.equals(this.content, facebookAdsGetInfo200ResponseAllOf1.content)&&
        Objects.equals(this.additionalProperties, facebookAdsGetInfo200ResponseAllOf1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FacebookAdsGetInfo200ResponseAllOf1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FacebookAdsGetInfo200ResponseAllOf1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FacebookAdsGetInfo200ResponseAllOf1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FacebookAdsGetInfo200ResponseAllOf1 is not found in the empty JSON string", FacebookAdsGetInfo200ResponseAllOf1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FacebookAdsGetInfo200ResponseAllOf1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FacebookAdsGetInfo200ResponseAllOf1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FacebookAdsGetInfo200ResponseAllOf1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FacebookAdsGetInfo200ResponseAllOf1.class));

       return (TypeAdapter<T>) new TypeAdapter<FacebookAdsGetInfo200ResponseAllOf1>() {
           @Override
           public void write(JsonWriter out, FacebookAdsGetInfo200ResponseAllOf1 value) throws IOException {
           ...
           @Override
           public FacebookAdsGetInfo200ResponseAllOf1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FacebookAdsGetInfo200ResponseAllOf1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FacebookAdsGetInfo200ResponseAllOf1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FacebookAdsGetInfo200ResponseAllOf1
  * @throws IOException if the JSON string is invalid with respect to FacebookAdsGetInfo200ResponseAllOf1
  */
  public static FacebookAdsGetInfo200ResponseAllOf1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FacebookAdsGetInfo200ResponseAllOf1.class);
  }

 /**
  * Convert an instance of FacebookAdsGetInfo200ResponseAllOf1 to an JSON string
  *
  * @return JSON string
  */
