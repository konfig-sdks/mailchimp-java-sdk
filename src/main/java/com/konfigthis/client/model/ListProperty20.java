...
import com.konfigthis.client.model.SegmentOptionsProperty14;
...
public class ListProperty20 {
  ...
  private SegmentOptionsProperty14 segmentOpts;

  public ListProperty20() {
  }
  ...
  public ListProperty20 listId(String listId) {
  ...
  **/
  ...
  public ListProperty20 segmentOpts(SegmentOptionsProperty14 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty14 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty14 segmentOpts) {
   ...
   * @return the ListProperty20 instance itself
   */
  public ListProperty20 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty20 listProperty20 = (ListProperty20) o;
    return Objects.equals(this.listId, listProperty20.listId) &&
        Objects.equals(this.listIsActive, listProperty20.listIsActive) &&
        Objects.equals(this.listName, listProperty20.listName) &&
        Objects.equals(this.segmentText, listProperty20.segmentText) &&
        Objects.equals(this.recipientCount, listProperty20.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty20.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty20.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty20 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty20
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty20.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty20 is not found in the empty JSON string", ListProperty20.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty14.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty20.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty20' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty20> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty20.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty20>() {
           @Override
           public void write(JsonWriter out, ListProperty20 value) throws IOException {
           ...
           @Override
           public ListProperty20 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty20 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty20 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty20
  * @throws IOException if the JSON string is invalid with respect to ListProperty20
  */
  public static ListProperty20 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty20.class);
  }

 /**
  * Convert an instance of ListProperty20 to an JSON string
  *
  * @return JSON string
  */
