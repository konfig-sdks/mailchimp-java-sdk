...
public class SurveyReport1 {
  ...
  **/
   ...
   * @return the SurveyReport1 instance itself
   */
  public SurveyReport1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SurveyReport1 surveyReport1 = (SurveyReport1) o;
    return Objects.equals(this.title, surveyReport1.title) &&
        Objects.equals(this.id, surveyReport1.id) &&
        Objects.equals(this.webId, surveyReport1.webId) &&
        Objects.equals(this.listId, surveyReport1.listId) &&
        Objects.equals(this.listName, surveyReport1.listName) &&
        Objects.equals(this.url, surveyReport1.url) &&
        Objects.equals(this.status, surveyReport1.status) &&
        Objects.equals(this.publishedAt, surveyReport1.publishedAt) &&
        Objects.equals(this.createdAt, surveyReport1.createdAt) &&
        Objects.equals(this.updatedAt, surveyReport1.updatedAt) &&
        Objects.equals(this.totalResponses, surveyReport1.totalResponses)&&
        Objects.equals(this.additionalProperties, surveyReport1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SurveyReport1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SurveyReport1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SurveyReport1 is not found in the empty JSON string", SurveyReport1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SurveyReport1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SurveyReport1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SurveyReport1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SurveyReport1.class));

       return (TypeAdapter<T>) new TypeAdapter<SurveyReport1>() {
           @Override
           public void write(JsonWriter out, SurveyReport1 value) throws IOException {
           ...
           @Override
           public SurveyReport1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SurveyReport1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SurveyReport1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SurveyReport1
  * @throws IOException if the JSON string is invalid with respect to SurveyReport1
  */
  public static SurveyReport1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SurveyReport1.class);
  }

 /**
  * Convert an instance of SurveyReport1 to an JSON string
  *
  * @return JSON string
  */
