...
import com.konfigthis.client.model.SegmentOptions1;
...
public class Recipients1 {
  ...
  public Recipients1 listId(String listId) {
  ...
  **/
  ...
  public Recipients1 segmentOpts(SegmentOptions1 segmentOpts) {
  ...
  **/
   ...
   * @return the Recipients1 instance itself
   */
  public Recipients1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Recipients1 recipients1 = (Recipients1) o;
    return Objects.equals(this.listId, recipients1.listId) &&
        Objects.equals(this.listIsActive, recipients1.listIsActive) &&
        Objects.equals(this.listName, recipients1.listName) &&
        Objects.equals(this.segmentText, recipients1.segmentText) &&
        Objects.equals(this.recipientCount, recipients1.recipientCount) &&
        Objects.equals(this.segmentOpts, recipients1.segmentOpts)&&
        Objects.equals(this.additionalProperties, recipients1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Recipients1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Recipients1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Recipients1 is not found in the empty JSON string", Recipients1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptions1.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Recipients1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Recipients1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Recipients1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Recipients1.class));

       return (TypeAdapter<T>) new TypeAdapter<Recipients1>() {
           @Override
           public void write(JsonWriter out, Recipients1 value) throws IOException {
           ...
           @Override
           public Recipients1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Recipients1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Recipients1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Recipients1
  * @throws IOException if the JSON string is invalid with respect to Recipients1
  */
  public static Recipients1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Recipients1.class);
  }

 /**
  * Convert an instance of Recipients1 to an JSON string
  *
  * @return JSON string
  */
