...
import com.konfigthis.client.model.ECommerceReportProperty6;
...
public class CampaignReport3 {
  ...
  private ECommerceReportProperty6 ecommerce;
  ...
  public CampaignReport3 id(String id) {
  ...
  **/
  ...
  public CampaignReport3 type(String type) {
  ...
  **/
  ...
  public CampaignReport3 previewText(String previewText) {
  ...
  **/
  ...
  public CampaignReport3 emailsSent(Integer emailsSent) {
  ...
  **/
  ...
  public CampaignReport3 abuseReports(Integer abuseReports) {
  ...
  **/
  ...
  public CampaignReport3 bounces(BouncesProperty bounces) {
  ...
  **/
  ...
  public CampaignReport3 forwards(ForwardsProperty forwards) {
  ...
  **/
  ...
  public CampaignReport3 opens(OpensProperty opens) {
  ...
  **/
  ...
  public CampaignReport3 clicks(ClicksProperty clicks) {
  ...
  **/
  ...
  public CampaignReport3 facebookLikes(FacebookLikesProperty facebookLikes) {
  ...
  **/
  ...
  public CampaignReport3 industryStats(IndustryStatsProperty1 industryStats) {
  ...
  **/
  ...
  public CampaignReport3 listStats(ListStatsProperty listStats) {
  ...
  **/
  ...
  public CampaignReport3 abSplit(ABSplitStatsProperty abSplit) {
  ...
  **/
  ...
  public CampaignReport3 timewarp(List<TimewarpStatsPropertyInner> timewarp) {
  ...
  public CampaignReport3 addTimewarpItem(TimewarpStatsPropertyInner timewarpItem) {
  ...
  **/
  ...
  public CampaignReport3 timeseries(List<TimeseriesPropertyInner> timeseries) {
  ...
  public CampaignReport3 addTimeseriesItem(TimeseriesPropertyInner timeseriesItem) {
  ...
  **/
  ...
  public CampaignReport3 shareReport(ShareReportProperty shareReport) {
  ...
  **/
  ...
  public CampaignReport3 ecommerce(ECommerceReportProperty6 ecommerce) {
  ...
  **/
  ...
  public ECommerceReportProperty6 getEcommerce() {
    return ecommerce;
  }


  public void setEcommerce(ECommerceReportProperty6 ecommerce) {
  ...
  public CampaignReport3 deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
   ...
   * @return the CampaignReport3 instance itself
   */
  public CampaignReport3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignReport3 campaignReport3 = (CampaignReport3) o;
    return Objects.equals(this.id, campaignReport3.id) &&
        Objects.equals(this.campaignTitle, campaignReport3.campaignTitle) &&
        Objects.equals(this.type, campaignReport3.type) &&
        Objects.equals(this.listId, campaignReport3.listId) &&
        Objects.equals(this.listIsActive, campaignReport3.listIsActive) &&
        Objects.equals(this.listName, campaignReport3.listName) &&
        Objects.equals(this.subjectLine, campaignReport3.subjectLine) &&
        Objects.equals(this.previewText, campaignReport3.previewText) &&
        Objects.equals(this.emailsSent, campaignReport3.emailsSent) &&
        Objects.equals(this.abuseReports, campaignReport3.abuseReports) &&
        Objects.equals(this.unsubscribed, campaignReport3.unsubscribed) &&
        Objects.equals(this.sendTime, campaignReport3.sendTime) &&
        Objects.equals(this.rssLastSend, campaignReport3.rssLastSend) &&
        Objects.equals(this.bounces, campaignReport3.bounces) &&
        Objects.equals(this.forwards, campaignReport3.forwards) &&
        Objects.equals(this.opens, campaignReport3.opens) &&
        Objects.equals(this.clicks, campaignReport3.clicks) &&
        Objects.equals(this.facebookLikes, campaignReport3.facebookLikes) &&
        Objects.equals(this.industryStats, campaignReport3.industryStats) &&
        Objects.equals(this.listStats, campaignReport3.listStats) &&
        Objects.equals(this.abSplit, campaignReport3.abSplit) &&
        Objects.equals(this.timewarp, campaignReport3.timewarp) &&
        Objects.equals(this.timeseries, campaignReport3.timeseries) &&
        Objects.equals(this.shareReport, campaignReport3.shareReport) &&
        Objects.equals(this.ecommerce, campaignReport3.ecommerce) &&
        Objects.equals(this.deliveryStatus, campaignReport3.deliveryStatus) &&
        Objects.equals(this.links, campaignReport3.links)&&
        Objects.equals(this.additionalProperties, campaignReport3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignReport3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignReport3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignReport3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignReport3 is not found in the empty JSON string", CampaignReport3.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("ecommerce") != null && !jsonObj.get("ecommerce").isJsonNull()) {
        ECommerceReportProperty6.validateJsonObject(jsonObj.getAsJsonObject("ecommerce"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignReport3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignReport3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignReport3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignReport3.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignReport3>() {
           @Override
           public void write(JsonWriter out, CampaignReport3 value) throws IOException {
           ...
           @Override
           public CampaignReport3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignReport3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignReport3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignReport3
  * @throws IOException if the JSON string is invalid with respect to CampaignReport3
  */
  public static CampaignReport3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignReport3.class);
  }

 /**
  * Convert an instance of CampaignReport3 to an JSON string
  *
  * @return JSON string
  */
