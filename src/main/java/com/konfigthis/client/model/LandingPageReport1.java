...
import com.konfigthis.client.model.LandingPageReport1Timeseries;
...
public class LandingPageReport1 {
  ...
  private LandingPageReport1Timeseries timeseries;
  ...
  **/
  ...
  public LandingPageReport1 timeseries(LandingPageReport1Timeseries timeseries) {
  ...
  **/
  ...
  public LandingPageReport1Timeseries getTimeseries() {
    return timeseries;
  }


  public void setTimeseries(LandingPageReport1Timeseries timeseries) {
  ...
  public LandingPageReport1 ecommerce(ReportingGetLandingPageReportResponseEcommerce ecommerce) {
  ...
  **/
   ...
   * @return the LandingPageReport1 instance itself
   */
  public LandingPageReport1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, landingPageReport1.title) &&
        Objects.equals(this.id, landingPageReport1.id) &&
        ...
        Objects.equals(this.links, landingPageReport1.links)&&
        Objects.equals(this.additionalProperties, landingPageReport1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LandingPageReport1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LandingPageReport1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in LandingPageReport1 is not found in the empty JSON string", LandingPageReport1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("timeseries") != null && !jsonObj.get("timeseries").isJsonNull()) {
        LandingPageReport1Timeseries.validateJsonObject(jsonObj.getAsJsonObject("timeseries"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!LandingPageReport1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'LandingPageReport1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<LandingPageReport1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(LandingPageReport1.class));

       return (TypeAdapter<T>) new TypeAdapter<LandingPageReport1>() {
           @Override
           public void write(JsonWriter out, LandingPageReport1 value) throws IOException {
           ...
           @Override
           public LandingPageReport1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             LandingPageReport1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of LandingPageReport1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of LandingPageReport1
  * @throws IOException if the JSON string is invalid with respect to LandingPageReport1
  */
  public static LandingPageReport1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, LandingPageReport1.class);
  }

 /**
  * Convert an instance of LandingPageReport1 to an JSON string
  *
  * @return JSON string
  */
