...
public class SurveyQuestionReport1 {
  ...
  **/
  ...
  public SurveyQuestionReport1 mergeField(MergeFieldProperty mergeField) {
  ...
  **/
  ...
  public SurveyQuestionReport1 contactCounts(ContactCountsProperty contactCounts) {
  ...
  **/
   ...
   * @return the SurveyQuestionReport1 instance itself
   */
  public SurveyQuestionReport1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SurveyQuestionReport1 surveyQuestionReport1 = (SurveyQuestionReport1) o;
    return Objects.equals(this.id, surveyQuestionReport1.id) &&
        Objects.equals(this.surveyId, surveyQuestionReport1.surveyId) &&
        Objects.equals(this.query, surveyQuestionReport1.query) &&
        Objects.equals(this.type, surveyQuestionReport1.type) &&
        Objects.equals(this.totalResponses, surveyQuestionReport1.totalResponses) &&
        Objects.equals(this.isRequired, surveyQuestionReport1.isRequired) &&
        Objects.equals(this.hasOther, surveyQuestionReport1.hasOther) &&
        Objects.equals(this.otherLabel, surveyQuestionReport1.otherLabel) &&
        Objects.equals(this.averageRating, surveyQuestionReport1.averageRating) &&
        Objects.equals(this.rangeLowLabel, surveyQuestionReport1.rangeLowLabel) &&
        Objects.equals(this.rangeHighLabel, surveyQuestionReport1.rangeHighLabel) &&
        Objects.equals(this.placeholderLabel, surveyQuestionReport1.placeholderLabel) &&
        Objects.equals(this.subscribeCheckboxEnabled, surveyQuestionReport1.subscribeCheckboxEnabled) &&
        Objects.equals(this.subscribeCheckboxLabel, surveyQuestionReport1.subscribeCheckboxLabel) &&
        Objects.equals(this.mergeField, surveyQuestionReport1.mergeField) &&
        Objects.equals(this.options, surveyQuestionReport1.options) &&
        Objects.equals(this.contactCounts, surveyQuestionReport1.contactCounts)&&
        Objects.equals(this.additionalProperties, surveyQuestionReport1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SurveyQuestionReport1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SurveyQuestionReport1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SurveyQuestionReport1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SurveyQuestionReport1 is not found in the empty JSON string", SurveyQuestionReport1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SurveyQuestionReport1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SurveyQuestionReport1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SurveyQuestionReport1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SurveyQuestionReport1.class));

       return (TypeAdapter<T>) new TypeAdapter<SurveyQuestionReport1>() {
           @Override
           public void write(JsonWriter out, SurveyQuestionReport1 value) throws IOException {
           ...
           @Override
           public SurveyQuestionReport1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SurveyQuestionReport1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SurveyQuestionReport1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SurveyQuestionReport1
  * @throws IOException if the JSON string is invalid with respect to SurveyQuestionReport1
  */
  public static SurveyQuestionReport1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SurveyQuestionReport1.class);
  }

 /**
  * Convert an instance of SurveyQuestionReport1 to an JSON string
  *
  * @return JSON string
  */
