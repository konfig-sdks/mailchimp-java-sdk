...
public class SegmentOptionsProperty15 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty15() {
  }

  public SegmentOptionsProperty15 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty15 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty15 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty15 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty15 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty15 instance itself
   */
  public SegmentOptionsProperty15 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty15 segmentOptionsProperty15 = (SegmentOptionsProperty15) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty15.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty15.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty15.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty15.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty15.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty15 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty15
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty15.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty15 is not found in the empty JSON string", SegmentOptionsProperty15.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty15.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty15>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty15 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty15 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty15 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty15 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty15
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty15
  */
  public static SegmentOptionsProperty15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty15.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty15 to an JSON string
  *
  * @return JSON string
  */
