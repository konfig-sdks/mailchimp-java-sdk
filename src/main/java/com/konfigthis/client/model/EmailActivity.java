...
public class EmailActivity {
  ...
  **/
  ...
  public EmailActivity activity(List<MemberActivity2> activity) {
  ...
  public EmailActivity addActivityItem(MemberActivity2 activityItem) {
  ...
  **/
   ...
   * @return the EmailActivity instance itself
   */
  public EmailActivity putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.campaignId, emailActivity.campaignId) &&
        Objects.equals(this.listId, emailActivity.listId) &&
        Objects.equals(this.listIsActive, emailActivity.listIsActive) &&
        Objects.equals(this.emailId, emailActivity.emailId) &&
        Objects.equals(this.emailAddress, emailActivity.emailAddress) &&
        Objects.equals(this.activity, emailActivity.activity) &&
        Objects.equals(this.links, emailActivity.links)&&
        Objects.equals(this.additionalProperties, emailActivity.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to EmailActivity
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EmailActivity.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EmailActivity is not found in the empty JSON string", EmailActivity.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EmailActivity.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EmailActivity' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EmailActivity> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EmailActivity.class));

       return (TypeAdapter<T>) new TypeAdapter<EmailActivity>() {
           @Override
           public void write(JsonWriter out, EmailActivity value) throws IOException {
           ...
           @Override
           public EmailActivity read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EmailActivity instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EmailActivity given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EmailActivity
  * @throws IOException if the JSON string is invalid with respect to EmailActivity
  */
  public static EmailActivity fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EmailActivity.class);
  }

 /**
  * Convert an instance of EmailActivity to an JSON string
  *
  * @return JSON string
  */
