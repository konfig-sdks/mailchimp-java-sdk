...
import com.konfigthis.client.model.SubscriberStatsProperty11;
...
public class ListMembers4 {
 ...
 public enum SmsSubscriptionStatusEnum {
  ...
  private SubscriberStatsProperty11 stats;
  ...
  public ListMembers4 tags(List<TagsPropertyInner> tags) {
  ...
  public ListMembers4 addTagsItem(TagsPropertyInner tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ListMembers4 smsPhoneNumber(String smsPhoneNumber) {
  ...
  **/
  ...
  public ListMembers4 smsSubscriptionStatus(SmsSubscriptionStatusEnum smsSubscriptionStatus) {
  ...
  **/
  ...
  public ListMembers4 smsSubscriptionLastUpdated(String smsSubscriptionLastUpdated) {
  ...
  **/
  ...
  public ListMembers4 stats(SubscriberStatsProperty11 stats) {
  ...
  **/
  ...
  public SubscriberStatsProperty11 getStats() {
    return stats;
  }


  public void setStats(SubscriberStatsProperty11 stats) {
  ...
  **/
  ...
  public ListMembers4 location(LocationProperty2 location) {
  ...
  **/
  ...
  public ListMembers4 lastNote(NotesProperty lastNote) {
  ...
  **/
   ...
   * @return the ListMembers4 instance itself
   */
  public ListMembers4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.tags, listMembers4.tags) &&
        Objects.equals(this.id, listMembers4.id) &&
        Objects.equals(this.emailAddress, listMembers4.emailAddress) &&
        Objects.equals(this.uniqueEmailId, listMembers4.uniqueEmailId) &&
        Objects.equals(this.contactId, listMembers4.contactId) &&
        ...
        Objects.equals(this.consentsToOneToOneMessaging, listMembers4.consentsToOneToOneMessaging) &&
        Objects.equals(this.smsPhoneNumber, listMembers4.smsPhoneNumber) &&
        Objects.equals(this.smsSubscriptionStatus, listMembers4.smsSubscriptionStatus) &&
        Objects.equals(this.smsSubscriptionLastUpdated, listMembers4.smsSubscriptionLastUpdated) &&
        ...
        Objects.equals(this.links, listMembers4.links)&&
        Objects.equals(this.additionalProperties, listMembers4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMembers4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMembers4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMembers4 is not found in the empty JSON string", ListMembers4.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("stats") != null && !jsonObj.get("stats").isJsonNull()) {
        SubscriberStatsProperty11.validateJsonObject(jsonObj.getAsJsonObject("stats"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMembers4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMembers4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMembers4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMembers4.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMembers4>() {
           @Override
           public void write(JsonWriter out, ListMembers4 value) throws IOException {
           ...
           @Override
           public ListMembers4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMembers4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMembers4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMembers4
  * @throws IOException if the JSON string is invalid with respect to ListMembers4
  */
  public static ListMembers4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMembers4.class);
  }

 /**
  * Convert an instance of ListMembers4 to an JSON string
  *
  * @return JSON string
  */
