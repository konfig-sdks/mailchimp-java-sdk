...
public class GalleryFolder {
  ...
  **/
   ...
   * @return the GalleryFolder instance itself
   */
  public GalleryFolder putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, galleryFolder.id) &&
        ...
        Objects.equals(this.additionalProperties, galleryFolder.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GalleryFolder
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GalleryFolder.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GalleryFolder is not found in the empty JSON string", GalleryFolder.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GalleryFolder.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GalleryFolder' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GalleryFolder> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GalleryFolder.class));

       return (TypeAdapter<T>) new TypeAdapter<GalleryFolder>() {
           @Override
           public void write(JsonWriter out, GalleryFolder value) throws IOException {
           ...
           @Override
           public GalleryFolder read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GalleryFolder instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GalleryFolder given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GalleryFolder
  * @throws IOException if the JSON string is invalid with respect to GalleryFolder
  */
  public static GalleryFolder fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GalleryFolder.class);
  }

 /**
  * Convert an instance of GalleryFolder to an JSON string
  *
  * @return JSON string
  */
