...
public class ChimpChatter {
  ...
  **/
   ...
   * @return the ChimpChatter instance itself
   */
  public ChimpChatter putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, chimpChatter.title) &&
        ...
        Objects.equals(this.additionalProperties, chimpChatter.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ChimpChatter
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ChimpChatter.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ChimpChatter is not found in the empty JSON string", ChimpChatter.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ChimpChatter.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ChimpChatter' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ChimpChatter> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ChimpChatter.class));

       return (TypeAdapter<T>) new TypeAdapter<ChimpChatter>() {
           @Override
           public void write(JsonWriter out, ChimpChatter value) throws IOException {
           ...
           @Override
           public ChimpChatter read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ChimpChatter instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ChimpChatter given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ChimpChatter
  * @throws IOException if the JSON string is invalid with respect to ChimpChatter
  */
  public static ChimpChatter fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ChimpChatter.class);
  }

 /**
  * Convert an instance of ChimpChatter to an JSON string
  *
  * @return JSON string
  */
