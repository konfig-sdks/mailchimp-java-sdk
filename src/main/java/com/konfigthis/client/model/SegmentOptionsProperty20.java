...
public class SegmentOptionsProperty20 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty20() {
  }

  public SegmentOptionsProperty20 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty20 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty20 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty20 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty20 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty20 instance itself
   */
  public SegmentOptionsProperty20 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty20 segmentOptionsProperty20 = (SegmentOptionsProperty20) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty20.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty20.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty20.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty20.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty20.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty20 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty20
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty20.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty20 is not found in the empty JSON string", SegmentOptionsProperty20.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty20.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty20' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty20> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty20.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty20>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty20 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty20 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty20 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty20 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty20
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty20
  */
  public static SegmentOptionsProperty20 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty20.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty20 to an JSON string
  *
  * @return JSON string
  */
