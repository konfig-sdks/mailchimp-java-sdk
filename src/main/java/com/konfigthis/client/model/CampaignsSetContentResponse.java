...
public class CampaignsSetContentResponse {
  ...
  private List<VariateContentsPropertyInner3> variateContents = null;
  ...
  public CampaignsSetContentResponse() {
  }
  ...
  public CampaignsSetContentResponse variateContents(List<VariateContentsPropertyInner3> variateContents) {
  ...
  public CampaignsSetContentResponse addVariateContentsItem(VariateContentsPropertyInner3 variateContentsItem) {
  ...
  **/
  ...
  public List<VariateContentsPropertyInner3> getVariateContents() {
    return variateContents;
  }


  public void setVariateContents(List<VariateContentsPropertyInner3> variateContents) {
  ...
  public CampaignsSetContentResponse plainText(String plainText) {
  ...
  **/
  ...
  public CampaignsSetContentResponse html(String html) {
  ...
  **/
  ...
  public CampaignsSetContentResponse archiveHtml(String archiveHtml) {
  ...
  **/
   ...
   * @return the CampaignsSetContentResponse instance itself
   */
  public CampaignsSetContentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsSetContentResponse campaignsSetContentResponse = (CampaignsSetContentResponse) o;
    return Objects.equals(this.variateContents, campaignsSetContentResponse.variateContents) &&
        Objects.equals(this.plainText, campaignsSetContentResponse.plainText) &&
        Objects.equals(this.html, campaignsSetContentResponse.html) &&
        Objects.equals(this.archiveHtml, campaignsSetContentResponse.archiveHtml) &&
        Objects.equals(this.links, campaignsSetContentResponse.links)&&
        Objects.equals(this.additionalProperties, campaignsSetContentResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsSetContentResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsSetContentResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsSetContentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsSetContentResponse is not found in the empty JSON string", CampaignsSetContentResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("variate_contents") != null && !jsonObj.get("variate_contents").isJsonNull()) {
        ...
        if (jsonArrayvariateContents != null) {
          ...
          for (int i = 0; i < jsonArrayvariateContents.size(); i++) {
            VariateContentsPropertyInner3.validateJsonObject(jsonArrayvariateContents.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsSetContentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsSetContentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsSetContentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsSetContentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsSetContentResponse>() {
           @Override
           public void write(JsonWriter out, CampaignsSetContentResponse value) throws IOException {
           ...
           @Override
           public CampaignsSetContentResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsSetContentResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsSetContentResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsSetContentResponse
  * @throws IOException if the JSON string is invalid with respect to CampaignsSetContentResponse
  */
  public static CampaignsSetContentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsSetContentResponse.class);
  }

 /**
  * Convert an instance of CampaignsSetContentResponse to an JSON string
  *
  * @return JSON string
  */
