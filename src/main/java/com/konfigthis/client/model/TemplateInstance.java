...
public class TemplateInstance {
  ...
  **/
   ...
   * @return the TemplateInstance instance itself
   */
  public TemplateInstance putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, templateInstance.id) &&
        ...
        Objects.equals(this.additionalProperties, templateInstance.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to TemplateInstance
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!TemplateInstance.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in TemplateInstance is not found in the empty JSON string", TemplateInstance.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!TemplateInstance.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'TemplateInstance' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<TemplateInstance> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(TemplateInstance.class));

       return (TypeAdapter<T>) new TypeAdapter<TemplateInstance>() {
           @Override
           public void write(JsonWriter out, TemplateInstance value) throws IOException {
           ...
           @Override
           public TemplateInstance read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             TemplateInstance instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of TemplateInstance given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of TemplateInstance
  * @throws IOException if the JSON string is invalid with respect to TemplateInstance
  */
  public static TemplateInstance fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, TemplateInstance.class);
  }

 /**
  * Convert an instance of TemplateInstance to an JSON string
  *
  * @return JSON string
  */
