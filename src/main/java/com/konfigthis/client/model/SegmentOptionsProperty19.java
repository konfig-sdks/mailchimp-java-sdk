...
public class SegmentOptionsProperty19 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty19() {
  }

  public SegmentOptionsProperty19 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty19 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty19 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty19 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty19 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty19 instance itself
   */
  public SegmentOptionsProperty19 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty19 segmentOptionsProperty19 = (SegmentOptionsProperty19) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty19.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty19.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty19.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty19.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty19.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty19 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty19
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty19.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty19 is not found in the empty JSON string", SegmentOptionsProperty19.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty19.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty19' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty19> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty19.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty19>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty19 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty19 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty19 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty19 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty19
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty19
  */
  public static SegmentOptionsProperty19 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty19.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty19 to an JSON string
  *
  * @return JSON string
  */
