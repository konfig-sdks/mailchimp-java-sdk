...
public class LandingPage {
  ...
  **/
  ...
  public LandingPage tracking(TrackingSettingsProperty tracking) {
  ...
  **/
   ...
   * @return the LandingPage instance itself
   */
  public LandingPage putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, landingPage.title) &&
        ...
        Objects.equals(this.additionalProperties, landingPage.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to LandingPage
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!LandingPage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<LandingPage>() {
           ...
           public LandingPage read(JsonReader in) throws IOException {
             ...
             LandingPage instance = thisAdapter.fromJsonTree(jsonObj);
