...
public class BatchesGetOperationStatusResponse {
 ...
 public enum StatusEnum {
  ...
  public BatchesGetOperationStatusResponse() {
  }
  ...
  **/
   ...
   * @return the BatchesGetOperationStatusResponse instance itself
   */
  public BatchesGetOperationStatusResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BatchesGetOperationStatusResponse batchesGetOperationStatusResponse = (BatchesGetOperationStatusResponse) o;
    return Objects.equals(this.id, batchesGetOperationStatusResponse.id) &&
        Objects.equals(this.status, batchesGetOperationStatusResponse.status) &&
        Objects.equals(this.totalOperations, batchesGetOperationStatusResponse.totalOperations) &&
        Objects.equals(this.finishedOperations, batchesGetOperationStatusResponse.finishedOperations) &&
        Objects.equals(this.erroredOperations, batchesGetOperationStatusResponse.erroredOperations) &&
        Objects.equals(this.submittedAt, batchesGetOperationStatusResponse.submittedAt) &&
        Objects.equals(this.completedAt, batchesGetOperationStatusResponse.completedAt) &&
        Objects.equals(this.responseBodyUrl, batchesGetOperationStatusResponse.responseBodyUrl) &&
        Objects.equals(this.links, batchesGetOperationStatusResponse.links)&&
        Objects.equals(this.additionalProperties, batchesGetOperationStatusResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchesGetOperationStatusResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchesGetOperationStatusResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchesGetOperationStatusResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchesGetOperationStatusResponse is not found in the empty JSON string", BatchesGetOperationStatusResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchesGetOperationStatusResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchesGetOperationStatusResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchesGetOperationStatusResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchesGetOperationStatusResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchesGetOperationStatusResponse>() {
           @Override
           public void write(JsonWriter out, BatchesGetOperationStatusResponse value) throws IOException {
           ...
           @Override
           public BatchesGetOperationStatusResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BatchesGetOperationStatusResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BatchesGetOperationStatusResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BatchesGetOperationStatusResponse
  * @throws IOException if the JSON string is invalid with respect to BatchesGetOperationStatusResponse
  */
  public static BatchesGetOperationStatusResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchesGetOperationStatusResponse.class);
  }

 /**
  * Convert an instance of BatchesGetOperationStatusResponse to an JSON string
  *
  * @return JSON string
  */
