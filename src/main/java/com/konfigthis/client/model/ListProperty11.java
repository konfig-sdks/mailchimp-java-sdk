...
import com.konfigthis.client.model.SegmentOptionsProperty5;
...
public class ListProperty11 {
  ...
  private SegmentOptionsProperty5 segmentOpts;

  public ListProperty11() {
  }
  ...
  public ListProperty11 listId(String listId) {
  ...
  **/
  ...
  public ListProperty11 segmentOpts(SegmentOptionsProperty5 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty5 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty5 segmentOpts) {
   ...
   * @return the ListProperty11 instance itself
   */
  public ListProperty11 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty11 listProperty11 = (ListProperty11) o;
    return Objects.equals(this.listId, listProperty11.listId) &&
        Objects.equals(this.listIsActive, listProperty11.listIsActive) &&
        Objects.equals(this.listName, listProperty11.listName) &&
        Objects.equals(this.segmentText, listProperty11.segmentText) &&
        Objects.equals(this.recipientCount, listProperty11.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty11.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty11.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty11 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty11
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty11.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty11 is not found in the empty JSON string", ListProperty11.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty5.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty11.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty11>() {
           @Override
           public void write(JsonWriter out, ListProperty11 value) throws IOException {
           ...
           @Override
           public ListProperty11 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty11 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty11 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty11
  * @throws IOException if the JSON string is invalid with respect to ListProperty11
  */
  public static ListProperty11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty11.class);
  }

 /**
  * Convert an instance of ListProperty11 to an JSON string
  *
  * @return JSON string
  */
