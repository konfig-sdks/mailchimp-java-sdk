...
import com.konfigthis.client.model.SegmentOptionsProperty20;
...
public class ListProperty26 {
  ...
  private SegmentOptionsProperty20 segmentOpts;

  public ListProperty26() {
  }
  ...
  public ListProperty26 listId(String listId) {
  ...
  **/
  ...
  public ListProperty26 segmentOpts(SegmentOptionsProperty20 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty20 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty20 segmentOpts) {
   ...
   * @return the ListProperty26 instance itself
   */
  public ListProperty26 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty26 listProperty26 = (ListProperty26) o;
    return Objects.equals(this.listId, listProperty26.listId) &&
        Objects.equals(this.listName, listProperty26.listName) &&
        Objects.equals(this.segmentText, listProperty26.segmentText) &&
        Objects.equals(this.recipientCount, listProperty26.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty26.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty26.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty26 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty26
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty26.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty26 is not found in the empty JSON string", ListProperty26.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListProperty26.openapiRequiredFields) {
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty20.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty26.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty26' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty26> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty26.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty26>() {
           @Override
           public void write(JsonWriter out, ListProperty26 value) throws IOException {
           ...
           @Override
           public ListProperty26 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty26 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty26 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty26
  * @throws IOException if the JSON string is invalid with respect to ListProperty26
  */
  public static ListProperty26 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty26.class);
  }

 /**
  * Convert an instance of ListProperty26 to an JSON string
  *
  * @return JSON string
  */
