...
import com.konfigthis.client.model.CollectionOfContentForListSignupForms2;
import com.konfigthis.client.model.CollectionOfElementStyleForListSignupForms2;
import com.konfigthis.client.model.ResourceLink;
import com.konfigthis.client.model.SignupFormHeaderOptionsProperty2;
...
public class SignupForm1 {
  ...
  private SignupFormHeaderOptionsProperty2 header;

  public static final String SERIALIZED_NAME_CONTENTS = "contents";
  @SerializedName(SERIALIZED_NAME_CONTENTS)
  private List<CollectionOfContentForListSignupForms2> contents = null;

  public static final String SERIALIZED_NAME_STYLES = "styles";
  @SerializedName(SERIALIZED_NAME_STYLES)
  private List<CollectionOfElementStyleForListSignupForms2> styles = null;
  ...
  public SignupForm1 header(SignupFormHeaderOptionsProperty2 header) {
  ...
  **/
  ...
  public SignupFormHeaderOptionsProperty2 getHeader() {
    return header;
  }


  public void setHeader(SignupFormHeaderOptionsProperty2 header) {
  ...
  public SignupForm1 contents(List<CollectionOfContentForListSignupForms2> contents) {
  ...
  public SignupForm1 addContentsItem(CollectionOfContentForListSignupForms2 contentsItem) {
  ...
  **/
  ...
  public List<CollectionOfContentForListSignupForms2> getContents() {
    return contents;
  }


  public void setContents(List<CollectionOfContentForListSignupForms2> contents) {
  ...
  public SignupForm1 styles(List<CollectionOfElementStyleForListSignupForms2> styles) {
  ...
  public SignupForm1 addStylesItem(CollectionOfElementStyleForListSignupForms2 stylesItem) {
    if (this.styles == null) {
  ...
  **/
  ...
  public List<CollectionOfElementStyleForListSignupForms2> getStyles() {
    return styles;
  }


  public void setStyles(List<CollectionOfElementStyleForListSignupForms2> styles) {
  ...
  **/
   ...
   * @return the SignupForm1 instance itself
   */
  public SignupForm1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.header, signupForm1.header) &&
        ...
        Objects.equals(this.links, signupForm1.links)&&
        Objects.equals(this.additionalProperties, signupForm1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SignupForm1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SignupForm1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SignupForm1 is not found in the empty JSON string", SignupForm1.openapiRequiredFields.toString()));
        }
      }
      // validate the optional field `header`
      if (jsonObj.get("header") != null && !jsonObj.get("header").isJsonNull()) {
        SignupFormHeaderOptionsProperty2.validateJsonObject(jsonObj.getAsJsonObject("header"));
      }
      if (jsonObj.get("contents") != null && !jsonObj.get("contents").isJsonNull()) {
        ...
        if (jsonArraycontents != null) {
          ...
          for (int i = 0; i < jsonArraycontents.size(); i++) {
            CollectionOfContentForListSignupForms2.validateJsonObject(jsonArraycontents.get(i).getAsJsonObject());
          };
        }
      }
      if (jsonObj.get("styles") != null && !jsonObj.get("styles").isJsonNull()) {
        ...
        if (jsonArraystyles != null) {
          ...
          for (int i = 0; i < jsonArraystyles.size(); i++) {
            CollectionOfElementStyleForListSignupForms2.validateJsonObject(jsonArraystyles.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SignupForm1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SignupForm1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SignupForm1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SignupForm1.class));

       return (TypeAdapter<T>) new TypeAdapter<SignupForm1>() {
           @Override
           public void write(JsonWriter out, SignupForm1 value) throws IOException {
           ...
           @Override
           public SignupForm1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SignupForm1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SignupForm1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SignupForm1
  * @throws IOException if the JSON string is invalid with respect to SignupForm1
  */
  public static SignupForm1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SignupForm1.class);
  }

 /**
  * Convert an instance of SignupForm1 to an JSON string
  *
  * @return JSON string
  */
