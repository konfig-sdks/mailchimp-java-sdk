...
public class AutomationDelayProperty2 {
 ...
 public enum ActionEnum {
  ...
  public AutomationDelayProperty2() {
  }
  ...
  **/
  ...
  public AutomationDelayProperty2 type(TypeEnum type) {
  ...
  **/
  ...
  public AutomationDelayProperty2 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public AutomationDelayProperty2 action(ActionEnum action) {
  ...
  **/
   ...
   * @return the AutomationDelayProperty2 instance itself
   */
  public AutomationDelayProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationDelayProperty2 automationDelayProperty2 = (AutomationDelayProperty2) o;
    return Objects.equals(this.amount, automationDelayProperty2.amount) &&
        Objects.equals(this.type, automationDelayProperty2.type) &&
        Objects.equals(this.direction, automationDelayProperty2.direction) &&
        Objects.equals(this.action, automationDelayProperty2.action) &&
        Objects.equals(this.actionDescription, automationDelayProperty2.actionDescription) &&
        Objects.equals(this.fullDescription, automationDelayProperty2.fullDescription)&&
        Objects.equals(this.additionalProperties, automationDelayProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationDelayProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationDelayProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationDelayProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationDelayProperty2 is not found in the empty JSON string", AutomationDelayProperty2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationDelayProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationDelayProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationDelayProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationDelayProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationDelayProperty2>() {
           @Override
           public void write(JsonWriter out, AutomationDelayProperty2 value) throws IOException {
           ...
           @Override
           public AutomationDelayProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationDelayProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationDelayProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationDelayProperty2
  * @throws IOException if the JSON string is invalid with respect to AutomationDelayProperty2
  */
  public static AutomationDelayProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationDelayProperty2.class);
  }

 /**
  * Convert an instance of AutomationDelayProperty2 to an JSON string
  *
  * @return JSON string
  */
