...
import com.konfigthis.client.model.ListProperty29;
...
public class CampaignProperty {
 ...
 public enum ContentTypeEnum {
  ...
  private ListProperty29 recipients;
  ...
  **/
  ...
  public CampaignProperty type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignProperty contentType(ContentTypeEnum contentType) {
  ...
  **/
  ...
  public CampaignProperty recipients(ListProperty29 recipients) {
  ...
  **/
  ...
  public ListProperty29 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty29 recipients) {
  ...
  public CampaignProperty settings(CampaignSettingsProperty4 settings) {
  ...
  **/
  ...
  public CampaignProperty variateSettings(ABTestOptionsProperty1 variateSettings) {
  ...
  **/
  ...
  public CampaignProperty tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public CampaignProperty rssOpts(RSSOptionsProperty2 rssOpts) {
  ...
  **/
  ...
  public CampaignProperty abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public CampaignProperty socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public CampaignProperty reportSummary(CampaignReportSummaryProperty2 reportSummary) {
  ...
  **/
  ...
  public CampaignProperty deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
  ...
  public CampaignProperty resendShortcutEligibility(ResendShortcutEligibilityProperty resendShortcutEligibility) {
  ...
  **/
   ...
   * @return the CampaignProperty instance itself
   */
  public CampaignProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, campaignProperty.id) &&
        Objects.equals(this.webId, campaignProperty.webId) &&
        Objects.equals(this.parentCampaignId, campaignProperty.parentCampaignId) &&
        Objects.equals(this.type, campaignProperty.type) &&
        Objects.equals(this.createTime, campaignProperty.createTime) &&
        Objects.equals(this.archiveUrl, campaignProperty.archiveUrl) &&
        Objects.equals(this.longArchiveUrl, campaignProperty.longArchiveUrl) &&
        Objects.equals(this.status, campaignProperty.status) &&
        Objects.equals(this.emailsSent, campaignProperty.emailsSent) &&
        Objects.equals(this.sendTime, campaignProperty.sendTime) &&
        Objects.equals(this.contentType, campaignProperty.contentType) &&
        Objects.equals(this.needsBlockRefresh, campaignProperty.needsBlockRefresh) &&
        Objects.equals(this.resendable, campaignProperty.resendable) &&
        Objects.equals(this.recipients, campaignProperty.recipients) &&
        Objects.equals(this.settings, campaignProperty.settings) &&
        Objects.equals(this.variateSettings, campaignProperty.variateSettings) &&
        Objects.equals(this.tracking, campaignProperty.tracking) &&
        Objects.equals(this.rssOpts, campaignProperty.rssOpts) &&
        Objects.equals(this.abSplitOpts, campaignProperty.abSplitOpts) &&
        Objects.equals(this.socialCard, campaignProperty.socialCard) &&
        Objects.equals(this.reportSummary, campaignProperty.reportSummary) &&
        Objects.equals(this.deliveryStatus, campaignProperty.deliveryStatus) &&
        Objects.equals(this.resendShortcutEligibility, campaignProperty.resendShortcutEligibility) &&
        Objects.equals(this.links, campaignProperty.links)&&
        Objects.equals(this.additionalProperties, campaignProperty.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignProperty is not found in the empty JSON string", CampaignProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty29.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignProperty>() {
           @Override
           public void write(JsonWriter out, CampaignProperty value) throws IOException {
           ...
           @Override
           public CampaignProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignProperty
  * @throws IOException if the JSON string is invalid with respect to CampaignProperty
  */
  public static CampaignProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignProperty.class);
  }

 /**
  * Convert an instance of CampaignProperty to an JSON string
  *
  * @return JSON string
  */
