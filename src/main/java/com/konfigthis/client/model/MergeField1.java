...
public class MergeField1 {
 ...
 public enum TypeEnum {
  ...
  private MergeFieldOptionsProperty3 options;
  ...
  **/
  ...
  public MergeField1 options(MergeFieldOptionsProperty3 options) {
  ...
  **/
  ...
  public MergeFieldOptionsProperty3 getOptions() {
    return options;
  }


  public void setOptions(MergeFieldOptionsProperty3 options) {
  ...
  **/
   ...
   * @return the MergeField1 instance itself
   */
  public MergeField1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mergeId, mergeField1.mergeId) &&
        ...
        Objects.equals(this.links, mergeField1.links)&&
        Objects.equals(this.additionalProperties, mergeField1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MergeField1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MergeField1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeField1 is not found in the empty JSON string", MergeField1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        MergeFieldOptionsProperty3.validateJsonObject(jsonObj.getAsJsonObject("options"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeField1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeField1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeField1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeField1.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeField1>() {
           @Override
           public void write(JsonWriter out, MergeField1 value) throws IOException {
           ...
           @Override
           public MergeField1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MergeField1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MergeField1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MergeField1
  * @throws IOException if the JSON string is invalid with respect to MergeField1
  */
  public static MergeField1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeField1.class);
  }

 /**
  * Convert an instance of MergeField1 to an JSON string
  *
  * @return JSON string
  */
