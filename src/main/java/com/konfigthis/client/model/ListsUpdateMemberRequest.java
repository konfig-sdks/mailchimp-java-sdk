...
public class ListsUpdateMemberRequest {
 ...
 public enum StatusEnum {
  ...
  public ListsUpdateMemberRequest() {
  }

  public ListsUpdateMemberRequest emailAddress(String emailAddress) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest emailType(String emailType) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest status(StatusEnum status) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest mergeFields(Map<String, Object> mergeFields) {
  ...
  public ListsUpdateMemberRequest putMergeFieldsItem(String key, Object mergeFieldsItem) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest interests(Map<String, Boolean> interests) {
  ...
  public ListsUpdateMemberRequest putInterestsItem(String key, Boolean interestsItem) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest language(String language) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest vip(Boolean vip) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest location(LocationProperty location) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest marketingPermissions(List<MarketingPermission> marketingPermissions) {
  ...
  public ListsUpdateMemberRequest addMarketingPermissionsItem(MarketingPermission marketingPermissionsItem) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest ipSignup(String ipSignup) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest timestampSignup(OffsetDateTime timestampSignup) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest ipOpt(String ipOpt) {
  ...
  **/
  ...
  public ListsUpdateMemberRequest timestampOpt(OffsetDateTime timestampOpt) {
  ...
  **/
   ...
   * @return the ListsUpdateMemberRequest instance itself
   */
  public ListsUpdateMemberRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListsUpdateMemberRequest listsUpdateMemberRequest = (ListsUpdateMemberRequest) o;
    return Objects.equals(this.emailAddress, listsUpdateMemberRequest.emailAddress) &&
        Objects.equals(this.emailType, listsUpdateMemberRequest.emailType) &&
        Objects.equals(this.status, listsUpdateMemberRequest.status) &&
        Objects.equals(this.mergeFields, listsUpdateMemberRequest.mergeFields) &&
        Objects.equals(this.interests, listsUpdateMemberRequest.interests) &&
        Objects.equals(this.language, listsUpdateMemberRequest.language) &&
        Objects.equals(this.vip, listsUpdateMemberRequest.vip) &&
        Objects.equals(this.location, listsUpdateMemberRequest.location) &&
        Objects.equals(this.marketingPermissions, listsUpdateMemberRequest.marketingPermissions) &&
        Objects.equals(this.ipSignup, listsUpdateMemberRequest.ipSignup) &&
        Objects.equals(this.timestampSignup, listsUpdateMemberRequest.timestampSignup) &&
        Objects.equals(this.ipOpt, listsUpdateMemberRequest.ipOpt) &&
        Objects.equals(this.timestampOpt, listsUpdateMemberRequest.timestampOpt)&&
        Objects.equals(this.additionalProperties, listsUpdateMemberRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(emailAddress, emailType, status, mergeFields, interests, language, vip, location, marketingPermissions, ipSignup, timestampSignup, ipOpt, timestampOpt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListsUpdateMemberRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListsUpdateMemberRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListsUpdateMemberRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListsUpdateMemberRequest is not found in the empty JSON string", ListsUpdateMemberRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListsUpdateMemberRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListsUpdateMemberRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListsUpdateMemberRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListsUpdateMemberRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListsUpdateMemberRequest>() {
           @Override
           public void write(JsonWriter out, ListsUpdateMemberRequest value) throws IOException {
           ...
           @Override
           public ListsUpdateMemberRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListsUpdateMemberRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListsUpdateMemberRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListsUpdateMemberRequest
  * @throws IOException if the JSON string is invalid with respect to ListsUpdateMemberRequest
  */
  public static ListsUpdateMemberRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListsUpdateMemberRequest.class);
  }

 /**
  * Convert an instance of ListsUpdateMemberRequest to an JSON string
  *
  * @return JSON string
  */
