...
public class GrowthHistory {
  ...
  **/
   ...
   * @return the GrowthHistory instance itself
   */
  public GrowthHistory putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.listId, growthHistory.listId) &&
        Objects.equals(this.month, growthHistory.month) &&
        Objects.equals(this.existing, growthHistory.existing) &&
        Objects.equals(this.imports, growthHistory.imports) &&
        Objects.equals(this.optins, growthHistory.optins) &&
        Objects.equals(this.subscribed, growthHistory.subscribed) &&
        Objects.equals(this.unsubscribed, growthHistory.unsubscribed) &&
        Objects.equals(this.reconfirm, growthHistory.reconfirm) &&
        Objects.equals(this.cleaned, growthHistory.cleaned) &&
        Objects.equals(this.pending, growthHistory.pending) &&
        Objects.equals(this.deleted, growthHistory.deleted) &&
        Objects.equals(this.transactional, growthHistory.transactional) &&
        Objects.equals(this.links, growthHistory.links)&&
        Objects.equals(this.additionalProperties, growthHistory.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to GrowthHistory
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!GrowthHistory.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in GrowthHistory is not found in the empty JSON string", GrowthHistory.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!GrowthHistory.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'GrowthHistory' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<GrowthHistory> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(GrowthHistory.class));

       return (TypeAdapter<T>) new TypeAdapter<GrowthHistory>() {
           @Override
           public void write(JsonWriter out, GrowthHistory value) throws IOException {
           ...
           @Override
           public GrowthHistory read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             GrowthHistory instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of GrowthHistory given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of GrowthHistory
  * @throws IOException if the JSON string is invalid with respect to GrowthHistory
  */
  public static GrowthHistory fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, GrowthHistory.class);
  }

 /**
  * Convert an instance of GrowthHistory to an JSON string
  *
  * @return JSON string
  */
