...
public class SendingScheduleProperty1 {
 ...
 public enum WeeklySendDayEnum {
  ...
  public SendingScheduleProperty1() {
  }

  public SendingScheduleProperty1 hour(Integer hour) {
    if (hour != null && hour < 0) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The hour to send the campaign in local time. Acceptable hours are 0-23. For example, '4' would be 4am in [your account's default time zone](https://mailchimp.com/help/set-account-details/).")
  ...
  public SendingScheduleProperty1 dailySend(DailySendingDaysProperty dailySend) {
  ...
  **/
  ...
  public SendingScheduleProperty1 weeklySendDay(WeeklySendDayEnum weeklySendDay) {
  ...
  **/
  ...
  public SendingScheduleProperty1 monthlySendDate(Double monthlySendDate) {
  ...
  public SendingScheduleProperty1 monthlySendDate(Integer monthlySendDate) {
    if (monthlySendDate != null && monthlySendDate < 0) {
      throw new IllegalArgumentException("Invalid value for monthlySendDate. Must be greater than or equal to 0.");
    }
    if (monthlySendDate != null && monthlySendDate > 31) {
  ...
  **/
   ...
   * @return the SendingScheduleProperty1 instance itself
   */
  public SendingScheduleProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SendingScheduleProperty1 sendingScheduleProperty1 = (SendingScheduleProperty1) o;
    return Objects.equals(this.hour, sendingScheduleProperty1.hour) &&
        Objects.equals(this.dailySend, sendingScheduleProperty1.dailySend) &&
        Objects.equals(this.weeklySendDay, sendingScheduleProperty1.weeklySendDay) &&
        Objects.equals(this.monthlySendDate, sendingScheduleProperty1.monthlySendDate)&&
        Objects.equals(this.additionalProperties, sendingScheduleProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SendingScheduleProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SendingScheduleProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SendingScheduleProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SendingScheduleProperty1 is not found in the empty JSON string", SendingScheduleProperty1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SendingScheduleProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SendingScheduleProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SendingScheduleProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SendingScheduleProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<SendingScheduleProperty1>() {
           @Override
           public void write(JsonWriter out, SendingScheduleProperty1 value) throws IOException {
           ...
           @Override
           public SendingScheduleProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SendingScheduleProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SendingScheduleProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SendingScheduleProperty1
  * @throws IOException if the JSON string is invalid with respect to SendingScheduleProperty1
  */
  public static SendingScheduleProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SendingScheduleProperty1.class);
  }

 /**
  * Convert an instance of SendingScheduleProperty1 to an JSON string
  *
  * @return JSON string
  */
