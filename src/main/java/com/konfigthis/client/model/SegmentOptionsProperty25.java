...
public class SegmentOptionsProperty25 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty25() {
  }

  public SegmentOptionsProperty25 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty25 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty25 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty25 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty25 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty25 instance itself
   */
  public SegmentOptionsProperty25 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty25 segmentOptionsProperty25 = (SegmentOptionsProperty25) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty25.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty25.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty25.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty25.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty25.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty25 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty25
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty25.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty25 is not found in the empty JSON string", SegmentOptionsProperty25.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty25.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty25' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty25> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty25.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty25>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty25 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty25 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty25 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty25 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty25
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty25
  */
  public static SegmentOptionsProperty25 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty25.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty25 to an JSON string
  *
  * @return JSON string
  */
