...
public class EventsProperty7 {
  ...
  public EventsProperty7() {
  }

  public EventsProperty7 subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty7 unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty7 profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty7 cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty7 upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty7 campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty7 instance itself
   */
  public EventsProperty7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty7 eventsProperty7 = (EventsProperty7) o;
    return Objects.equals(this.subscribe, eventsProperty7.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty7.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty7.profile) &&
        Objects.equals(this.cleaned, eventsProperty7.cleaned) &&
        Objects.equals(this.upemail, eventsProperty7.upemail) &&
        Objects.equals(this.campaign, eventsProperty7.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty7.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty7 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty7 is not found in the empty JSON string", EventsProperty7.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty7.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty7>() {
           @Override
           public void write(JsonWriter out, EventsProperty7 value) throws IOException {
           ...
           @Override
           public EventsProperty7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty7
  * @throws IOException if the JSON string is invalid with respect to EventsProperty7
  */
  public static EventsProperty7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty7.class);
  }

 /**
  * Convert an instance of EventsProperty7 to an JSON string
  *
  * @return JSON string
  */
