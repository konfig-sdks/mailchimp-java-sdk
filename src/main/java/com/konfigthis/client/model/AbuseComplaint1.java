...
public class AbuseComplaint1 {
  ...
  **/
   ...
   * @return the AbuseComplaint1 instance itself
   */
  public AbuseComplaint1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, abuseComplaint1.id) &&
        ...
        Objects.equals(this.additionalProperties, abuseComplaint1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AbuseComplaint1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AbuseComplaint1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AbuseComplaint1 is not found in the empty JSON string", AbuseComplaint1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AbuseComplaint1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AbuseComplaint1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AbuseComplaint1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AbuseComplaint1.class));

       return (TypeAdapter<T>) new TypeAdapter<AbuseComplaint1>() {
           @Override
           public void write(JsonWriter out, AbuseComplaint1 value) throws IOException {
           ...
           @Override
           public AbuseComplaint1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AbuseComplaint1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AbuseComplaint1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AbuseComplaint1
  * @throws IOException if the JSON string is invalid with respect to AbuseComplaint1
  */
  public static AbuseComplaint1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AbuseComplaint1.class);
  }

 /**
  * Convert an instance of AbuseComplaint1 to an JSON string
  *
  * @return JSON string
  */
