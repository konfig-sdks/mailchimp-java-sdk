...
import com.konfigthis.client.model.SegmentOptionsProperty28;
...
public class RecipientsProperty3 {
  ...
  private SegmentOptionsProperty28 segmentOpts;

  public RecipientsProperty3() {
  }
  ...
  public RecipientsProperty3 listId(String listId) {
  ...
  **/
  ...
  public RecipientsProperty3 segmentOpts(SegmentOptionsProperty28 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty28 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty28 segmentOpts) {
   ...
   * @return the RecipientsProperty3 instance itself
   */
  public RecipientsProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecipientsProperty3 recipientsProperty3 = (RecipientsProperty3) o;
    return Objects.equals(this.listId, recipientsProperty3.listId) &&
        Objects.equals(this.listIsActive, recipientsProperty3.listIsActive) &&
        Objects.equals(this.listName, recipientsProperty3.listName) &&
        Objects.equals(this.segmentText, recipientsProperty3.segmentText) &&
        Objects.equals(this.recipientCount, recipientsProperty3.recipientCount) &&
        Objects.equals(this.segmentOpts, recipientsProperty3.segmentOpts)&&
        Objects.equals(this.additionalProperties, recipientsProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipientsProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecipientsProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecipientsProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecipientsProperty3 is not found in the empty JSON string", RecipientsProperty3.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty28.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecipientsProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecipientsProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecipientsProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecipientsProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<RecipientsProperty3>() {
           @Override
           public void write(JsonWriter out, RecipientsProperty3 value) throws IOException {
           ...
           @Override
           public RecipientsProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecipientsProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecipientsProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecipientsProperty3
  * @throws IOException if the JSON string is invalid with respect to RecipientsProperty3
  */
  public static RecipientsProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecipientsProperty3.class);
  }

 /**
  * Convert an instance of RecipientsProperty3 to an JSON string
  *
  * @return JSON string
  */
