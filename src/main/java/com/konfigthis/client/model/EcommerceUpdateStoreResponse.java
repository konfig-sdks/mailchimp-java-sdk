...
import com.konfigthis.client.model.AddressProperty17;
import com.konfigthis.client.model.AutomationsProperty6;
import com.konfigthis.client.model.ConnectedSiteProperty6;
...
public class EcommerceUpdateStoreResponse {
  ...
  public EcommerceUpdateStoreResponse() {
  }
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse name(String name) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse platform(String platform) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse domain(String domain) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse isSyncing(Boolean isSyncing) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse emailAddress(String emailAddress) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse moneyFormat(String moneyFormat) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse primaryLocale(String primaryLocale) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse timezone(String timezone) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse phone(String phone) {
  ...
  **/
  ...
  public EcommerceUpdateStoreResponse address(AddressProperty17 address) {
  ...
  **/
  ...
  public AddressProperty17 getAddress() {
    return address;
  }


  public void setAddress(AddressProperty17 address) {
  ...
  public EcommerceUpdateStoreResponse connectedSite(ConnectedSiteProperty6 connectedSite) {
  ...
  **/
  ...
  public ConnectedSiteProperty6 getConnectedSite() {
    return connectedSite;
  }


  public void setConnectedSite(ConnectedSiteProperty6 connectedSite) {
  ...
  public EcommerceUpdateStoreResponse automations(AutomationsProperty6 automations) {
  ...
  **/
  ...
  public AutomationsProperty6 getAutomations() {
    return automations;
  }


  public void setAutomations(AutomationsProperty6 automations) {
  ...
  **/
   ...
   * @return the EcommerceUpdateStoreResponse instance itself
   */
  public EcommerceUpdateStoreResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceUpdateStoreResponse ecommerceUpdateStoreResponse = (EcommerceUpdateStoreResponse) o;
    return Objects.equals(this.id, ecommerceUpdateStoreResponse.id) &&
        Objects.equals(this.listId, ecommerceUpdateStoreResponse.listId) &&
        Objects.equals(this.name, ecommerceUpdateStoreResponse.name) &&
        Objects.equals(this.platform, ecommerceUpdateStoreResponse.platform) &&
        Objects.equals(this.domain, ecommerceUpdateStoreResponse.domain) &&
        Objects.equals(this.isSyncing, ecommerceUpdateStoreResponse.isSyncing) &&
        Objects.equals(this.emailAddress, ecommerceUpdateStoreResponse.emailAddress) &&
        Objects.equals(this.currencyCode, ecommerceUpdateStoreResponse.currencyCode) &&
        Objects.equals(this.moneyFormat, ecommerceUpdateStoreResponse.moneyFormat) &&
        Objects.equals(this.primaryLocale, ecommerceUpdateStoreResponse.primaryLocale) &&
        Objects.equals(this.timezone, ecommerceUpdateStoreResponse.timezone) &&
        Objects.equals(this.phone, ecommerceUpdateStoreResponse.phone) &&
        Objects.equals(this.address, ecommerceUpdateStoreResponse.address) &&
        Objects.equals(this.connectedSite, ecommerceUpdateStoreResponse.connectedSite) &&
        Objects.equals(this.automations, ecommerceUpdateStoreResponse.automations) &&
        Objects.equals(this.listIsActive, ecommerceUpdateStoreResponse.listIsActive) &&
        Objects.equals(this.createdAt, ecommerceUpdateStoreResponse.createdAt) &&
        Objects.equals(this.updatedAt, ecommerceUpdateStoreResponse.updatedAt) &&
        Objects.equals(this.links, ecommerceUpdateStoreResponse.links)&&
        Objects.equals(this.additionalProperties, ecommerceUpdateStoreResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceUpdateStoreResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceUpdateStoreResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceUpdateStoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceUpdateStoreResponse is not found in the empty JSON string", EcommerceUpdateStoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        AddressProperty17.validateJsonObject(jsonObj.getAsJsonObject("address"));
      }
      // validate the optional field `connected_site`
      if (jsonObj.get("connected_site") != null && !jsonObj.get("connected_site").isJsonNull()) {
        ConnectedSiteProperty6.validateJsonObject(jsonObj.getAsJsonObject("connected_site"));
      }
      // validate the optional field `automations`
      if (jsonObj.get("automations") != null && !jsonObj.get("automations").isJsonNull()) {
        AutomationsProperty6.validateJsonObject(jsonObj.getAsJsonObject("automations"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceUpdateStoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceUpdateStoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceUpdateStoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceUpdateStoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceUpdateStoreResponse>() {
           @Override
           public void write(JsonWriter out, EcommerceUpdateStoreResponse value) throws IOException {
           ...
           @Override
           public EcommerceUpdateStoreResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceUpdateStoreResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceUpdateStoreResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceUpdateStoreResponse
  * @throws IOException if the JSON string is invalid with respect to EcommerceUpdateStoreResponse
  */
  public static EcommerceUpdateStoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceUpdateStoreResponse.class);
  }

 /**
  * Convert an instance of EcommerceUpdateStoreResponse to an JSON string
  *
  * @return JSON string
  */
