...
public class EcommerceUpdateOrderLine200Response {
  ...
  public EcommerceUpdateOrderLine200Response() {
  }
  ...
  **/
  ...
  public EcommerceUpdateOrderLine200Response productId(String productId) {
  ...
  **/
  ...
  public EcommerceUpdateOrderLine200Response productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceUpdateOrderLine200Response quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceUpdateOrderLine200Response price(Double price) {
  ...
  public EcommerceUpdateOrderLine200Response price(Integer price) {
  ...
  **/
  ...
  public EcommerceUpdateOrderLine200Response discount(Double discount) {
  ...
  public EcommerceUpdateOrderLine200Response discount(Integer discount) {
  ...
  **/
   ...
   * @return the EcommerceUpdateOrderLine200Response instance itself
   */
  public EcommerceUpdateOrderLine200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceUpdateOrderLine200Response ecommerceUpdateOrderLine200Response = (EcommerceUpdateOrderLine200Response) o;
    return Objects.equals(this.id, ecommerceUpdateOrderLine200Response.id) &&
        Objects.equals(this.productId, ecommerceUpdateOrderLine200Response.productId) &&
        Objects.equals(this.productTitle, ecommerceUpdateOrderLine200Response.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceUpdateOrderLine200Response.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceUpdateOrderLine200Response.productVariantTitle) &&
        Objects.equals(this.imageUrl, ecommerceUpdateOrderLine200Response.imageUrl) &&
        Objects.equals(this.quantity, ecommerceUpdateOrderLine200Response.quantity) &&
        Objects.equals(this.price, ecommerceUpdateOrderLine200Response.price) &&
        Objects.equals(this.discount, ecommerceUpdateOrderLine200Response.discount) &&
        Objects.equals(this.links, ecommerceUpdateOrderLine200Response.links)&&
        Objects.equals(this.additionalProperties, ecommerceUpdateOrderLine200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceUpdateOrderLine200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceUpdateOrderLine200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceUpdateOrderLine200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceUpdateOrderLine200Response is not found in the empty JSON string", EcommerceUpdateOrderLine200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceUpdateOrderLine200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceUpdateOrderLine200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceUpdateOrderLine200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceUpdateOrderLine200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceUpdateOrderLine200Response>() {
           @Override
           public void write(JsonWriter out, EcommerceUpdateOrderLine200Response value) throws IOException {
           ...
           @Override
           public EcommerceUpdateOrderLine200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceUpdateOrderLine200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceUpdateOrderLine200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceUpdateOrderLine200Response
  * @throws IOException if the JSON string is invalid with respect to EcommerceUpdateOrderLine200Response
  */
  public static EcommerceUpdateOrderLine200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceUpdateOrderLine200Response.class);
  }

 /**
  * Convert an instance of EcommerceUpdateOrderLine200Response to an JSON string
  *
  * @return JSON string
  */
