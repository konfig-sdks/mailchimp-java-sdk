...
public class ListsAddMemberToListRequest {
 ...
 public enum StatusEnum {
  ...
  public ListsAddMemberToListRequest() {
  }

  public ListsAddMemberToListRequest tags(List<String> tags) {
  ...
  public ListsAddMemberToListRequest addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  @ApiModelProperty(value = "The tags that are associated with a member.")
  ...
  public ListsAddMemberToListRequest emailAddress(String emailAddress) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest emailType(String emailType) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest status(StatusEnum status) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "Subscriber's current status.")
  ...
  public ListsAddMemberToListRequest mergeFields(Map<String, Object> mergeFields) {
  ...
  public ListsAddMemberToListRequest putMergeFieldsItem(String key, Object mergeFieldsItem) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest interests(Map<String, Boolean> interests) {
  ...
  public ListsAddMemberToListRequest putInterestsItem(String key, Boolean interestsItem) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest language(String language) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest vip(Boolean vip) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest location(LocationProperty location) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest marketingPermissions(List<MarketingPermission> marketingPermissions) {
  ...
  public ListsAddMemberToListRequest addMarketingPermissionsItem(MarketingPermission marketingPermissionsItem) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest ipSignup(String ipSignup) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest timestampSignup(OffsetDateTime timestampSignup) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest ipOpt(String ipOpt) {
  ...
  **/
  ...
  public ListsAddMemberToListRequest timestampOpt(OffsetDateTime timestampOpt) {
  ...
  **/
   ...
   * @return the ListsAddMemberToListRequest instance itself
   */
  public ListsAddMemberToListRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListsAddMemberToListRequest listsAddMemberToListRequest = (ListsAddMemberToListRequest) o;
    return Objects.equals(this.tags, listsAddMemberToListRequest.tags) &&
        Objects.equals(this.emailAddress, listsAddMemberToListRequest.emailAddress) &&
        Objects.equals(this.emailType, listsAddMemberToListRequest.emailType) &&
        Objects.equals(this.status, listsAddMemberToListRequest.status) &&
        Objects.equals(this.mergeFields, listsAddMemberToListRequest.mergeFields) &&
        Objects.equals(this.interests, listsAddMemberToListRequest.interests) &&
        Objects.equals(this.language, listsAddMemberToListRequest.language) &&
        Objects.equals(this.vip, listsAddMemberToListRequest.vip) &&
        Objects.equals(this.location, listsAddMemberToListRequest.location) &&
        Objects.equals(this.marketingPermissions, listsAddMemberToListRequest.marketingPermissions) &&
        Objects.equals(this.ipSignup, listsAddMemberToListRequest.ipSignup) &&
        Objects.equals(this.timestampSignup, listsAddMemberToListRequest.timestampSignup) &&
        Objects.equals(this.ipOpt, listsAddMemberToListRequest.ipOpt) &&
        Objects.equals(this.timestampOpt, listsAddMemberToListRequest.timestampOpt)&&
        Objects.equals(this.additionalProperties, listsAddMemberToListRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(tags, emailAddress, emailType, status, mergeFields, interests, language, vip, location, marketingPermissions, ipSignup, timestampSignup, ipOpt, timestampOpt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ListsAddMemberToListRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListsAddMemberToListRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListsAddMemberToListRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListsAddMemberToListRequest is not found in the empty JSON string", ListsAddMemberToListRequest.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListsAddMemberToListRequest.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListsAddMemberToListRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListsAddMemberToListRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListsAddMemberToListRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListsAddMemberToListRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<ListsAddMemberToListRequest>() {
           @Override
           public void write(JsonWriter out, ListsAddMemberToListRequest value) throws IOException {
           ...
           @Override
           public ListsAddMemberToListRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListsAddMemberToListRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListsAddMemberToListRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListsAddMemberToListRequest
  * @throws IOException if the JSON string is invalid with respect to ListsAddMemberToListRequest
  */
  public static ListsAddMemberToListRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListsAddMemberToListRequest.class);
  }

 /**
  * Convert an instance of ListsAddMemberToListRequest to an JSON string
  *
  * @return JSON string
  */
