...
public class SegmentOptionsProperty9 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty9() {
  }

  public SegmentOptionsProperty9 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty9 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty9 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty9 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty9 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty9 instance itself
   */
  public SegmentOptionsProperty9 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty9 segmentOptionsProperty9 = (SegmentOptionsProperty9) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty9.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty9.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty9.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty9.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty9.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty9 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty9
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty9.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty9 is not found in the empty JSON string", SegmentOptionsProperty9.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty9.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty9' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty9> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty9.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty9>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty9 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty9 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty9 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty9 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty9
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty9
  */
  public static SegmentOptionsProperty9 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty9.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty9 to an JSON string
  *
  * @return JSON string
  */
