...
import com.konfigthis.client.model.SegmentOptionsProperty21;
...
public class ListProperty27 {
  ...
  private SegmentOptionsProperty21 segmentOpts;

  public ListProperty27() {
  }
  ...
  public ListProperty27 listId(String listId) {
  ...
  **/
  ...
  public ListProperty27 segmentOpts(SegmentOptionsProperty21 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty21 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty21 segmentOpts) {
   ...
   * @return the ListProperty27 instance itself
   */
  public ListProperty27 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty27 listProperty27 = (ListProperty27) o;
    return Objects.equals(this.listId, listProperty27.listId) &&
        Objects.equals(this.listName, listProperty27.listName) &&
        Objects.equals(this.segmentText, listProperty27.segmentText) &&
        Objects.equals(this.recipientCount, listProperty27.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty27.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty27.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty27 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty27
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty27.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty27 is not found in the empty JSON string", ListProperty27.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListProperty27.openapiRequiredFields) {
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty21.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty27.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty27' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty27> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty27.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty27>() {
           @Override
           public void write(JsonWriter out, ListProperty27 value) throws IOException {
           ...
           @Override
           public ListProperty27 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty27 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty27 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty27
  * @throws IOException if the JSON string is invalid with respect to ListProperty27
  */
  public static ListProperty27 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty27.class);
  }

 /**
  * Convert an instance of ListProperty27 to an JSON string
  *
  * @return JSON string
  */
