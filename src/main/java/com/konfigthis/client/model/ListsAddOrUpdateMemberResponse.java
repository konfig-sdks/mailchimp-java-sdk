...
import com.konfigthis.client.model.SubscriberStatsProperty9;
...
public class ListsAddOrUpdateMemberResponse {
 ...
 public enum SmsSubscriptionStatusEnum {
  ...
  private SubscriberStatsProperty9 stats;
  ...
  public ListsAddOrUpdateMemberResponse() {
  }
  ...
  public ListsAddOrUpdateMemberResponse tags(List<TagsPropertyInner> tags) {
  ...
  public ListsAddOrUpdateMemberResponse addTagsItem(TagsPropertyInner tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse emailAddress(String emailAddress) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse emailType(String emailType) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse status(StatusEnum status) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse unsubscribeReason(String unsubscribeReason) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse smsPhoneNumber(String smsPhoneNumber) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse smsSubscriptionStatus(SmsSubscriptionStatusEnum smsSubscriptionStatus) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse smsSubscriptionLastUpdated(String smsSubscriptionLastUpdated) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse mergeFields(Map<String, Object> mergeFields) {
  ...
  public ListsAddOrUpdateMemberResponse putMergeFieldsItem(String key, Object mergeFieldsItem) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse interests(Map<String, Boolean> interests) {
  ...
  public ListsAddOrUpdateMemberResponse putInterestsItem(String key, Boolean interestsItem) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse stats(SubscriberStatsProperty9 stats) {
  ...
  **/
  ...
  public SubscriberStatsProperty9 getStats() {
    return stats;
  }


  public void setStats(SubscriberStatsProperty9 stats) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse language(String language) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse vip(Boolean vip) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse location(LocationProperty2 location) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse marketingPermissions(List<MarketingPermission1> marketingPermissions) {
  ...
  public ListsAddOrUpdateMemberResponse addMarketingPermissionsItem(MarketingPermission1 marketingPermissionsItem) {
  ...
  **/
  ...
  public ListsAddOrUpdateMemberResponse lastNote(NotesProperty lastNote) {
  ...
  **/
   ...
   * @return the ListsAddOrUpdateMemberResponse instance itself
   */
  public ListsAddOrUpdateMemberResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListsAddOrUpdateMemberResponse listsAddOrUpdateMemberResponse = (ListsAddOrUpdateMemberResponse) o;
    return Objects.equals(this.tags, listsAddOrUpdateMemberResponse.tags) &&
        Objects.equals(this.id, listsAddOrUpdateMemberResponse.id) &&
        Objects.equals(this.emailAddress, listsAddOrUpdateMemberResponse.emailAddress) &&
        Objects.equals(this.uniqueEmailId, listsAddOrUpdateMemberResponse.uniqueEmailId) &&
        Objects.equals(this.contactId, listsAddOrUpdateMemberResponse.contactId) &&
        Objects.equals(this.fullName, listsAddOrUpdateMemberResponse.fullName) &&
        Objects.equals(this.webId, listsAddOrUpdateMemberResponse.webId) &&
        Objects.equals(this.emailType, listsAddOrUpdateMemberResponse.emailType) &&
        Objects.equals(this.status, listsAddOrUpdateMemberResponse.status) &&
        Objects.equals(this.unsubscribeReason, listsAddOrUpdateMemberResponse.unsubscribeReason) &&
        Objects.equals(this.consentsToOneToOneMessaging, listsAddOrUpdateMemberResponse.consentsToOneToOneMessaging) &&
        Objects.equals(this.smsPhoneNumber, listsAddOrUpdateMemberResponse.smsPhoneNumber) &&
        Objects.equals(this.smsSubscriptionStatus, listsAddOrUpdateMemberResponse.smsSubscriptionStatus) &&
        Objects.equals(this.smsSubscriptionLastUpdated, listsAddOrUpdateMemberResponse.smsSubscriptionLastUpdated) &&
        Objects.equals(this.mergeFields, listsAddOrUpdateMemberResponse.mergeFields) &&
        Objects.equals(this.interests, listsAddOrUpdateMemberResponse.interests) &&
        Objects.equals(this.stats, listsAddOrUpdateMemberResponse.stats) &&
        Objects.equals(this.ipSignup, listsAddOrUpdateMemberResponse.ipSignup) &&
        Objects.equals(this.timestampSignup, listsAddOrUpdateMemberResponse.timestampSignup) &&
        Objects.equals(this.ipOpt, listsAddOrUpdateMemberResponse.ipOpt) &&
        Objects.equals(this.timestampOpt, listsAddOrUpdateMemberResponse.timestampOpt) &&
        Objects.equals(this.memberRating, listsAddOrUpdateMemberResponse.memberRating) &&
        Objects.equals(this.lastChanged, listsAddOrUpdateMemberResponse.lastChanged) &&
        Objects.equals(this.language, listsAddOrUpdateMemberResponse.language) &&
        Objects.equals(this.vip, listsAddOrUpdateMemberResponse.vip) &&
        Objects.equals(this.emailClient, listsAddOrUpdateMemberResponse.emailClient) &&
        Objects.equals(this.location, listsAddOrUpdateMemberResponse.location) &&
        Objects.equals(this.marketingPermissions, listsAddOrUpdateMemberResponse.marketingPermissions) &&
        Objects.equals(this.lastNote, listsAddOrUpdateMemberResponse.lastNote) &&
        Objects.equals(this.source, listsAddOrUpdateMemberResponse.source) &&
        Objects.equals(this.tagsCount, listsAddOrUpdateMemberResponse.tagsCount) &&
        Objects.equals(this.listId, listsAddOrUpdateMemberResponse.listId) &&
        Objects.equals(this.links, listsAddOrUpdateMemberResponse.links)&&
        Objects.equals(this.additionalProperties, listsAddOrUpdateMemberResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListsAddOrUpdateMemberResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListsAddOrUpdateMemberResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListsAddOrUpdateMemberResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListsAddOrUpdateMemberResponse is not found in the empty JSON string", ListsAddOrUpdateMemberResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("stats") != null && !jsonObj.get("stats").isJsonNull()) {
        SubscriberStatsProperty9.validateJsonObject(jsonObj.getAsJsonObject("stats"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListsAddOrUpdateMemberResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListsAddOrUpdateMemberResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListsAddOrUpdateMemberResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListsAddOrUpdateMemberResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListsAddOrUpdateMemberResponse>() {
           @Override
           public void write(JsonWriter out, ListsAddOrUpdateMemberResponse value) throws IOException {
           ...
           @Override
           public ListsAddOrUpdateMemberResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListsAddOrUpdateMemberResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListsAddOrUpdateMemberResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListsAddOrUpdateMemberResponse
  * @throws IOException if the JSON string is invalid with respect to ListsAddOrUpdateMemberResponse
  */
  public static ListsAddOrUpdateMemberResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListsAddOrUpdateMemberResponse.class);
  }

 /**
  * Convert an instance of ListsAddOrUpdateMemberResponse to an JSON string
  *
  * @return JSON string
  */
