...
import com.konfigthis.client.model.SegmentOptionsProperty27;
...
public class RecipientsProperty2 {
  ...
  private SegmentOptionsProperty27 segmentOpts;

  public RecipientsProperty2() {
  }
  ...
  public RecipientsProperty2 listId(String listId) {
  ...
  **/
  ...
  public RecipientsProperty2 segmentOpts(SegmentOptionsProperty27 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty27 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty27 segmentOpts) {
   ...
   * @return the RecipientsProperty2 instance itself
   */
  public RecipientsProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecipientsProperty2 recipientsProperty2 = (RecipientsProperty2) o;
    return Objects.equals(this.listId, recipientsProperty2.listId) &&
        Objects.equals(this.listIsActive, recipientsProperty2.listIsActive) &&
        Objects.equals(this.listName, recipientsProperty2.listName) &&
        Objects.equals(this.segmentText, recipientsProperty2.segmentText) &&
        Objects.equals(this.recipientCount, recipientsProperty2.recipientCount) &&
        Objects.equals(this.segmentOpts, recipientsProperty2.segmentOpts)&&
        Objects.equals(this.additionalProperties, recipientsProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipientsProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecipientsProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecipientsProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecipientsProperty2 is not found in the empty JSON string", RecipientsProperty2.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty27.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecipientsProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecipientsProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecipientsProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecipientsProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<RecipientsProperty2>() {
           @Override
           public void write(JsonWriter out, RecipientsProperty2 value) throws IOException {
           ...
           @Override
           public RecipientsProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecipientsProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecipientsProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecipientsProperty2
  * @throws IOException if the JSON string is invalid with respect to RecipientsProperty2
  */
  public static RecipientsProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecipientsProperty2.class);
  }

 /**
  * Convert an instance of RecipientsProperty2 to an JSON string
  *
  * @return JSON string
  */
