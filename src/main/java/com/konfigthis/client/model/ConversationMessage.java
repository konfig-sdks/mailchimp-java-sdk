...
public class ConversationMessage {
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, conversationMessage.id) &&
        ...
        Objects.equals(this.additionalProperties, conversationMessage.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConversationMessage.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
