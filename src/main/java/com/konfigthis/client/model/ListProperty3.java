...
public class ListProperty3 {
  ...
  public ListProperty3 listId(String listId) {
  ...
  **/
  ...
  public ListProperty3 listName(String listName) {
  ...
  **/
  ...
  public ListProperty3 segmentOpts(SegmentOptionsProperty2 segmentOpts) {
  ...
  **/
  ...
  public ListProperty3 storeId(String storeId) {
  ...
  **/
   ...
   * @return the ListProperty3 instance itself
   */
  public ListProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty3 listProperty3 = (ListProperty3) o;
    return Objects.equals(this.listId, listProperty3.listId) &&
        Objects.equals(this.listIsActive, listProperty3.listIsActive) &&
        Objects.equals(this.listName, listProperty3.listName) &&
        Objects.equals(this.segmentOpts, listProperty3.segmentOpts) &&
        Objects.equals(this.storeId, listProperty3.storeId)&&
        Objects.equals(this.additionalProperties, listProperty3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty3 is not found in the empty JSON string", ListProperty3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty3>() {
           @Override
           public void write(JsonWriter out, ListProperty3 value) throws IOException {
           ...
           @Override
           public ListProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty3
  * @throws IOException if the JSON string is invalid with respect to ListProperty3
  */
  public static ListProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty3.class);
  }

 /**
  * Convert an instance of ListProperty3 to an JSON string
  *
  * @return JSON string
  */
