...
public class ECommerceProductVariant {
  ...
  **/
  ...
  public ECommerceProductVariant price(Double price) {
  ...
  public ECommerceProductVariant price(Integer price) {
  ...
  **/
   ...
   * @return the ECommerceProductVariant instance itself
   */
  public ECommerceProductVariant putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, eCommerceProductVariant.title) &&
        Objects.equals(this.id, eCommerceProductVariant.id) &&
        ...
        Objects.equals(this.additionalProperties, eCommerceProductVariant.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceProductVariant
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceProductVariant.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceProductVariant is not found in the empty JSON string", ECommerceProductVariant.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ECommerceProductVariant.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceProductVariant.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceProductVariant' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceProductVariant> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceProductVariant.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceProductVariant>() {
           @Override
           public void write(JsonWriter out, ECommerceProductVariant value) throws IOException {
           ...
           @Override
           public ECommerceProductVariant read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceProductVariant instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceProductVariant given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceProductVariant
  * @throws IOException if the JSON string is invalid with respect to ECommerceProductVariant
  */
  public static ECommerceProductVariant fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceProductVariant.class);
  }

 /**
  * Convert an instance of ECommerceProductVariant to an JSON string
  *
  * @return JSON string
  */
