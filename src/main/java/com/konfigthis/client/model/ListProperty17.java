...
import com.konfigthis.client.model.SegmentOptionsProperty11;
...
public class ListProperty17 {
  ...
  private SegmentOptionsProperty11 segmentOpts;

  public ListProperty17() {
  }
  ...
  public ListProperty17 listId(String listId) {
  ...
  **/
  ...
  public ListProperty17 segmentOpts(SegmentOptionsProperty11 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty11 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty11 segmentOpts) {
   ...
   * @return the ListProperty17 instance itself
   */
  public ListProperty17 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty17 listProperty17 = (ListProperty17) o;
    return Objects.equals(this.listId, listProperty17.listId) &&
        Objects.equals(this.listIsActive, listProperty17.listIsActive) &&
        Objects.equals(this.listName, listProperty17.listName) &&
        Objects.equals(this.segmentText, listProperty17.segmentText) &&
        Objects.equals(this.recipientCount, listProperty17.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty17.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty17.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty17 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty17
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty17.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty17 is not found in the empty JSON string", ListProperty17.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty11.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty17.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty17' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty17> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty17.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty17>() {
           @Override
           public void write(JsonWriter out, ListProperty17 value) throws IOException {
           ...
           @Override
           public ListProperty17 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty17 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty17 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty17
  * @throws IOException if the JSON string is invalid with respect to ListProperty17
  */
  public static ListProperty17 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty17.class);
  }

 /**
  * Convert an instance of ListProperty17 to an JSON string
  *
  * @return JSON string
  */
