...
import com.konfigthis.client.model.VariateContentsPropertyInner1;
...
public class CampaignsGetContentResponse {
  ...
  private List<VariateContentsPropertyInner1> variateContents = null;
  ...
  public CampaignsGetContentResponse() {
  }
  ...
  public CampaignsGetContentResponse variateContents(List<VariateContentsPropertyInner1> variateContents) {
  ...
  public CampaignsGetContentResponse addVariateContentsItem(VariateContentsPropertyInner1 variateContentsItem) {
  ...
  **/
  ...
  public List<VariateContentsPropertyInner1> getVariateContents() {
    return variateContents;
  }


  public void setVariateContents(List<VariateContentsPropertyInner1> variateContents) {
  ...
  public CampaignsGetContentResponse plainText(String plainText) {
  ...
  **/
  ...
  public CampaignsGetContentResponse html(String html) {
  ...
  **/
  ...
  public CampaignsGetContentResponse archiveHtml(String archiveHtml) {
  ...
  **/
   ...
   * @return the CampaignsGetContentResponse instance itself
   */
  public CampaignsGetContentResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsGetContentResponse campaignsGetContentResponse = (CampaignsGetContentResponse) o;
    return Objects.equals(this.variateContents, campaignsGetContentResponse.variateContents) &&
        Objects.equals(this.plainText, campaignsGetContentResponse.plainText) &&
        Objects.equals(this.html, campaignsGetContentResponse.html) &&
        Objects.equals(this.archiveHtml, campaignsGetContentResponse.archiveHtml) &&
        Objects.equals(this.links, campaignsGetContentResponse.links)&&
        Objects.equals(this.additionalProperties, campaignsGetContentResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsGetContentResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsGetContentResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsGetContentResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsGetContentResponse is not found in the empty JSON string", CampaignsGetContentResponse.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("variate_contents") != null && !jsonObj.get("variate_contents").isJsonNull()) {
        ...
        if (jsonArrayvariateContents != null) {
          ...
          for (int i = 0; i < jsonArrayvariateContents.size(); i++) {
            VariateContentsPropertyInner1.validateJsonObject(jsonArrayvariateContents.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsGetContentResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsGetContentResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsGetContentResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsGetContentResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsGetContentResponse>() {
           @Override
           public void write(JsonWriter out, CampaignsGetContentResponse value) throws IOException {
           ...
           @Override
           public CampaignsGetContentResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsGetContentResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsGetContentResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsGetContentResponse
  * @throws IOException if the JSON string is invalid with respect to CampaignsGetContentResponse
  */
  public static CampaignsGetContentResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsGetContentResponse.class);
  }

 /**
  * Convert an instance of CampaignsGetContentResponse to an JSON string
  *
  * @return JSON string
  */
