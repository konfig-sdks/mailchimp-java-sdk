...
import com.konfigthis.client.model.SegmentOptionsProperty18;
...
public class ListProperty24 {
  ...
  private SegmentOptionsProperty18 segmentOpts;

  public ListProperty24() {
  }
  ...
  public ListProperty24 listId(String listId) {
  ...
  **/
  ...
  public ListProperty24 segmentOpts(SegmentOptionsProperty18 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty18 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty18 segmentOpts) {
   ...
   * @return the ListProperty24 instance itself
   */
  public ListProperty24 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty24 listProperty24 = (ListProperty24) o;
    return Objects.equals(this.listId, listProperty24.listId) &&
        Objects.equals(this.listName, listProperty24.listName) &&
        Objects.equals(this.segmentText, listProperty24.segmentText) &&
        Objects.equals(this.recipientCount, listProperty24.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty24.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty24.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty24 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty24
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty24.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty24 is not found in the empty JSON string", ListProperty24.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListProperty24.openapiRequiredFields) {
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty18.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty24.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty24' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty24> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty24.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty24>() {
           @Override
           public void write(JsonWriter out, ListProperty24 value) throws IOException {
           ...
           @Override
           public ListProperty24 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty24 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty24 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty24
  * @throws IOException if the JSON string is invalid with respect to ListProperty24
  */
  public static ListProperty24 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty24.class);
  }

 /**
  * Convert an instance of ListProperty24 to an JSON string
  *
  * @return JSON string
  */
