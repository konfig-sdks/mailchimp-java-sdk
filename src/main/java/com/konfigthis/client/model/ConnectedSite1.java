...
import com.konfigthis.client.model.ScriptProperty1;
...
public class ConnectedSite1 {
  ...
  private ScriptProperty1 siteScript;
  ...
  **/
  ...
  public ConnectedSite1 siteScript(ScriptProperty1 siteScript) {
  ...
  **/
  ...
  public ScriptProperty1 getSiteScript() {
    return siteScript;
  }


  public void setSiteScript(ScriptProperty1 siteScript) {
  ...
  **/
   ...
   * @return the ConnectedSite1 instance itself
   */
  public ConnectedSite1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.foreignId, connectedSite1.foreignId) &&
        ...
        Objects.equals(this.links, connectedSite1.links)&&
        Objects.equals(this.additionalProperties, connectedSite1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectedSite1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectedSite1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectedSite1 is not found in the empty JSON string", ConnectedSite1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("site_script") != null && !jsonObj.get("site_script").isJsonNull()) {
        ScriptProperty1.validateJsonObject(jsonObj.getAsJsonObject("site_script"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectedSite1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectedSite1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectedSite1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectedSite1.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectedSite1>() {
           @Override
           public void write(JsonWriter out, ConnectedSite1 value) throws IOException {
           ...
           @Override
           public ConnectedSite1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConnectedSite1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConnectedSite1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConnectedSite1
  * @throws IOException if the JSON string is invalid with respect to ConnectedSite1
  */
  public static ConnectedSite1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectedSite1.class);
  }

 /**
  * Convert an instance of ConnectedSite1 to an JSON string
  *
  * @return JSON string
  */
