...
public class SegmentOptions2 {
  ...
  **/
  ...
  public SegmentOptions2 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
   ...
   * @return the SegmentOptions2 instance itself
   */
  public SegmentOptions2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.savedSegmentId, segmentOptions2.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptions2.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptions2.match) &&
        Objects.equals(this.conditions, segmentOptions2.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptions2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptions2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptions2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptions2 is not found in the empty JSON string", SegmentOptions2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptions2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptions2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptions2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptions2.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptions2>() {
           @Override
           public void write(JsonWriter out, SegmentOptions2 value) throws IOException {
           ...
           @Override
           public SegmentOptions2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptions2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptions2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptions2
  * @throws IOException if the JSON string is invalid with respect to SegmentOptions2
  */
  public static SegmentOptions2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptions2.class);
  }

 /**
  * Convert an instance of SegmentOptions2 to an JSON string
  *
  * @return JSON string
  */
