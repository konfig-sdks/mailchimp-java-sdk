...
import com.konfigthis.client.model.ListProperty27;
...
public class SurveysGenerateCampaignResponse {
 ...
 public enum StatusEnum {
  ...
  private ListProperty27 recipients;
  ...
  public SurveysGenerateCampaignResponse() {
  }
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse type(TypeEnum type) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse recipients(ListProperty27 recipients) {
  ...
  **/
  ...
  public ListProperty27 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty27 recipients) {
  ...
  public SurveysGenerateCampaignResponse settings(CampaignSettingsProperty5 settings) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse variateSettings(ABTestOptionsProperty2 variateSettings) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse rssOpts(RSSOptionsProperty3 rssOpts) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse reportSummary(CampaignReportSummaryProperty3 reportSummary) {
  ...
  **/
  ...
  public SurveysGenerateCampaignResponse deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
   ...
   * @return the SurveysGenerateCampaignResponse instance itself
   */
  public SurveysGenerateCampaignResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SurveysGenerateCampaignResponse surveysGenerateCampaignResponse = (SurveysGenerateCampaignResponse) o;
    return Objects.equals(this.id, surveysGenerateCampaignResponse.id) &&
        Objects.equals(this.webId, surveysGenerateCampaignResponse.webId) &&
        Objects.equals(this.parentCampaignId, surveysGenerateCampaignResponse.parentCampaignId) &&
        Objects.equals(this.type, surveysGenerateCampaignResponse.type) &&
        Objects.equals(this.createTime, surveysGenerateCampaignResponse.createTime) &&
        Objects.equals(this.archiveUrl, surveysGenerateCampaignResponse.archiveUrl) &&
        Objects.equals(this.longArchiveUrl, surveysGenerateCampaignResponse.longArchiveUrl) &&
        Objects.equals(this.status, surveysGenerateCampaignResponse.status) &&
        Objects.equals(this.emailsSent, surveysGenerateCampaignResponse.emailsSent) &&
        Objects.equals(this.sendTime, surveysGenerateCampaignResponse.sendTime) &&
        Objects.equals(this.contentType, surveysGenerateCampaignResponse.contentType) &&
        Objects.equals(this.needsBlockRefresh, surveysGenerateCampaignResponse.needsBlockRefresh) &&
        Objects.equals(this.resendable, surveysGenerateCampaignResponse.resendable) &&
        Objects.equals(this.recipients, surveysGenerateCampaignResponse.recipients) &&
        Objects.equals(this.settings, surveysGenerateCampaignResponse.settings) &&
        Objects.equals(this.variateSettings, surveysGenerateCampaignResponse.variateSettings) &&
        Objects.equals(this.tracking, surveysGenerateCampaignResponse.tracking) &&
        Objects.equals(this.rssOpts, surveysGenerateCampaignResponse.rssOpts) &&
        Objects.equals(this.abSplitOpts, surveysGenerateCampaignResponse.abSplitOpts) &&
        Objects.equals(this.socialCard, surveysGenerateCampaignResponse.socialCard) &&
        Objects.equals(this.reportSummary, surveysGenerateCampaignResponse.reportSummary) &&
        Objects.equals(this.deliveryStatus, surveysGenerateCampaignResponse.deliveryStatus) &&
        Objects.equals(this.links, surveysGenerateCampaignResponse.links)&&
        Objects.equals(this.additionalProperties, surveysGenerateCampaignResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SurveysGenerateCampaignResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SurveysGenerateCampaignResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SurveysGenerateCampaignResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SurveysGenerateCampaignResponse is not found in the empty JSON string", SurveysGenerateCampaignResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : SurveysGenerateCampaignResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty27.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SurveysGenerateCampaignResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SurveysGenerateCampaignResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SurveysGenerateCampaignResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SurveysGenerateCampaignResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<SurveysGenerateCampaignResponse>() {
           @Override
           public void write(JsonWriter out, SurveysGenerateCampaignResponse value) throws IOException {
           ...
           @Override
           public SurveysGenerateCampaignResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SurveysGenerateCampaignResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SurveysGenerateCampaignResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SurveysGenerateCampaignResponse
  * @throws IOException if the JSON string is invalid with respect to SurveysGenerateCampaignResponse
  */
  public static SurveysGenerateCampaignResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SurveysGenerateCampaignResponse.class);
  }

 /**
  * Convert an instance of SurveysGenerateCampaignResponse to an JSON string
  *
  * @return JSON string
  */
