...
public class SegmentOptionsProperty24 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty24() {
  }

  public SegmentOptionsProperty24 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty24 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty24 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty24 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty24 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty24 instance itself
   */
  public SegmentOptionsProperty24 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty24 segmentOptionsProperty24 = (SegmentOptionsProperty24) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty24.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty24.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty24.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty24.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty24.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty24 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty24
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty24.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty24 is not found in the empty JSON string", SegmentOptionsProperty24.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty24.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty24' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty24> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty24.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty24>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty24 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty24 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty24 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty24 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty24
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty24
  */
  public static SegmentOptionsProperty24 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty24.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty24 to an JSON string
  *
  * @return JSON string
  */
