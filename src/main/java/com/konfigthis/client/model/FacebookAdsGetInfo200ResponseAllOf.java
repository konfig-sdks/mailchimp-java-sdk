...
public class FacebookAdsGetInfo200ResponseAllOf {
 ...
 public enum StatusEnum {
  ...
  public FacebookAdsGetInfo200ResponseAllOf() {
  }

  public FacebookAdsGetInfo200ResponseAllOf id(String id) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf webId(Integer webId) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf name(String name) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf type(TypeEnum type) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf status(StatusEnum status) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf showReport(Boolean showReport) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf createTime(OffsetDateTime createTime) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf startTime(OffsetDateTime startTime) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf canceledAt(OffsetDateTime canceledAt) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf publishedTime(OffsetDateTime publishedTime) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf hasSegment(Boolean hasSegment) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf reportSummary(ReportSummary reportSummary) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf recipients(Recipients1 recipients) {
  ...
  **/
  ...
  public FacebookAdsGetInfo200ResponseAllOf thumbnail(String thumbnail) {
  ...
  **/
   ...
   * @return the FacebookAdsGetInfo200ResponseAllOf instance itself
   */
  public FacebookAdsGetInfo200ResponseAllOf putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FacebookAdsGetInfo200ResponseAllOf facebookAdsGetInfo200ResponseAllOf = (FacebookAdsGetInfo200ResponseAllOf) o;
    return Objects.equals(this.id, facebookAdsGetInfo200ResponseAllOf.id) &&
        Objects.equals(this.webId, facebookAdsGetInfo200ResponseAllOf.webId) &&
        Objects.equals(this.name, facebookAdsGetInfo200ResponseAllOf.name) &&
        Objects.equals(this.type, facebookAdsGetInfo200ResponseAllOf.type) &&
        Objects.equals(this.status, facebookAdsGetInfo200ResponseAllOf.status) &&
        Objects.equals(this.showReport, facebookAdsGetInfo200ResponseAllOf.showReport) &&
        Objects.equals(this.createTime, facebookAdsGetInfo200ResponseAllOf.createTime) &&
        Objects.equals(this.startTime, facebookAdsGetInfo200ResponseAllOf.startTime) &&
        Objects.equals(this.updatedAt, facebookAdsGetInfo200ResponseAllOf.updatedAt) &&
        Objects.equals(this.canceledAt, facebookAdsGetInfo200ResponseAllOf.canceledAt) &&
        Objects.equals(this.publishedTime, facebookAdsGetInfo200ResponseAllOf.publishedTime) &&
        Objects.equals(this.hasSegment, facebookAdsGetInfo200ResponseAllOf.hasSegment) &&
        Objects.equals(this.reportSummary, facebookAdsGetInfo200ResponseAllOf.reportSummary) &&
        Objects.equals(this.recipients, facebookAdsGetInfo200ResponseAllOf.recipients) &&
        Objects.equals(this.thumbnail, facebookAdsGetInfo200ResponseAllOf.thumbnail)&&
        Objects.equals(this.additionalProperties, facebookAdsGetInfo200ResponseAllOf.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FacebookAdsGetInfo200ResponseAllOf {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FacebookAdsGetInfo200ResponseAllOf
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FacebookAdsGetInfo200ResponseAllOf.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FacebookAdsGetInfo200ResponseAllOf is not found in the empty JSON string", FacebookAdsGetInfo200ResponseAllOf.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FacebookAdsGetInfo200ResponseAllOf.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FacebookAdsGetInfo200ResponseAllOf' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FacebookAdsGetInfo200ResponseAllOf> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FacebookAdsGetInfo200ResponseAllOf.class));

       return (TypeAdapter<T>) new TypeAdapter<FacebookAdsGetInfo200ResponseAllOf>() {
           @Override
           public void write(JsonWriter out, FacebookAdsGetInfo200ResponseAllOf value) throws IOException {
           ...
           @Override
           public FacebookAdsGetInfo200ResponseAllOf read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FacebookAdsGetInfo200ResponseAllOf instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FacebookAdsGetInfo200ResponseAllOf given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FacebookAdsGetInfo200ResponseAllOf
  * @throws IOException if the JSON string is invalid with respect to FacebookAdsGetInfo200ResponseAllOf
  */
  public static FacebookAdsGetInfo200ResponseAllOf fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FacebookAdsGetInfo200ResponseAllOf.class);
  }

 /**
  * Convert an instance of FacebookAdsGetInfo200ResponseAllOf to an JSON string
  *
  * @return JSON string
  */
