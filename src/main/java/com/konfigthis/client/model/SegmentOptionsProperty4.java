...
public class SegmentOptionsProperty4 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty4() {
  }

  public SegmentOptionsProperty4 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty4 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty4 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty4 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty4 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty4 instance itself
   */
  public SegmentOptionsProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty4 segmentOptionsProperty4 = (SegmentOptionsProperty4) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty4.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty4.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty4.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty4.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty4.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty4 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty4 is not found in the empty JSON string", SegmentOptionsProperty4.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty4>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty4 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty4
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty4
  */
  public static SegmentOptionsProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty4.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty4 to an JSON string
  *
  * @return JSON string
  */
