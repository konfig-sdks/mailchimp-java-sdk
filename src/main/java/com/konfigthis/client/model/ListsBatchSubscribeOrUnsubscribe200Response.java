...
public class ListsBatchSubscribeOrUnsubscribe200Response {
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response() {
  }
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response newMembers(List<ListMembers> newMembers) {
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response addNewMembersItem(ListMembers newMembersItem) {
  ...
  **/
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response updatedMembers(List<ListMembers> updatedMembers) {
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response addUpdatedMembersItem(ListMembers updatedMembersItem) {
  ...
  **/
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response errors(List<ErrorsPropertyInner> errors) {
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response addErrorsItem(ErrorsPropertyInner errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response totalCreated(Integer totalCreated) {
  ...
  **/
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response totalUpdated(Integer totalUpdated) {
  ...
  **/
  ...
  public ListsBatchSubscribeOrUnsubscribe200Response errorCount(Integer errorCount) {
  ...
  **/
   ...
   * @return the ListsBatchSubscribeOrUnsubscribe200Response instance itself
   */
  public ListsBatchSubscribeOrUnsubscribe200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListsBatchSubscribeOrUnsubscribe200Response listsBatchSubscribeOrUnsubscribe200Response = (ListsBatchSubscribeOrUnsubscribe200Response) o;
    return Objects.equals(this.newMembers, listsBatchSubscribeOrUnsubscribe200Response.newMembers) &&
        Objects.equals(this.updatedMembers, listsBatchSubscribeOrUnsubscribe200Response.updatedMembers) &&
        Objects.equals(this.errors, listsBatchSubscribeOrUnsubscribe200Response.errors) &&
        Objects.equals(this.totalCreated, listsBatchSubscribeOrUnsubscribe200Response.totalCreated) &&
        Objects.equals(this.totalUpdated, listsBatchSubscribeOrUnsubscribe200Response.totalUpdated) &&
        Objects.equals(this.errorCount, listsBatchSubscribeOrUnsubscribe200Response.errorCount) &&
        Objects.equals(this.links, listsBatchSubscribeOrUnsubscribe200Response.links)&&
        Objects.equals(this.additionalProperties, listsBatchSubscribeOrUnsubscribe200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListsBatchSubscribeOrUnsubscribe200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListsBatchSubscribeOrUnsubscribe200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListsBatchSubscribeOrUnsubscribe200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListsBatchSubscribeOrUnsubscribe200Response is not found in the empty JSON string", ListsBatchSubscribeOrUnsubscribe200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListsBatchSubscribeOrUnsubscribe200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListsBatchSubscribeOrUnsubscribe200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListsBatchSubscribeOrUnsubscribe200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListsBatchSubscribeOrUnsubscribe200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListsBatchSubscribeOrUnsubscribe200Response>() {
           @Override
           public void write(JsonWriter out, ListsBatchSubscribeOrUnsubscribe200Response value) throws IOException {
           ...
           @Override
           public ListsBatchSubscribeOrUnsubscribe200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListsBatchSubscribeOrUnsubscribe200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListsBatchSubscribeOrUnsubscribe200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListsBatchSubscribeOrUnsubscribe200Response
  * @throws IOException if the JSON string is invalid with respect to ListsBatchSubscribeOrUnsubscribe200Response
  */
  public static ListsBatchSubscribeOrUnsubscribe200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListsBatchSubscribeOrUnsubscribe200Response.class);
  }

 /**
  * Convert an instance of ListsBatchSubscribeOrUnsubscribe200Response to an JSON string
  *
  * @return JSON string
  */
