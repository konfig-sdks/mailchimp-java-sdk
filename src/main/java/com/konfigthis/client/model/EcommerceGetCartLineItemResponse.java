...
public class EcommerceGetCartLineItemResponse {
  ...
  public EcommerceGetCartLineItemResponse() {
  }
  ...
  **/
  ...
  public EcommerceGetCartLineItemResponse productId(String productId) {
  ...
  **/
  ...
  public EcommerceGetCartLineItemResponse productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceGetCartLineItemResponse quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceGetCartLineItemResponse price(Double price) {
  ...
  public EcommerceGetCartLineItemResponse price(Integer price) {
  ...
  **/
   ...
   * @return the EcommerceGetCartLineItemResponse instance itself
   */
  public EcommerceGetCartLineItemResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceGetCartLineItemResponse ecommerceGetCartLineItemResponse = (EcommerceGetCartLineItemResponse) o;
    return Objects.equals(this.id, ecommerceGetCartLineItemResponse.id) &&
        Objects.equals(this.productId, ecommerceGetCartLineItemResponse.productId) &&
        Objects.equals(this.productTitle, ecommerceGetCartLineItemResponse.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceGetCartLineItemResponse.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceGetCartLineItemResponse.productVariantTitle) &&
        Objects.equals(this.quantity, ecommerceGetCartLineItemResponse.quantity) &&
        Objects.equals(this.price, ecommerceGetCartLineItemResponse.price) &&
        Objects.equals(this.links, ecommerceGetCartLineItemResponse.links)&&
        Objects.equals(this.additionalProperties, ecommerceGetCartLineItemResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceGetCartLineItemResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceGetCartLineItemResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceGetCartLineItemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceGetCartLineItemResponse is not found in the empty JSON string", EcommerceGetCartLineItemResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceGetCartLineItemResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceGetCartLineItemResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceGetCartLineItemResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceGetCartLineItemResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceGetCartLineItemResponse>() {
           @Override
           public void write(JsonWriter out, EcommerceGetCartLineItemResponse value) throws IOException {
           ...
           @Override
           public EcommerceGetCartLineItemResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceGetCartLineItemResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceGetCartLineItemResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceGetCartLineItemResponse
  * @throws IOException if the JSON string is invalid with respect to EcommerceGetCartLineItemResponse
  */
  public static EcommerceGetCartLineItemResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceGetCartLineItemResponse.class);
  }

 /**
  * Convert an instance of EcommerceGetCartLineItemResponse to an JSON string
  *
  * @return JSON string
  */
