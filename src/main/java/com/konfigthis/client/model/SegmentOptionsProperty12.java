...
public class SegmentOptionsProperty12 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty12() {
  }

  public SegmentOptionsProperty12 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty12 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty12 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty12 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty12 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty12 instance itself
   */
  public SegmentOptionsProperty12 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty12 segmentOptionsProperty12 = (SegmentOptionsProperty12) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty12.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty12.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty12.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty12.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty12.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty12 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty12
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty12.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty12 is not found in the empty JSON string", SegmentOptionsProperty12.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty12.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty12>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty12 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty12 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty12 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty12 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty12
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty12
  */
  public static SegmentOptionsProperty12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty12.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty12 to an JSON string
  *
  * @return JSON string
  */
