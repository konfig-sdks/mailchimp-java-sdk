...
public class ListMembers1 {
  ...
  **/
  ...
  public ListMembers1 stats(SubscriberStatsProperty stats) {
  ...
  **/
  ...
  public ListMembers1 location(LocationProperty1 location) {
  ...
  **/
  ...
  public ListMembers1 lastNote(NotesProperty lastNote) {
  ...
  **/
   ...
   * @return the ListMembers1 instance itself
   */
  public ListMembers1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, listMembers1.id) &&
        ...
        Objects.equals(this.additionalProperties, listMembers1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMembers1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMembers1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMembers1 is not found in the empty JSON string", ListMembers1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMembers1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMembers1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMembers1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMembers1.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMembers1>() {
           @Override
           public void write(JsonWriter out, ListMembers1 value) throws IOException {
           ...
           @Override
           public ListMembers1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMembers1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMembers1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMembers1
  * @throws IOException if the JSON string is invalid with respect to ListMembers1
  */
  public static ListMembers1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMembers1.class);
  }

 /**
  * Convert an instance of ListMembers1 to an JSON string
  *
  * @return JSON string
  */
