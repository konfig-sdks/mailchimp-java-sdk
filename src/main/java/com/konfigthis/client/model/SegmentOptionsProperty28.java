...
public class SegmentOptionsProperty28 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty28() {
  }

  public SegmentOptionsProperty28 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty28 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty28 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty28 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty28 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty28 instance itself
   */
  public SegmentOptionsProperty28 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty28 segmentOptionsProperty28 = (SegmentOptionsProperty28) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty28.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty28.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty28.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty28.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty28.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty28 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty28
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty28.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty28 is not found in the empty JSON string", SegmentOptionsProperty28.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty28.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty28' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty28> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty28.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty28>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty28 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty28 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty28 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty28 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty28
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty28
  */
  public static SegmentOptionsProperty28 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty28.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty28 to an JSON string
  *
  * @return JSON string
  */
