...
import com.konfigthis.client.model.SegmentOptionsProperty12;
...
public class ListProperty18 {
  ...
  private SegmentOptionsProperty12 segmentOpts;

  public ListProperty18() {
  }
  ...
  public ListProperty18 listId(String listId) {
  ...
  **/
  ...
  public ListProperty18 segmentOpts(SegmentOptionsProperty12 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty12 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty12 segmentOpts) {
   ...
   * @return the ListProperty18 instance itself
   */
  public ListProperty18 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty18 listProperty18 = (ListProperty18) o;
    return Objects.equals(this.listId, listProperty18.listId) &&
        Objects.equals(this.listIsActive, listProperty18.listIsActive) &&
        Objects.equals(this.listName, listProperty18.listName) &&
        Objects.equals(this.segmentText, listProperty18.segmentText) &&
        Objects.equals(this.recipientCount, listProperty18.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty18.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty18.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty18 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty18
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty18.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty18 is not found in the empty JSON string", ListProperty18.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty12.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty18.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty18' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty18> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty18.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty18>() {
           @Override
           public void write(JsonWriter out, ListProperty18 value) throws IOException {
           ...
           @Override
           public ListProperty18 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty18 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty18 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty18
  * @throws IOException if the JSON string is invalid with respect to ListProperty18
  */
  public static ListProperty18 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty18.class);
  }

 /**
  * Convert an instance of ListProperty18 to an JSON string
  *
  * @return JSON string
  */
