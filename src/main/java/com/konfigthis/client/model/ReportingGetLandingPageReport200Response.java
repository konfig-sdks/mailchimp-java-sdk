...
import com.konfigthis.client.model.ReportingGetLandingPageReport200ResponseTimeseries;
...
public class ReportingGetLandingPageReport200Response {
  ...
  private ReportingGetLandingPageReport200ResponseTimeseries timeseries;
  ...
  public ReportingGetLandingPageReport200Response() {
  }
  ...
  **/
  ...
  public ReportingGetLandingPageReport200Response timeseries(ReportingGetLandingPageReport200ResponseTimeseries timeseries) {
  ...
  **/
  ...
  public ReportingGetLandingPageReport200ResponseTimeseries getTimeseries() {
    return timeseries;
  }


  public void setTimeseries(ReportingGetLandingPageReport200ResponseTimeseries timeseries) {
  ...
  public ReportingGetLandingPageReport200Response ecommerce(ReportingGetLandingPageReportResponseEcommerce ecommerce) {
  ...
  **/
   ...
   * @return the ReportingGetLandingPageReport200Response instance itself
   */
  public ReportingGetLandingPageReport200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReportingGetLandingPageReport200Response reportingGetLandingPageReport200Response = (ReportingGetLandingPageReport200Response) o;
    return Objects.equals(this.title, reportingGetLandingPageReport200Response.title) &&
        Objects.equals(this.id, reportingGetLandingPageReport200Response.id) &&
        Objects.equals(this.name, reportingGetLandingPageReport200Response.name) &&
        Objects.equals(this.url, reportingGetLandingPageReport200Response.url) &&
        Objects.equals(this.publishedAt, reportingGetLandingPageReport200Response.publishedAt) &&
        Objects.equals(this.unpublishedAt, reportingGetLandingPageReport200Response.unpublishedAt) &&
        Objects.equals(this.status, reportingGetLandingPageReport200Response.status) &&
        Objects.equals(this.listId, reportingGetLandingPageReport200Response.listId) &&
        Objects.equals(this.visits, reportingGetLandingPageReport200Response.visits) &&
        Objects.equals(this.uniqueVisits, reportingGetLandingPageReport200Response.uniqueVisits) &&
        Objects.equals(this.subscribes, reportingGetLandingPageReport200Response.subscribes) &&
        Objects.equals(this.clicks, reportingGetLandingPageReport200Response.clicks) &&
        Objects.equals(this.conversionRate, reportingGetLandingPageReport200Response.conversionRate) &&
        Objects.equals(this.timeseries, reportingGetLandingPageReport200Response.timeseries) &&
        Objects.equals(this.ecommerce, reportingGetLandingPageReport200Response.ecommerce) &&
        Objects.equals(this.webId, reportingGetLandingPageReport200Response.webId) &&
        Objects.equals(this.listName, reportingGetLandingPageReport200Response.listName) &&
        Objects.equals(this.signupTags, reportingGetLandingPageReport200Response.signupTags) &&
        Objects.equals(this.links, reportingGetLandingPageReport200Response.links)&&
        Objects.equals(this.additionalProperties, reportingGetLandingPageReport200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportingGetLandingPageReport200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReportingGetLandingPageReport200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReportingGetLandingPageReport200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportingGetLandingPageReport200Response is not found in the empty JSON string", ReportingGetLandingPageReport200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("timeseries") != null && !jsonObj.get("timeseries").isJsonNull()) {
        ReportingGetLandingPageReport200ResponseTimeseries.validateJsonObject(jsonObj.getAsJsonObject("timeseries"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportingGetLandingPageReport200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportingGetLandingPageReport200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportingGetLandingPageReport200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportingGetLandingPageReport200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportingGetLandingPageReport200Response>() {
           @Override
           public void write(JsonWriter out, ReportingGetLandingPageReport200Response value) throws IOException {
           ...
           @Override
           public ReportingGetLandingPageReport200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReportingGetLandingPageReport200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReportingGetLandingPageReport200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReportingGetLandingPageReport200Response
  * @throws IOException if the JSON string is invalid with respect to ReportingGetLandingPageReport200Response
  */
  public static ReportingGetLandingPageReport200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportingGetLandingPageReport200Response.class);
  }

 /**
  * Convert an instance of ReportingGetLandingPageReport200Response to an JSON string
  *
  * @return JSON string
  */
