...
public class SegmentOptionsProperty22 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty22() {
  }

  public SegmentOptionsProperty22 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty22 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty22 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty22 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty22 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty22 instance itself
   */
  public SegmentOptionsProperty22 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty22 segmentOptionsProperty22 = (SegmentOptionsProperty22) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty22.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty22.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty22.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty22.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty22.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty22 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty22
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty22.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty22 is not found in the empty JSON string", SegmentOptionsProperty22.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty22.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty22' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty22> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty22.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty22>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty22 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty22 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty22 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty22 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty22
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty22
  */
  public static SegmentOptionsProperty22 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty22.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty22 to an JSON string
  *
  * @return JSON string
  */
