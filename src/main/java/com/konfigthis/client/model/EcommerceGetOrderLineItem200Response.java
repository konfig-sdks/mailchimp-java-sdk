...
public class EcommerceGetOrderLineItem200Response {
  ...
  public EcommerceGetOrderLineItem200Response() {
  }
  ...
  **/
  ...
  public EcommerceGetOrderLineItem200Response productId(String productId) {
  ...
  **/
  ...
  public EcommerceGetOrderLineItem200Response productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceGetOrderLineItem200Response quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceGetOrderLineItem200Response price(Double price) {
  ...
  public EcommerceGetOrderLineItem200Response price(Integer price) {
  ...
  **/
  ...
  public EcommerceGetOrderLineItem200Response discount(Double discount) {
  ...
  public EcommerceGetOrderLineItem200Response discount(Integer discount) {
  ...
  **/
   ...
   * @return the EcommerceGetOrderLineItem200Response instance itself
   */
  public EcommerceGetOrderLineItem200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceGetOrderLineItem200Response ecommerceGetOrderLineItem200Response = (EcommerceGetOrderLineItem200Response) o;
    return Objects.equals(this.id, ecommerceGetOrderLineItem200Response.id) &&
        Objects.equals(this.productId, ecommerceGetOrderLineItem200Response.productId) &&
        Objects.equals(this.productTitle, ecommerceGetOrderLineItem200Response.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceGetOrderLineItem200Response.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceGetOrderLineItem200Response.productVariantTitle) &&
        Objects.equals(this.imageUrl, ecommerceGetOrderLineItem200Response.imageUrl) &&
        Objects.equals(this.quantity, ecommerceGetOrderLineItem200Response.quantity) &&
        Objects.equals(this.price, ecommerceGetOrderLineItem200Response.price) &&
        Objects.equals(this.discount, ecommerceGetOrderLineItem200Response.discount) &&
        Objects.equals(this.links, ecommerceGetOrderLineItem200Response.links)&&
        Objects.equals(this.additionalProperties, ecommerceGetOrderLineItem200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceGetOrderLineItem200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceGetOrderLineItem200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceGetOrderLineItem200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceGetOrderLineItem200Response is not found in the empty JSON string", EcommerceGetOrderLineItem200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceGetOrderLineItem200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceGetOrderLineItem200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceGetOrderLineItem200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceGetOrderLineItem200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceGetOrderLineItem200Response>() {
           @Override
           public void write(JsonWriter out, EcommerceGetOrderLineItem200Response value) throws IOException {
           ...
           @Override
           public EcommerceGetOrderLineItem200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceGetOrderLineItem200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceGetOrderLineItem200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceGetOrderLineItem200Response
  * @throws IOException if the JSON string is invalid with respect to EcommerceGetOrderLineItem200Response
  */
  public static EcommerceGetOrderLineItem200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceGetOrderLineItem200Response.class);
  }

 /**
  * Convert an instance of EcommerceGetOrderLineItem200Response to an JSON string
  *
  * @return JSON string
  */
