...
public class EventsProperty3 {
  ...
  public EventsProperty3() {
  }

  public EventsProperty3 subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty3 unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty3 profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty3 cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty3 upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty3 campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty3 instance itself
   */
  public EventsProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty3 eventsProperty3 = (EventsProperty3) o;
    return Objects.equals(this.subscribe, eventsProperty3.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty3.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty3.profile) &&
        Objects.equals(this.cleaned, eventsProperty3.cleaned) &&
        Objects.equals(this.upemail, eventsProperty3.upemail) &&
        Objects.equals(this.campaign, eventsProperty3.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty3 is not found in the empty JSON string", EventsProperty3.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty3>() {
           @Override
           public void write(JsonWriter out, EventsProperty3 value) throws IOException {
           ...
           @Override
           public EventsProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty3
  * @throws IOException if the JSON string is invalid with respect to EventsProperty3
  */
  public static EventsProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty3.class);
  }

 /**
  * Convert an instance of EventsProperty3 to an JSON string
  *
  * @return JSON string
  */
