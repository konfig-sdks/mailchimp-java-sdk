...
import com.konfigthis.client.model.ListProperty5;
...
public class AutomationsCreateClassicResponse {
 ...
 public enum StatusEnum {
  ...
  private ListProperty5 recipients;
  ...
  public AutomationsCreateClassicResponse() {
  }
  ...
  **/
  ...
  public AutomationsCreateClassicResponse recipients(ListProperty5 recipients) {
  ...
  **/
  ...
  public ListProperty5 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty5 recipients) {
  ...
  public AutomationsCreateClassicResponse settings(AutomationCampaignSettingsProperty1 settings) {
  ...
  **/
  ...
  public AutomationsCreateClassicResponse tracking(AutomationTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public AutomationsCreateClassicResponse triggerSettings(AutomationTriggerProperty1 triggerSettings) {
  ...
  **/
  ...
  public AutomationsCreateClassicResponse reportSummary(CampaignReportSummaryProperty reportSummary) {
  ...
  **/
   ...
   * @return the AutomationsCreateClassicResponse instance itself
   */
  public AutomationsCreateClassicResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationsCreateClassicResponse automationsCreateClassicResponse = (AutomationsCreateClassicResponse) o;
    return Objects.equals(this.id, automationsCreateClassicResponse.id) &&
        Objects.equals(this.createTime, automationsCreateClassicResponse.createTime) &&
        Objects.equals(this.startTime, automationsCreateClassicResponse.startTime) &&
        Objects.equals(this.status, automationsCreateClassicResponse.status) &&
        Objects.equals(this.emailsSent, automationsCreateClassicResponse.emailsSent) &&
        Objects.equals(this.recipients, automationsCreateClassicResponse.recipients) &&
        Objects.equals(this.settings, automationsCreateClassicResponse.settings) &&
        Objects.equals(this.tracking, automationsCreateClassicResponse.tracking) &&
        Objects.equals(this.triggerSettings, automationsCreateClassicResponse.triggerSettings) &&
        Objects.equals(this.reportSummary, automationsCreateClassicResponse.reportSummary) &&
        Objects.equals(this.links, automationsCreateClassicResponse.links)&&
        Objects.equals(this.additionalProperties, automationsCreateClassicResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationsCreateClassicResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationsCreateClassicResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationsCreateClassicResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationsCreateClassicResponse is not found in the empty JSON string", AutomationsCreateClassicResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty5.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationsCreateClassicResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationsCreateClassicResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationsCreateClassicResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationsCreateClassicResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationsCreateClassicResponse>() {
           @Override
           public void write(JsonWriter out, AutomationsCreateClassicResponse value) throws IOException {
           ...
           @Override
           public AutomationsCreateClassicResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationsCreateClassicResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationsCreateClassicResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationsCreateClassicResponse
  * @throws IOException if the JSON string is invalid with respect to AutomationsCreateClassicResponse
  */
  public static AutomationsCreateClassicResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationsCreateClassicResponse.class);
  }

 /**
  * Convert an instance of AutomationsCreateClassicResponse to an JSON string
  *
  * @return JSON string
  */
