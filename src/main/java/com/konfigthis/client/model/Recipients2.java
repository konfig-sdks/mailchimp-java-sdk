...
import com.konfigthis.client.model.SegmentOptions2;
...
public class Recipients2 {
  ...
  public Recipients2 listId(String listId) {
  ...
  **/
  ...
  public Recipients2 segmentOpts(SegmentOptions2 segmentOpts) {
  ...
  **/
   ...
   * @return the Recipients2 instance itself
   */
  public Recipients2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Recipients2 recipients2 = (Recipients2) o;
    return Objects.equals(this.listId, recipients2.listId) &&
        Objects.equals(this.listIsActive, recipients2.listIsActive) &&
        Objects.equals(this.listName, recipients2.listName) &&
        Objects.equals(this.segmentText, recipients2.segmentText) &&
        Objects.equals(this.recipientCount, recipients2.recipientCount) &&
        Objects.equals(this.segmentOpts, recipients2.segmentOpts)&&
        Objects.equals(this.additionalProperties, recipients2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Recipients2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Recipients2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Recipients2 is not found in the empty JSON string", Recipients2.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptions2.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Recipients2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Recipients2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Recipients2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Recipients2.class));

       return (TypeAdapter<T>) new TypeAdapter<Recipients2>() {
           @Override
           public void write(JsonWriter out, Recipients2 value) throws IOException {
           ...
           @Override
           public Recipients2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Recipients2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Recipients2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Recipients2
  * @throws IOException if the JSON string is invalid with respect to Recipients2
  */
  public static Recipients2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Recipients2.class);
  }

 /**
  * Convert an instance of Recipients2 to an JSON string
  *
  * @return JSON string
  */
