...
import com.konfigthis.client.model.BillingAddressProperty8;
import com.konfigthis.client.model.ECommerceCustomerProperty18;
import com.konfigthis.client.model.ECommerceOrderLineItem2;
import com.konfigthis.client.model.OutreachProperty8;
import com.konfigthis.client.model.PromosPropertyInner1;
import com.konfigthis.client.model.ResourceLink;
import com.konfigthis.client.model.ShippingAddressProperty8;
...
public class EcommerceGetStoreOrderInfoResponse {
  ...
  private ECommerceCustomerProperty18 customer;
 ...
 public enum TrackingCodeEnum {
  ...
  private ShippingAddressProperty8 shippingAddress;

  public static final String SERIALIZED_NAME_BILLING_ADDRESS = "billing_address";
  @SerializedName(SERIALIZED_NAME_BILLING_ADDRESS)
  private BillingAddressProperty8 billingAddress;
  ...
  private OutreachProperty8 outreach;
  ...
  public EcommerceGetStoreOrderInfoResponse() {
  }
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse customer(ECommerceCustomerProperty18 customer) {
  ...
  **/
  ...
  public ECommerceCustomerProperty18 getCustomer() {
    return customer;
  }


  public void setCustomer(ECommerceCustomerProperty18 customer) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse campaignId(String campaignId) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse landingSite(String landingSite) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse financialStatus(String financialStatus) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse fulfillmentStatus(String fulfillmentStatus) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse orderTotal(Double orderTotal) {
  ...
  public EcommerceGetStoreOrderInfoResponse orderTotal(Integer orderTotal) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse orderUrl(String orderUrl) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse discountTotal(Double discountTotal) {
  ...
  public EcommerceGetStoreOrderInfoResponse discountTotal(Integer discountTotal) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse taxTotal(Double taxTotal) {
  ...
  public EcommerceGetStoreOrderInfoResponse taxTotal(Integer taxTotal) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse shippingTotal(Double shippingTotal) {
  ...
  public EcommerceGetStoreOrderInfoResponse shippingTotal(Integer shippingTotal) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse trackingCode(TrackingCodeEnum trackingCode) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse processedAtForeign(OffsetDateTime processedAtForeign) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse cancelledAtForeign(OffsetDateTime cancelledAtForeign) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse updatedAtForeign(OffsetDateTime updatedAtForeign) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse shippingAddress(ShippingAddressProperty8 shippingAddress) {
  ...
  **/
  ...
  public ShippingAddressProperty8 getShippingAddress() {
    return shippingAddress;
  }


  public void setShippingAddress(ShippingAddressProperty8 shippingAddress) {
  ...
  public EcommerceGetStoreOrderInfoResponse billingAddress(BillingAddressProperty8 billingAddress) {
  ...
  **/
  ...
  public BillingAddressProperty8 getBillingAddress() {
    return billingAddress;
  }


  public void setBillingAddress(BillingAddressProperty8 billingAddress) {
  ...
  public EcommerceGetStoreOrderInfoResponse promos(List<PromosPropertyInner1> promos) {
  ...
  public EcommerceGetStoreOrderInfoResponse addPromosItem(PromosPropertyInner1 promosItem) {
    if (this.promos == null) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse lines(List<ECommerceOrderLineItem2> lines) {
  ...
  public EcommerceGetStoreOrderInfoResponse addLinesItem(ECommerceOrderLineItem2 linesItem) {
    if (this.lines == null) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse outreach(OutreachProperty8 outreach) {
  ...
  **/
  ...
  public OutreachProperty8 getOutreach() {
    return outreach;
  }


  public void setOutreach(OutreachProperty8 outreach) {
  ...
  public EcommerceGetStoreOrderInfoResponse trackingNumber(String trackingNumber) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse trackingCarrier(String trackingCarrier) {
  ...
  **/
  ...
  public EcommerceGetStoreOrderInfoResponse trackingUrl(String trackingUrl) {
  ...
  **/
   ...
   * @return the EcommerceGetStoreOrderInfoResponse instance itself
   */
  public EcommerceGetStoreOrderInfoResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceGetStoreOrderInfoResponse ecommerceGetStoreOrderInfoResponse = (EcommerceGetStoreOrderInfoResponse) o;
    return Objects.equals(this.id, ecommerceGetStoreOrderInfoResponse.id) &&
        Objects.equals(this.customer, ecommerceGetStoreOrderInfoResponse.customer) &&
        Objects.equals(this.storeId, ecommerceGetStoreOrderInfoResponse.storeId) &&
        Objects.equals(this.campaignId, ecommerceGetStoreOrderInfoResponse.campaignId) &&
        Objects.equals(this.landingSite, ecommerceGetStoreOrderInfoResponse.landingSite) &&
        Objects.equals(this.financialStatus, ecommerceGetStoreOrderInfoResponse.financialStatus) &&
        Objects.equals(this.fulfillmentStatus, ecommerceGetStoreOrderInfoResponse.fulfillmentStatus) &&
        Objects.equals(this.currencyCode, ecommerceGetStoreOrderInfoResponse.currencyCode) &&
        Objects.equals(this.orderTotal, ecommerceGetStoreOrderInfoResponse.orderTotal) &&
        Objects.equals(this.orderUrl, ecommerceGetStoreOrderInfoResponse.orderUrl) &&
        Objects.equals(this.discountTotal, ecommerceGetStoreOrderInfoResponse.discountTotal) &&
        Objects.equals(this.taxTotal, ecommerceGetStoreOrderInfoResponse.taxTotal) &&
        Objects.equals(this.shippingTotal, ecommerceGetStoreOrderInfoResponse.shippingTotal) &&
        Objects.equals(this.trackingCode, ecommerceGetStoreOrderInfoResponse.trackingCode) &&
        Objects.equals(this.processedAtForeign, ecommerceGetStoreOrderInfoResponse.processedAtForeign) &&
        Objects.equals(this.cancelledAtForeign, ecommerceGetStoreOrderInfoResponse.cancelledAtForeign) &&
        Objects.equals(this.updatedAtForeign, ecommerceGetStoreOrderInfoResponse.updatedAtForeign) &&
        Objects.equals(this.shippingAddress, ecommerceGetStoreOrderInfoResponse.shippingAddress) &&
        Objects.equals(this.billingAddress, ecommerceGetStoreOrderInfoResponse.billingAddress) &&
        Objects.equals(this.promos, ecommerceGetStoreOrderInfoResponse.promos) &&
        Objects.equals(this.lines, ecommerceGetStoreOrderInfoResponse.lines) &&
        Objects.equals(this.outreach, ecommerceGetStoreOrderInfoResponse.outreach) &&
        Objects.equals(this.trackingNumber, ecommerceGetStoreOrderInfoResponse.trackingNumber) &&
        Objects.equals(this.trackingCarrier, ecommerceGetStoreOrderInfoResponse.trackingCarrier) &&
        Objects.equals(this.trackingUrl, ecommerceGetStoreOrderInfoResponse.trackingUrl) &&
        Objects.equals(this.links, ecommerceGetStoreOrderInfoResponse.links)&&
        Objects.equals(this.additionalProperties, ecommerceGetStoreOrderInfoResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceGetStoreOrderInfoResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceGetStoreOrderInfoResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceGetStoreOrderInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceGetStoreOrderInfoResponse is not found in the empty JSON string", EcommerceGetStoreOrderInfoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("customer") != null && !jsonObj.get("customer").isJsonNull()) {
        ECommerceCustomerProperty18.validateJsonObject(jsonObj.getAsJsonObject("customer"));
      }
      ...
      if (jsonObj.get("shipping_address") != null && !jsonObj.get("shipping_address").isJsonNull()) {
        ShippingAddressProperty8.validateJsonObject(jsonObj.getAsJsonObject("shipping_address"));
      }
      // validate the optional field `billing_address`
      if (jsonObj.get("billing_address") != null && !jsonObj.get("billing_address").isJsonNull()) {
        BillingAddressProperty8.validateJsonObject(jsonObj.getAsJsonObject("billing_address"));
      }
      ...
      if (jsonObj.get("outreach") != null && !jsonObj.get("outreach").isJsonNull()) {
        OutreachProperty8.validateJsonObject(jsonObj.getAsJsonObject("outreach"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceGetStoreOrderInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceGetStoreOrderInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceGetStoreOrderInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceGetStoreOrderInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceGetStoreOrderInfoResponse>() {
           @Override
           public void write(JsonWriter out, EcommerceGetStoreOrderInfoResponse value) throws IOException {
           ...
           @Override
           public EcommerceGetStoreOrderInfoResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceGetStoreOrderInfoResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceGetStoreOrderInfoResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceGetStoreOrderInfoResponse
  * @throws IOException if the JSON string is invalid with respect to EcommerceGetStoreOrderInfoResponse
  */
  public static EcommerceGetStoreOrderInfoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceGetStoreOrderInfoResponse.class);
  }

 /**
  * Convert an instance of EcommerceGetStoreOrderInfoResponse to an JSON string
  *
  * @return JSON string
  */
