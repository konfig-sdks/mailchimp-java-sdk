...
public class ECommercePromoCode {
  ...
  **/
   ...
   * @return the ECommercePromoCode instance itself
   */
  public ECommercePromoCode putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eCommercePromoCode.id) &&
        ...
        Objects.equals(this.additionalProperties, eCommercePromoCode.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommercePromoCode
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommercePromoCode.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommercePromoCode is not found in the empty JSON string", ECommercePromoCode.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommercePromoCode.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommercePromoCode' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommercePromoCode> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommercePromoCode.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommercePromoCode>() {
           @Override
           public void write(JsonWriter out, ECommercePromoCode value) throws IOException {
           ...
           @Override
           public ECommercePromoCode read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommercePromoCode instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommercePromoCode given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommercePromoCode
  * @throws IOException if the JSON string is invalid with respect to ECommercePromoCode
  */
  public static ECommercePromoCode fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommercePromoCode.class);
  }

 /**
  * Convert an instance of ECommercePromoCode to an JSON string
  *
  * @return JSON string
  */
