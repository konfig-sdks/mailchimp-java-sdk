...
import com.konfigthis.client.model.BillingAddressProperty6;
import com.konfigthis.client.model.ECommerceCustomerProperty16;
import com.konfigthis.client.model.ECommerceOrderLineItem2;
import com.konfigthis.client.model.OutreachProperty6;
import com.konfigthis.client.model.PromosPropertyInner1;
import com.konfigthis.client.model.ResourceLink;
import com.konfigthis.client.model.ShippingAddressProperty6;
...
public class EcommerceAddOrderToStoreResponse {
  ...
  private ECommerceCustomerProperty16 customer;
 ...
 public enum TrackingCodeEnum {
  ...
  private ShippingAddressProperty6 shippingAddress;

  public static final String SERIALIZED_NAME_BILLING_ADDRESS = "billing_address";
  @SerializedName(SERIALIZED_NAME_BILLING_ADDRESS)
  private BillingAddressProperty6 billingAddress;
  ...
  private OutreachProperty6 outreach;
  ...
  public EcommerceAddOrderToStoreResponse() {
  }
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse customer(ECommerceCustomerProperty16 customer) {
  ...
  **/
  ...
  public ECommerceCustomerProperty16 getCustomer() {
    return customer;
  }


  public void setCustomer(ECommerceCustomerProperty16 customer) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse campaignId(String campaignId) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse landingSite(String landingSite) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse financialStatus(String financialStatus) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse fulfillmentStatus(String fulfillmentStatus) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse orderTotal(Double orderTotal) {
  ...
  public EcommerceAddOrderToStoreResponse orderTotal(Integer orderTotal) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse orderUrl(String orderUrl) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse discountTotal(Double discountTotal) {
  ...
  public EcommerceAddOrderToStoreResponse discountTotal(Integer discountTotal) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse taxTotal(Double taxTotal) {
  ...
  public EcommerceAddOrderToStoreResponse taxTotal(Integer taxTotal) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse shippingTotal(Double shippingTotal) {
  ...
  public EcommerceAddOrderToStoreResponse shippingTotal(Integer shippingTotal) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse trackingCode(TrackingCodeEnum trackingCode) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse processedAtForeign(OffsetDateTime processedAtForeign) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse cancelledAtForeign(OffsetDateTime cancelledAtForeign) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse updatedAtForeign(OffsetDateTime updatedAtForeign) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse shippingAddress(ShippingAddressProperty6 shippingAddress) {
  ...
  **/
  ...
  public ShippingAddressProperty6 getShippingAddress() {
    return shippingAddress;
  }


  public void setShippingAddress(ShippingAddressProperty6 shippingAddress) {
  ...
  public EcommerceAddOrderToStoreResponse billingAddress(BillingAddressProperty6 billingAddress) {
  ...
  **/
  ...
  public BillingAddressProperty6 getBillingAddress() {
    return billingAddress;
  }


  public void setBillingAddress(BillingAddressProperty6 billingAddress) {
  ...
  public EcommerceAddOrderToStoreResponse promos(List<PromosPropertyInner1> promos) {
  ...
  public EcommerceAddOrderToStoreResponse addPromosItem(PromosPropertyInner1 promosItem) {
    if (this.promos == null) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse lines(List<ECommerceOrderLineItem2> lines) {
  ...
  public EcommerceAddOrderToStoreResponse addLinesItem(ECommerceOrderLineItem2 linesItem) {
    if (this.lines == null) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse outreach(OutreachProperty6 outreach) {
  ...
  **/
  ...
  public OutreachProperty6 getOutreach() {
    return outreach;
  }


  public void setOutreach(OutreachProperty6 outreach) {
  ...
  public EcommerceAddOrderToStoreResponse trackingNumber(String trackingNumber) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse trackingCarrier(String trackingCarrier) {
  ...
  **/
  ...
  public EcommerceAddOrderToStoreResponse trackingUrl(String trackingUrl) {
  ...
  **/
   ...
   * @return the EcommerceAddOrderToStoreResponse instance itself
   */
  public EcommerceAddOrderToStoreResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceAddOrderToStoreResponse ecommerceAddOrderToStoreResponse = (EcommerceAddOrderToStoreResponse) o;
    return Objects.equals(this.id, ecommerceAddOrderToStoreResponse.id) &&
        Objects.equals(this.customer, ecommerceAddOrderToStoreResponse.customer) &&
        Objects.equals(this.storeId, ecommerceAddOrderToStoreResponse.storeId) &&
        Objects.equals(this.campaignId, ecommerceAddOrderToStoreResponse.campaignId) &&
        Objects.equals(this.landingSite, ecommerceAddOrderToStoreResponse.landingSite) &&
        Objects.equals(this.financialStatus, ecommerceAddOrderToStoreResponse.financialStatus) &&
        Objects.equals(this.fulfillmentStatus, ecommerceAddOrderToStoreResponse.fulfillmentStatus) &&
        Objects.equals(this.currencyCode, ecommerceAddOrderToStoreResponse.currencyCode) &&
        Objects.equals(this.orderTotal, ecommerceAddOrderToStoreResponse.orderTotal) &&
        Objects.equals(this.orderUrl, ecommerceAddOrderToStoreResponse.orderUrl) &&
        Objects.equals(this.discountTotal, ecommerceAddOrderToStoreResponse.discountTotal) &&
        Objects.equals(this.taxTotal, ecommerceAddOrderToStoreResponse.taxTotal) &&
        Objects.equals(this.shippingTotal, ecommerceAddOrderToStoreResponse.shippingTotal) &&
        Objects.equals(this.trackingCode, ecommerceAddOrderToStoreResponse.trackingCode) &&
        Objects.equals(this.processedAtForeign, ecommerceAddOrderToStoreResponse.processedAtForeign) &&
        Objects.equals(this.cancelledAtForeign, ecommerceAddOrderToStoreResponse.cancelledAtForeign) &&
        Objects.equals(this.updatedAtForeign, ecommerceAddOrderToStoreResponse.updatedAtForeign) &&
        Objects.equals(this.shippingAddress, ecommerceAddOrderToStoreResponse.shippingAddress) &&
        Objects.equals(this.billingAddress, ecommerceAddOrderToStoreResponse.billingAddress) &&
        Objects.equals(this.promos, ecommerceAddOrderToStoreResponse.promos) &&
        Objects.equals(this.lines, ecommerceAddOrderToStoreResponse.lines) &&
        Objects.equals(this.outreach, ecommerceAddOrderToStoreResponse.outreach) &&
        Objects.equals(this.trackingNumber, ecommerceAddOrderToStoreResponse.trackingNumber) &&
        Objects.equals(this.trackingCarrier, ecommerceAddOrderToStoreResponse.trackingCarrier) &&
        Objects.equals(this.trackingUrl, ecommerceAddOrderToStoreResponse.trackingUrl) &&
        Objects.equals(this.links, ecommerceAddOrderToStoreResponse.links)&&
        Objects.equals(this.additionalProperties, ecommerceAddOrderToStoreResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceAddOrderToStoreResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceAddOrderToStoreResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceAddOrderToStoreResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceAddOrderToStoreResponse is not found in the empty JSON string", EcommerceAddOrderToStoreResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("customer") != null && !jsonObj.get("customer").isJsonNull()) {
        ECommerceCustomerProperty16.validateJsonObject(jsonObj.getAsJsonObject("customer"));
      }
      ...
      if (jsonObj.get("shipping_address") != null && !jsonObj.get("shipping_address").isJsonNull()) {
        ShippingAddressProperty6.validateJsonObject(jsonObj.getAsJsonObject("shipping_address"));
      }
      // validate the optional field `billing_address`
      if (jsonObj.get("billing_address") != null && !jsonObj.get("billing_address").isJsonNull()) {
        BillingAddressProperty6.validateJsonObject(jsonObj.getAsJsonObject("billing_address"));
      }
      ...
      if (jsonObj.get("outreach") != null && !jsonObj.get("outreach").isJsonNull()) {
        OutreachProperty6.validateJsonObject(jsonObj.getAsJsonObject("outreach"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceAddOrderToStoreResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceAddOrderToStoreResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceAddOrderToStoreResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceAddOrderToStoreResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceAddOrderToStoreResponse>() {
           @Override
           public void write(JsonWriter out, EcommerceAddOrderToStoreResponse value) throws IOException {
           ...
           @Override
           public EcommerceAddOrderToStoreResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceAddOrderToStoreResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceAddOrderToStoreResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceAddOrderToStoreResponse
  * @throws IOException if the JSON string is invalid with respect to EcommerceAddOrderToStoreResponse
  */
  public static EcommerceAddOrderToStoreResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceAddOrderToStoreResponse.class);
  }

 /**
  * Convert an instance of EcommerceAddOrderToStoreResponse to an JSON string
  *
  * @return JSON string
  */
