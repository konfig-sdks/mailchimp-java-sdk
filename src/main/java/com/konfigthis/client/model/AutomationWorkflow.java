...
import com.konfigthis.client.model.ListProperty3;
...
public class AutomationWorkflow {
 ...
 public enum StatusEnum {
  ...
  private ListProperty3 recipients;
  ...
  **/
  ...
  public AutomationWorkflow recipients(ListProperty3 recipients) {
  ...
  **/
  ...
  public ListProperty3 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty3 recipients) {
  ...
  public AutomationWorkflow settings(AutomationCampaignSettingsProperty1 settings) {
  ...
  **/
  ...
  public AutomationWorkflow tracking(AutomationTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public AutomationWorkflow triggerSettings(AutomationTriggerProperty1 triggerSettings) {
  ...
  **/
  ...
  public AutomationWorkflow reportSummary(CampaignReportSummaryProperty reportSummary) {
  ...
  **/
   ...
   * @return the AutomationWorkflow instance itself
   */
  public AutomationWorkflow putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, automationWorkflow.id) &&
        ...
        Objects.equals(this.additionalProperties, automationWorkflow.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationWorkflow
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationWorkflow.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationWorkflow is not found in the empty JSON string", AutomationWorkflow.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty3.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationWorkflow.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationWorkflow' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationWorkflow> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationWorkflow.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationWorkflow>() {
           @Override
           public void write(JsonWriter out, AutomationWorkflow value) throws IOException {
           ...
           @Override
           public AutomationWorkflow read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationWorkflow instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationWorkflow given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationWorkflow
  * @throws IOException if the JSON string is invalid with respect to AutomationWorkflow
  */
  public static AutomationWorkflow fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationWorkflow.class);
  }

 /**
  * Convert an instance of AutomationWorkflow to an JSON string
  *
  * @return JSON string
  */
