...
public class AutomationDelayProperty3 {
 ...
 public enum ActionEnum {
  ...
  public AutomationDelayProperty3() {
  }
  ...
  **/
  ...
  public AutomationDelayProperty3 type(TypeEnum type) {
  ...
  **/
  ...
  public AutomationDelayProperty3 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public AutomationDelayProperty3 action(ActionEnum action) {
  ...
  **/
   ...
   * @return the AutomationDelayProperty3 instance itself
   */
  public AutomationDelayProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationDelayProperty3 automationDelayProperty3 = (AutomationDelayProperty3) o;
    return Objects.equals(this.amount, automationDelayProperty3.amount) &&
        Objects.equals(this.type, automationDelayProperty3.type) &&
        Objects.equals(this.direction, automationDelayProperty3.direction) &&
        Objects.equals(this.action, automationDelayProperty3.action) &&
        Objects.equals(this.actionDescription, automationDelayProperty3.actionDescription) &&
        Objects.equals(this.fullDescription, automationDelayProperty3.fullDescription)&&
        Objects.equals(this.additionalProperties, automationDelayProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationDelayProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationDelayProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationDelayProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationDelayProperty3 is not found in the empty JSON string", AutomationDelayProperty3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationDelayProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationDelayProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationDelayProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationDelayProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationDelayProperty3>() {
           @Override
           public void write(JsonWriter out, AutomationDelayProperty3 value) throws IOException {
           ...
           @Override
           public AutomationDelayProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationDelayProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationDelayProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationDelayProperty3
  * @throws IOException if the JSON string is invalid with respect to AutomationDelayProperty3
  */
  public static AutomationDelayProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationDelayProperty3.class);
  }

 /**
  * Convert an instance of AutomationDelayProperty3 to an JSON string
  *
  * @return JSON string
  */
