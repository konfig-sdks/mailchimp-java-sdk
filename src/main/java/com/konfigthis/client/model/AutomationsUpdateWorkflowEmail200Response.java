...
import com.konfigthis.client.model.AutomationDelayProperty6;
...
import com.konfigthis.client.model.ListProperty14;
...
public class AutomationsUpdateWorkflowEmail200Response {
  ...
  private AutomationDelayProperty6 delay;
 ...
 public enum StatusEnum {
  ...
  private ListProperty14 recipients;
  ...
  public AutomationsUpdateWorkflowEmail200Response() {
  }
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmail200Response delay(AutomationDelayProperty6 delay) {
  ...
  **/
  ...
  public AutomationDelayProperty6 getDelay() {
    return delay;
  }


  public void setDelay(AutomationDelayProperty6 delay) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmail200Response recipients(ListProperty14 recipients) {
  ...
  **/
  ...
  public ListProperty14 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty14 recipients) {
  ...
  public AutomationsUpdateWorkflowEmail200Response settings(CampaignSettingsProperty3 settings) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmail200Response tracking(CampaignTrackingOptionsProperty1 tracking) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmail200Response socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmail200Response triggerSettings(AutomationTriggerProperty1 triggerSettings) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmail200Response reportSummary(CampaignReportSummaryProperty1 reportSummary) {
  ...
  **/
   ...
   * @return the AutomationsUpdateWorkflowEmail200Response instance itself
   */
  public AutomationsUpdateWorkflowEmail200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationsUpdateWorkflowEmail200Response automationsUpdateWorkflowEmail200Response = (AutomationsUpdateWorkflowEmail200Response) o;
    return Objects.equals(this.id, automationsUpdateWorkflowEmail200Response.id) &&
        Objects.equals(this.webId, automationsUpdateWorkflowEmail200Response.webId) &&
        Objects.equals(this.workflowId, automationsUpdateWorkflowEmail200Response.workflowId) &&
        Objects.equals(this.position, automationsUpdateWorkflowEmail200Response.position) &&
        Objects.equals(this.delay, automationsUpdateWorkflowEmail200Response.delay) &&
        Objects.equals(this.createTime, automationsUpdateWorkflowEmail200Response.createTime) &&
        Objects.equals(this.startTime, automationsUpdateWorkflowEmail200Response.startTime) &&
        Objects.equals(this.archiveUrl, automationsUpdateWorkflowEmail200Response.archiveUrl) &&
        Objects.equals(this.status, automationsUpdateWorkflowEmail200Response.status) &&
        Objects.equals(this.emailsSent, automationsUpdateWorkflowEmail200Response.emailsSent) &&
        Objects.equals(this.sendTime, automationsUpdateWorkflowEmail200Response.sendTime) &&
        Objects.equals(this.contentType, automationsUpdateWorkflowEmail200Response.contentType) &&
        Objects.equals(this.needsBlockRefresh, automationsUpdateWorkflowEmail200Response.needsBlockRefresh) &&
        Objects.equals(this.hasLogoMergeTag, automationsUpdateWorkflowEmail200Response.hasLogoMergeTag) &&
        Objects.equals(this.recipients, automationsUpdateWorkflowEmail200Response.recipients) &&
        Objects.equals(this.settings, automationsUpdateWorkflowEmail200Response.settings) &&
        Objects.equals(this.tracking, automationsUpdateWorkflowEmail200Response.tracking) &&
        Objects.equals(this.socialCard, automationsUpdateWorkflowEmail200Response.socialCard) &&
        Objects.equals(this.triggerSettings, automationsUpdateWorkflowEmail200Response.triggerSettings) &&
        Objects.equals(this.reportSummary, automationsUpdateWorkflowEmail200Response.reportSummary) &&
        Objects.equals(this.links, automationsUpdateWorkflowEmail200Response.links)&&
        Objects.equals(this.additionalProperties, automationsUpdateWorkflowEmail200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationsUpdateWorkflowEmail200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationsUpdateWorkflowEmail200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationsUpdateWorkflowEmail200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationsUpdateWorkflowEmail200Response is not found in the empty JSON string", AutomationsUpdateWorkflowEmail200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("delay") != null && !jsonObj.get("delay").isJsonNull()) {
        AutomationDelayProperty6.validateJsonObject(jsonObj.getAsJsonObject("delay"));
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty14.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationsUpdateWorkflowEmail200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationsUpdateWorkflowEmail200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationsUpdateWorkflowEmail200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationsUpdateWorkflowEmail200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationsUpdateWorkflowEmail200Response>() {
           @Override
           public void write(JsonWriter out, AutomationsUpdateWorkflowEmail200Response value) throws IOException {
           ...
           @Override
           public AutomationsUpdateWorkflowEmail200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationsUpdateWorkflowEmail200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationsUpdateWorkflowEmail200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationsUpdateWorkflowEmail200Response
  * @throws IOException if the JSON string is invalid with respect to AutomationsUpdateWorkflowEmail200Response
  */
  public static AutomationsUpdateWorkflowEmail200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationsUpdateWorkflowEmail200Response.class);
  }

 /**
  * Convert an instance of AutomationsUpdateWorkflowEmail200Response to an JSON string
  *
  * @return JSON string
  */
