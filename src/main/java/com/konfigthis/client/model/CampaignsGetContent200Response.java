...
import com.konfigthis.client.model.VariateContentsPropertyInner2;
...
public class CampaignsGetContent200Response {
  ...
  private List<VariateContentsPropertyInner2> variateContents = null;
  ...
  public CampaignsGetContent200Response() {
  }
  ...
  public CampaignsGetContent200Response variateContents(List<VariateContentsPropertyInner2> variateContents) {
  ...
  public CampaignsGetContent200Response addVariateContentsItem(VariateContentsPropertyInner2 variateContentsItem) {
  ...
  **/
  ...
  public List<VariateContentsPropertyInner2> getVariateContents() {
    return variateContents;
  }


  public void setVariateContents(List<VariateContentsPropertyInner2> variateContents) {
  ...
  public CampaignsGetContent200Response plainText(String plainText) {
  ...
  **/
  ...
  public CampaignsGetContent200Response html(String html) {
  ...
  **/
  ...
  public CampaignsGetContent200Response archiveHtml(String archiveHtml) {
  ...
  **/
   ...
   * @return the CampaignsGetContent200Response instance itself
   */
  public CampaignsGetContent200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsGetContent200Response campaignsGetContent200Response = (CampaignsGetContent200Response) o;
    return Objects.equals(this.variateContents, campaignsGetContent200Response.variateContents) &&
        Objects.equals(this.plainText, campaignsGetContent200Response.plainText) &&
        Objects.equals(this.html, campaignsGetContent200Response.html) &&
        Objects.equals(this.archiveHtml, campaignsGetContent200Response.archiveHtml) &&
        Objects.equals(this.links, campaignsGetContent200Response.links)&&
        Objects.equals(this.additionalProperties, campaignsGetContent200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsGetContent200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsGetContent200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsGetContent200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsGetContent200Response is not found in the empty JSON string", CampaignsGetContent200Response.openapiRequiredFields.toString()));
        }
      }
      if (jsonObj.get("variate_contents") != null && !jsonObj.get("variate_contents").isJsonNull()) {
        ...
        if (jsonArrayvariateContents != null) {
          ...
          for (int i = 0; i < jsonArrayvariateContents.size(); i++) {
            VariateContentsPropertyInner2.validateJsonObject(jsonArrayvariateContents.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsGetContent200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsGetContent200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsGetContent200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsGetContent200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsGetContent200Response>() {
           @Override
           public void write(JsonWriter out, CampaignsGetContent200Response value) throws IOException {
           ...
           @Override
           public CampaignsGetContent200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsGetContent200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsGetContent200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsGetContent200Response
  * @throws IOException if the JSON string is invalid with respect to CampaignsGetContent200Response
  */
  public static CampaignsGetContent200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsGetContent200Response.class);
  }

 /**
  * Convert an instance of CampaignsGetContent200Response to an JSON string
  *
  * @return JSON string
  */
