...
import com.konfigthis.client.model.ListProperty23;
...
public class CampaignsReplicateActionResponse {
 ...
 public enum StatusEnum {
  ...
  private ListProperty23 recipients;
  ...
  public CampaignsReplicateActionResponse() {
  }
  ...
  **/
  ...
  public CampaignsReplicateActionResponse type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse recipients(ListProperty23 recipients) {
  ...
  **/
  ...
  public ListProperty23 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty23 recipients) {
  ...
  public CampaignsReplicateActionResponse settings(CampaignSettingsProperty5 settings) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse variateSettings(ABTestOptionsProperty2 variateSettings) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse rssOpts(RSSOptionsProperty3 rssOpts) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse reportSummary(CampaignReportSummaryProperty3 reportSummary) {
  ...
  **/
  ...
  public CampaignsReplicateActionResponse deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
   ...
   * @return the CampaignsReplicateActionResponse instance itself
   */
  public CampaignsReplicateActionResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsReplicateActionResponse campaignsReplicateActionResponse = (CampaignsReplicateActionResponse) o;
    return Objects.equals(this.id, campaignsReplicateActionResponse.id) &&
        Objects.equals(this.webId, campaignsReplicateActionResponse.webId) &&
        Objects.equals(this.parentCampaignId, campaignsReplicateActionResponse.parentCampaignId) &&
        Objects.equals(this.type, campaignsReplicateActionResponse.type) &&
        Objects.equals(this.createTime, campaignsReplicateActionResponse.createTime) &&
        Objects.equals(this.archiveUrl, campaignsReplicateActionResponse.archiveUrl) &&
        Objects.equals(this.longArchiveUrl, campaignsReplicateActionResponse.longArchiveUrl) &&
        Objects.equals(this.status, campaignsReplicateActionResponse.status) &&
        Objects.equals(this.emailsSent, campaignsReplicateActionResponse.emailsSent) &&
        Objects.equals(this.sendTime, campaignsReplicateActionResponse.sendTime) &&
        Objects.equals(this.contentType, campaignsReplicateActionResponse.contentType) &&
        Objects.equals(this.needsBlockRefresh, campaignsReplicateActionResponse.needsBlockRefresh) &&
        Objects.equals(this.resendable, campaignsReplicateActionResponse.resendable) &&
        Objects.equals(this.recipients, campaignsReplicateActionResponse.recipients) &&
        Objects.equals(this.settings, campaignsReplicateActionResponse.settings) &&
        Objects.equals(this.variateSettings, campaignsReplicateActionResponse.variateSettings) &&
        Objects.equals(this.tracking, campaignsReplicateActionResponse.tracking) &&
        Objects.equals(this.rssOpts, campaignsReplicateActionResponse.rssOpts) &&
        Objects.equals(this.abSplitOpts, campaignsReplicateActionResponse.abSplitOpts) &&
        Objects.equals(this.socialCard, campaignsReplicateActionResponse.socialCard) &&
        Objects.equals(this.reportSummary, campaignsReplicateActionResponse.reportSummary) &&
        Objects.equals(this.deliveryStatus, campaignsReplicateActionResponse.deliveryStatus) &&
        Objects.equals(this.links, campaignsReplicateActionResponse.links)&&
        Objects.equals(this.additionalProperties, campaignsReplicateActionResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsReplicateActionResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsReplicateActionResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsReplicateActionResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsReplicateActionResponse is not found in the empty JSON string", CampaignsReplicateActionResponse.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CampaignsReplicateActionResponse.openapiRequiredFields) {
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty23.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsReplicateActionResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsReplicateActionResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsReplicateActionResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsReplicateActionResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsReplicateActionResponse>() {
           @Override
           public void write(JsonWriter out, CampaignsReplicateActionResponse value) throws IOException {
           ...
           @Override
           public CampaignsReplicateActionResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsReplicateActionResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsReplicateActionResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsReplicateActionResponse
  * @throws IOException if the JSON string is invalid with respect to CampaignsReplicateActionResponse
  */
  public static CampaignsReplicateActionResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsReplicateActionResponse.class);
  }

 /**
  * Convert an instance of CampaignsReplicateActionResponse to an JSON string
  *
  * @return JSON string
  */
