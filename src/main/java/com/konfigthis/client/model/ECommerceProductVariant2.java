...
public class ECommerceProductVariant2 {
  ...
  **/
  ...
  public ECommerceProductVariant2 price(Double price) {
  ...
  public ECommerceProductVariant2 price(Integer price) {
  ...
  **/
   ...
   * @return the ECommerceProductVariant2 instance itself
   */
  public ECommerceProductVariant2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, eCommerceProductVariant2.title) &&
        Objects.equals(this.id, eCommerceProductVariant2.id) &&
        ...
        Objects.equals(this.createdAt, eCommerceProductVariant2.createdAt) &&
        Objects.equals(this.updatedAt, eCommerceProductVariant2.updatedAt) &&
        Objects.equals(this.links, eCommerceProductVariant2.links)&&
        Objects.equals(this.additionalProperties, eCommerceProductVariant2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceProductVariant2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceProductVariant2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceProductVariant2 is not found in the empty JSON string", ECommerceProductVariant2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceProductVariant2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceProductVariant2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceProductVariant2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceProductVariant2.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceProductVariant2>() {
           @Override
           public void write(JsonWriter out, ECommerceProductVariant2 value) throws IOException {
           ...
           @Override
           public ECommerceProductVariant2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceProductVariant2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceProductVariant2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceProductVariant2
  * @throws IOException if the JSON string is invalid with respect to ECommerceProductVariant2
  */
  public static ECommerceProductVariant2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceProductVariant2.class);
  }

 /**
  * Convert an instance of ECommerceProductVariant2 to an JSON string
  *
  * @return JSON string
  */
