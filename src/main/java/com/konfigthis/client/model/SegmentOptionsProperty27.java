...
public class SegmentOptionsProperty27 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty27() {
  }

  public SegmentOptionsProperty27 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty27 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty27 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty27 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty27 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty27 instance itself
   */
  public SegmentOptionsProperty27 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty27 segmentOptionsProperty27 = (SegmentOptionsProperty27) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty27.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty27.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty27.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty27.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty27.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty27 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty27
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty27.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty27 is not found in the empty JSON string", SegmentOptionsProperty27.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty27.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty27' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty27> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty27.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty27>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty27 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty27 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty27 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty27 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty27
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty27
  */
  public static SegmentOptionsProperty27 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty27.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty27 to an JSON string
  *
  * @return JSON string
  */
