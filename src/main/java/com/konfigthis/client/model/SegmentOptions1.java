...
public class SegmentOptions1 {
  ...
  **/
   ...
   * @return the SegmentOptions1 instance itself
   */
  public SegmentOptions1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.savedSegmentId, segmentOptions1.savedSegmentId) &&
        ...
        Objects.equals(this.additionalProperties, segmentOptions1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptions1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptions1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptions1 is not found in the empty JSON string", SegmentOptions1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptions1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptions1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptions1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptions1.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptions1>() {
           @Override
           public void write(JsonWriter out, SegmentOptions1 value) throws IOException {
           ...
           @Override
           public SegmentOptions1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptions1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptions1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptions1
  * @throws IOException if the JSON string is invalid with respect to SegmentOptions1
  */
  public static SegmentOptions1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptions1.class);
  }

 /**
  * Convert an instance of SegmentOptions1 to an JSON string
  *
  * @return JSON string
  */
