...
public class SegmentOptions3 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptions3() {
  }

  public SegmentOptions3 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptions3 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptions3 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptions3 conditions(List<Object> conditions) {
  ...
  public SegmentOptions3 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptions3 instance itself
   */
  public SegmentOptions3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptions3 segmentOptions3 = (SegmentOptions3) o;
    return Objects.equals(this.savedSegmentId, segmentOptions3.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptions3.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptions3.match) &&
        Objects.equals(this.conditions, segmentOptions3.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptions3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptions3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptions3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptions3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptions3 is not found in the empty JSON string", SegmentOptions3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptions3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptions3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptions3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptions3.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptions3>() {
           @Override
           public void write(JsonWriter out, SegmentOptions3 value) throws IOException {
           ...
           @Override
           public SegmentOptions3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptions3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptions3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptions3
  * @throws IOException if the JSON string is invalid with respect to SegmentOptions3
  */
  public static SegmentOptions3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptions3.class);
  }

 /**
  * Convert an instance of SegmentOptions3 to an JSON string
  *
  * @return JSON string
  */
