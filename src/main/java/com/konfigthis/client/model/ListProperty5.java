...
public class ListProperty5 {
  ...
  public ListProperty5 listId(String listId) {
  ...
  **/
  ...
  public ListProperty5 listName(String listName) {
  ...
  **/
  ...
  public ListProperty5 segmentOpts(SegmentOptionsProperty2 segmentOpts) {
  ...
  **/
  ...
  public ListProperty5 storeId(String storeId) {
  ...
  **/
   ...
   * @return the ListProperty5 instance itself
   */
  public ListProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty5 listProperty5 = (ListProperty5) o;
    return Objects.equals(this.listId, listProperty5.listId) &&
        Objects.equals(this.listIsActive, listProperty5.listIsActive) &&
        Objects.equals(this.listName, listProperty5.listName) &&
        Objects.equals(this.segmentOpts, listProperty5.segmentOpts) &&
        Objects.equals(this.storeId, listProperty5.storeId)&&
        Objects.equals(this.additionalProperties, listProperty5.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty5 is not found in the empty JSON string", ListProperty5.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty5>() {
           @Override
           public void write(JsonWriter out, ListProperty5 value) throws IOException {
           ...
           @Override
           public ListProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty5
  * @throws IOException if the JSON string is invalid with respect to ListProperty5
  */
  public static ListProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty5.class);
  }

 /**
  * Convert an instance of ListProperty5 to an JSON string
  *
  * @return JSON string
  */
