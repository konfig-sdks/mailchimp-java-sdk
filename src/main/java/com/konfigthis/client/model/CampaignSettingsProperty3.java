 ...
 */
@ApiModel(description = "Settings for the campaign including the email subject, from name, and from email address.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class CampaignSettingsProperty3 {
  ...
  public CampaignSettingsProperty3() {
  }
  ...
  public CampaignSettingsProperty3 title(String title) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 subjectLine(String subjectLine) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 previewText(String previewText) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 fromName(String fromName) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 replyTo(String replyTo) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 authenticate(Boolean authenticate) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 autoFooter(Boolean autoFooter) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 inlineCss(Boolean inlineCss) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 autoTweet(Boolean autoTweet) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 autoFbPost(List<String> autoFbPost) {
  ...
  public CampaignSettingsProperty3 addAutoFbPostItem(String autoFbPostItem) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 fbComments(Boolean fbComments) {
  ...
  **/
  ...
  public CampaignSettingsProperty3 templateId(Integer templateId) {
  ...
  **/
   ...
   * @return the CampaignSettingsProperty3 instance itself
   */
  public CampaignSettingsProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignSettingsProperty3 campaignSettingsProperty3 = (CampaignSettingsProperty3) o;
    return Objects.equals(this.title, campaignSettingsProperty3.title) &&
        Objects.equals(this.subjectLine, campaignSettingsProperty3.subjectLine) &&
        Objects.equals(this.previewText, campaignSettingsProperty3.previewText) &&
        Objects.equals(this.fromName, campaignSettingsProperty3.fromName) &&
        Objects.equals(this.replyTo, campaignSettingsProperty3.replyTo) &&
        Objects.equals(this.authenticate, campaignSettingsProperty3.authenticate) &&
        Objects.equals(this.autoFooter, campaignSettingsProperty3.autoFooter) &&
        Objects.equals(this.inlineCss, campaignSettingsProperty3.inlineCss) &&
        Objects.equals(this.autoTweet, campaignSettingsProperty3.autoTweet) &&
        Objects.equals(this.autoFbPost, campaignSettingsProperty3.autoFbPost) &&
        Objects.equals(this.fbComments, campaignSettingsProperty3.fbComments) &&
        Objects.equals(this.templateId, campaignSettingsProperty3.templateId) &&
        Objects.equals(this.dragAndDrop, campaignSettingsProperty3.dragAndDrop)&&
        Objects.equals(this.additionalProperties, campaignSettingsProperty3.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, subjectLine, previewText, fromName, replyTo, authenticate, autoFooter, inlineCss, autoTweet, autoFbPost, fbComments, templateId, dragAndDrop, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignSettingsProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignSettingsProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignSettingsProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignSettingsProperty3 is not found in the empty JSON string", CampaignSettingsProperty3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignSettingsProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignSettingsProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignSettingsProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignSettingsProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignSettingsProperty3>() {
           @Override
           public void write(JsonWriter out, CampaignSettingsProperty3 value) throws IOException {
           ...
           @Override
           public CampaignSettingsProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignSettingsProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignSettingsProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignSettingsProperty3
  * @throws IOException if the JSON string is invalid with respect to CampaignSettingsProperty3
  */
  public static CampaignSettingsProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignSettingsProperty3.class);
  }

 /**
  * Convert an instance of CampaignSettingsProperty3 to an JSON string
  *
  * @return JSON string
  */
