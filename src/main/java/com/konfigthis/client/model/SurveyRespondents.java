 ...
 */
@ApiModel(description = "Survey respondent details.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class SurveyRespondents {
  ...
  **/
  ...
  public SurveyRespondents contact(ContactProperty contact) {
  ...
  **/
   ...
   * @return the SurveyRespondents instance itself
   */
  public SurveyRespondents putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.responseId, surveyRespondents.responseId) &&
        ...
        Objects.equals(this.additionalProperties, surveyRespondents.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(responseId, submittedAt, contact, isNewContact, additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SurveyRespondents
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SurveyRespondents.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SurveyRespondents is not found in the empty JSON string", SurveyRespondents.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SurveyRespondents.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SurveyRespondents' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SurveyRespondents> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SurveyRespondents.class));

       return (TypeAdapter<T>) new TypeAdapter<SurveyRespondents>() {
           @Override
           public void write(JsonWriter out, SurveyRespondents value) throws IOException {
           ...
           @Override
           public SurveyRespondents read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SurveyRespondents instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SurveyRespondents given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SurveyRespondents
  * @throws IOException if the JSON string is invalid with respect to SurveyRespondents
  */
  public static SurveyRespondents fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SurveyRespondents.class);
  }

 /**
  * Convert an instance of SurveyRespondents to an JSON string
  *
  * @return JSON string
  */
