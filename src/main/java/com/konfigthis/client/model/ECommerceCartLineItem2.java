...
public class ECommerceCartLineItem2 {
  ...
  **/
  ...
  public ECommerceCartLineItem2 price(Double price) {
  ...
  public ECommerceCartLineItem2 price(Integer price) {
  ...
  **/
   ...
   * @return the ECommerceCartLineItem2 instance itself
   */
  public ECommerceCartLineItem2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eCommerceCartLineItem2.id) &&
        ...
        Objects.equals(this.productTitle, eCommerceCartLineItem2.productTitle) &&
        Objects.equals(this.productVariantId, eCommerceCartLineItem2.productVariantId) &&
        Objects.equals(this.productVariantTitle, eCommerceCartLineItem2.productVariantTitle) &&
        Objects.equals(this.quantity, eCommerceCartLineItem2.quantity) &&
        Objects.equals(this.price, eCommerceCartLineItem2.price) &&
        Objects.equals(this.links, eCommerceCartLineItem2.links)&&
        Objects.equals(this.additionalProperties, eCommerceCartLineItem2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceCartLineItem2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceCartLineItem2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceCartLineItem2 is not found in the empty JSON string", ECommerceCartLineItem2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceCartLineItem2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceCartLineItem2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceCartLineItem2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceCartLineItem2.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceCartLineItem2>() {
           @Override
           public void write(JsonWriter out, ECommerceCartLineItem2 value) throws IOException {
           ...
           @Override
           public ECommerceCartLineItem2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceCartLineItem2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceCartLineItem2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceCartLineItem2
  * @throws IOException if the JSON string is invalid with respect to ECommerceCartLineItem2
  */
  public static ECommerceCartLineItem2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceCartLineItem2.class);
  }

 /**
  * Convert an instance of ECommerceCartLineItem2 to an JSON string
  *
  * @return JSON string
  */
