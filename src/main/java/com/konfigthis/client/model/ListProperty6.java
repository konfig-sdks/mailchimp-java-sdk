...
public class ListProperty6 {
  ...
  public ListProperty6 listId(String listId) {
  ...
  **/
  ...
  public ListProperty6 listName(String listName) {
  ...
  **/
  ...
  public ListProperty6 segmentOpts(SegmentOptionsProperty2 segmentOpts) {
  ...
  **/
  ...
  public ListProperty6 storeId(String storeId) {
  ...
  **/
   ...
   * @return the ListProperty6 instance itself
   */
  public ListProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty6 listProperty6 = (ListProperty6) o;
    return Objects.equals(this.listId, listProperty6.listId) &&
        Objects.equals(this.listIsActive, listProperty6.listIsActive) &&
        Objects.equals(this.listName, listProperty6.listName) &&
        Objects.equals(this.segmentOpts, listProperty6.segmentOpts) &&
        Objects.equals(this.storeId, listProperty6.storeId)&&
        Objects.equals(this.additionalProperties, listProperty6.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty6 is not found in the empty JSON string", ListProperty6.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty6>() {
           @Override
           public void write(JsonWriter out, ListProperty6 value) throws IOException {
           ...
           @Override
           public ListProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty6
  * @throws IOException if the JSON string is invalid with respect to ListProperty6
  */
  public static ListProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty6.class);
  }

 /**
  * Convert an instance of ListProperty6 to an JSON string
  *
  * @return JSON string
  */
