...
import com.konfigthis.client.model.SegmentOptionsProperty25;
...
public class RecipientsProperty {
  ...
  private SegmentOptionsProperty25 segmentOpts;

  public RecipientsProperty() {
  }
  ...
  public RecipientsProperty listId(String listId) {
  ...
  **/
  ...
  public RecipientsProperty segmentOpts(SegmentOptionsProperty25 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty25 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty25 segmentOpts) {
   ...
   * @return the RecipientsProperty instance itself
   */
  public RecipientsProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecipientsProperty recipientsProperty = (RecipientsProperty) o;
    return Objects.equals(this.listId, recipientsProperty.listId) &&
        Objects.equals(this.listIsActive, recipientsProperty.listIsActive) &&
        Objects.equals(this.listName, recipientsProperty.listName) &&
        Objects.equals(this.segmentText, recipientsProperty.segmentText) &&
        Objects.equals(this.recipientCount, recipientsProperty.recipientCount) &&
        Objects.equals(this.segmentOpts, recipientsProperty.segmentOpts)&&
        Objects.equals(this.additionalProperties, recipientsProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipientsProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecipientsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecipientsProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecipientsProperty is not found in the empty JSON string", RecipientsProperty.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty25.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecipientsProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecipientsProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecipientsProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecipientsProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<RecipientsProperty>() {
           @Override
           public void write(JsonWriter out, RecipientsProperty value) throws IOException {
           ...
           @Override
           public RecipientsProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecipientsProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecipientsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecipientsProperty
  * @throws IOException if the JSON string is invalid with respect to RecipientsProperty
  */
  public static RecipientsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecipientsProperty.class);
  }

 /**
  * Convert an instance of RecipientsProperty to an JSON string
  *
  * @return JSON string
  */
