 ...
 */
@ApiModel(description = "A specific event for a contact.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Event {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name for this type of event ('purchased', 'visited', etc). Must be 2-30 characters in length")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(occurredAt, name, properties, additionalProperties);
  }
