...
public class EventsProperty {
  ...
  public EventsProperty subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty instance itself
   */
  public EventsProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty eventsProperty = (EventsProperty) o;
    return Objects.equals(this.subscribe, eventsProperty.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty.profile) &&
        Objects.equals(this.cleaned, eventsProperty.cleaned) &&
        Objects.equals(this.upemail, eventsProperty.upemail) &&
        Objects.equals(this.campaign, eventsProperty.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty is not found in the empty JSON string", EventsProperty.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty>() {
           @Override
           public void write(JsonWriter out, EventsProperty value) throws IOException {
           ...
           @Override
           public EventsProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty
  * @throws IOException if the JSON string is invalid with respect to EventsProperty
  */
  public static EventsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty.class);
  }

 /**
  * Convert an instance of EventsProperty to an JSON string
  *
  * @return JSON string
  */
