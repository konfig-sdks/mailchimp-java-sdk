...
public class SegmentOptionsProperty16 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty16() {
  }

  public SegmentOptionsProperty16 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty16 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty16 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty16 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty16 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty16 instance itself
   */
  public SegmentOptionsProperty16 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty16 segmentOptionsProperty16 = (SegmentOptionsProperty16) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty16.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty16.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty16.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty16.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty16.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty16 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty16
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty16.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty16 is not found in the empty JSON string", SegmentOptionsProperty16.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty16.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty16' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty16> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty16.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty16>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty16 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty16 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty16 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty16 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty16
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty16
  */
  public static SegmentOptionsProperty16 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty16.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty16 to an JSON string
  *
  * @return JSON string
  */
