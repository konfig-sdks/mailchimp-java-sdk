...
import com.konfigthis.client.model.AutomationDelayProperty2;
...
import com.konfigthis.client.model.ListProperty10;
...
public class AutomationWorkflowEmail1 {
  ...
  private AutomationDelayProperty2 delay;
 ...
 public enum StatusEnum {
  ...
  private ListProperty10 recipients;
  ...
  public AutomationWorkflowEmail1() {
  }
  ...
  **/
  ...
  public AutomationWorkflowEmail1 delay(AutomationDelayProperty2 delay) {
  ...
  **/
  ...
  public AutomationDelayProperty2 getDelay() {
    return delay;
  }


  public void setDelay(AutomationDelayProperty2 delay) {
  ...
  **/
  ...
  public AutomationWorkflowEmail1 recipients(ListProperty10 recipients) {
  ...
  **/
  ...
  public ListProperty10 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty10 recipients) {
  ...
  public AutomationWorkflowEmail1 settings(CampaignSettingsProperty3 settings) {
  ...
  **/
  ...
  public AutomationWorkflowEmail1 tracking(CampaignTrackingOptionsProperty1 tracking) {
  ...
  **/
  ...
  public AutomationWorkflowEmail1 socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public AutomationWorkflowEmail1 triggerSettings(AutomationTriggerProperty1 triggerSettings) {
  ...
  **/
  ...
  public AutomationWorkflowEmail1 reportSummary(CampaignReportSummaryProperty1 reportSummary) {
  ...
  **/
   ...
   * @return the AutomationWorkflowEmail1 instance itself
   */
  public AutomationWorkflowEmail1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, automationWorkflowEmail1.id) &&
        ...
        Objects.equals(this.links, automationWorkflowEmail1.links)&&
        Objects.equals(this.additionalProperties, automationWorkflowEmail1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationWorkflowEmail1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationWorkflowEmail1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationWorkflowEmail1 is not found in the empty JSON string", AutomationWorkflowEmail1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("delay") != null && !jsonObj.get("delay").isJsonNull()) {
        AutomationDelayProperty2.validateJsonObject(jsonObj.getAsJsonObject("delay"));
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty10.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationWorkflowEmail1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationWorkflowEmail1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationWorkflowEmail1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationWorkflowEmail1.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationWorkflowEmail1>() {
           @Override
           public void write(JsonWriter out, AutomationWorkflowEmail1 value) throws IOException {
           ...
           @Override
           public AutomationWorkflowEmail1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationWorkflowEmail1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationWorkflowEmail1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationWorkflowEmail1
  * @throws IOException if the JSON string is invalid with respect to AutomationWorkflowEmail1
  */
  public static AutomationWorkflowEmail1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationWorkflowEmail1.class);
  }

 /**
  * Convert an instance of AutomationWorkflowEmail1 to an JSON string
  *
  * @return JSON string
  */
