...
public class SegmentOptions {
  ...
  **/
  ...
  public SegmentOptions prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
   ...
   * @return the SegmentOptions instance itself
   */
  public SegmentOptions putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.savedSegmentId, segmentOptions.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptions.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptions.match) &&
        Objects.equals(this.conditions, segmentOptions.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptions.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptions
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptions.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptions is not found in the empty JSON string", SegmentOptions.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptions.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptions' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptions> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptions.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptions>() {
           @Override
           public void write(JsonWriter out, SegmentOptions value) throws IOException {
           ...
           @Override
           public SegmentOptions read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptions instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptions given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptions
  * @throws IOException if the JSON string is invalid with respect to SegmentOptions
  */
  public static SegmentOptions fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptions.class);
  }

 /**
  * Convert an instance of SegmentOptions to an JSON string
  *
  * @return JSON string
  */
