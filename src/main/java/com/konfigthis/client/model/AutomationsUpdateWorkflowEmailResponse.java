...
public class AutomationsUpdateWorkflowEmailResponse {
  ...
  private AutomationDelayProperty5 delay;
 ...
 public enum StatusEnum {
  ...
  private ListProperty13 recipients;
  ...
  public AutomationsUpdateWorkflowEmailResponse() {
  }
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmailResponse delay(AutomationDelayProperty5 delay) {
  ...
  **/
  ...
  public AutomationDelayProperty5 getDelay() {
    return delay;
  }


  public void setDelay(AutomationDelayProperty5 delay) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmailResponse recipients(ListProperty13 recipients) {
  ...
  **/
  ...
  public ListProperty13 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty13 recipients) {
  ...
  public AutomationsUpdateWorkflowEmailResponse settings(CampaignSettingsProperty3 settings) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmailResponse tracking(CampaignTrackingOptionsProperty1 tracking) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmailResponse socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmailResponse triggerSettings(AutomationTriggerProperty1 triggerSettings) {
  ...
  **/
  ...
  public AutomationsUpdateWorkflowEmailResponse reportSummary(CampaignReportSummaryProperty1 reportSummary) {
  ...
  **/
   ...
   * @return the AutomationsUpdateWorkflowEmailResponse instance itself
   */
  public AutomationsUpdateWorkflowEmailResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationsUpdateWorkflowEmailResponse automationsUpdateWorkflowEmailResponse = (AutomationsUpdateWorkflowEmailResponse) o;
    return Objects.equals(this.id, automationsUpdateWorkflowEmailResponse.id) &&
        Objects.equals(this.webId, automationsUpdateWorkflowEmailResponse.webId) &&
        Objects.equals(this.workflowId, automationsUpdateWorkflowEmailResponse.workflowId) &&
        Objects.equals(this.position, automationsUpdateWorkflowEmailResponse.position) &&
        Objects.equals(this.delay, automationsUpdateWorkflowEmailResponse.delay) &&
        Objects.equals(this.createTime, automationsUpdateWorkflowEmailResponse.createTime) &&
        Objects.equals(this.startTime, automationsUpdateWorkflowEmailResponse.startTime) &&
        Objects.equals(this.archiveUrl, automationsUpdateWorkflowEmailResponse.archiveUrl) &&
        Objects.equals(this.status, automationsUpdateWorkflowEmailResponse.status) &&
        Objects.equals(this.emailsSent, automationsUpdateWorkflowEmailResponse.emailsSent) &&
        Objects.equals(this.sendTime, automationsUpdateWorkflowEmailResponse.sendTime) &&
        Objects.equals(this.contentType, automationsUpdateWorkflowEmailResponse.contentType) &&
        Objects.equals(this.needsBlockRefresh, automationsUpdateWorkflowEmailResponse.needsBlockRefresh) &&
        Objects.equals(this.hasLogoMergeTag, automationsUpdateWorkflowEmailResponse.hasLogoMergeTag) &&
        Objects.equals(this.recipients, automationsUpdateWorkflowEmailResponse.recipients) &&
        Objects.equals(this.settings, automationsUpdateWorkflowEmailResponse.settings) &&
        Objects.equals(this.tracking, automationsUpdateWorkflowEmailResponse.tracking) &&
        Objects.equals(this.socialCard, automationsUpdateWorkflowEmailResponse.socialCard) &&
        Objects.equals(this.triggerSettings, automationsUpdateWorkflowEmailResponse.triggerSettings) &&
        Objects.equals(this.reportSummary, automationsUpdateWorkflowEmailResponse.reportSummary) &&
        Objects.equals(this.links, automationsUpdateWorkflowEmailResponse.links)&&
        Objects.equals(this.additionalProperties, automationsUpdateWorkflowEmailResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationsUpdateWorkflowEmailResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationsUpdateWorkflowEmailResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationsUpdateWorkflowEmailResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationsUpdateWorkflowEmailResponse is not found in the empty JSON string", AutomationsUpdateWorkflowEmailResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("delay") != null && !jsonObj.get("delay").isJsonNull()) {
        AutomationDelayProperty5.validateJsonObject(jsonObj.getAsJsonObject("delay"));
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty13.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationsUpdateWorkflowEmailResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationsUpdateWorkflowEmailResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationsUpdateWorkflowEmailResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationsUpdateWorkflowEmailResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationsUpdateWorkflowEmailResponse>() {
           @Override
           public void write(JsonWriter out, AutomationsUpdateWorkflowEmailResponse value) throws IOException {
           ...
           @Override
           public AutomationsUpdateWorkflowEmailResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationsUpdateWorkflowEmailResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationsUpdateWorkflowEmailResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationsUpdateWorkflowEmailResponse
  * @throws IOException if the JSON string is invalid with respect to AutomationsUpdateWorkflowEmailResponse
  */
  public static AutomationsUpdateWorkflowEmailResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationsUpdateWorkflowEmailResponse.class);
  }

 /**
  * Convert an instance of AutomationsUpdateWorkflowEmailResponse to an JSON string
  *
  * @return JSON string
  */
