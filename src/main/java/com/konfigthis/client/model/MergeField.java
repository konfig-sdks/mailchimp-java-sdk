...
import com.konfigthis.client.model.MergeFieldOptionsProperty2;
...
public class MergeField {
 ...
 public enum TypeEnum {
  ...
  private MergeFieldOptionsProperty2 options;
  ...
  **/
  ...
  public MergeField options(MergeFieldOptionsProperty2 options) {
  ...
  **/
  ...
  public MergeFieldOptionsProperty2 getOptions() {
    return options;
  }


  public void setOptions(MergeFieldOptionsProperty2 options) {
  ...
  **/
   ...
   * @return the MergeField instance itself
   */
  public MergeField putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.mergeId, mergeField.mergeId) &&
        ...
        Objects.equals(this.additionalProperties, mergeField.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to MergeField
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!MergeField.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in MergeField is not found in the empty JSON string", MergeField.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("options") != null && !jsonObj.get("options").isJsonNull()) {
        MergeFieldOptionsProperty2.validateJsonObject(jsonObj.getAsJsonObject("options"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!MergeField.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'MergeField' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<MergeField> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(MergeField.class));

       return (TypeAdapter<T>) new TypeAdapter<MergeField>() {
           @Override
           public void write(JsonWriter out, MergeField value) throws IOException {
           ...
           @Override
           public MergeField read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             MergeField instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of MergeField given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of MergeField
  * @throws IOException if the JSON string is invalid with respect to MergeField
  */
  public static MergeField fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, MergeField.class);
  }

 /**
  * Convert an instance of MergeField to an JSON string
  *
  * @return JSON string
  */
