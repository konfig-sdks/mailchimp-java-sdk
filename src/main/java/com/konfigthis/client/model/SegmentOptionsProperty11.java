...
public class SegmentOptionsProperty11 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty11() {
  }

  public SegmentOptionsProperty11 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty11 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty11 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty11 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty11 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty11 instance itself
   */
  public SegmentOptionsProperty11 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty11 segmentOptionsProperty11 = (SegmentOptionsProperty11) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty11.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty11.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty11.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty11.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty11.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty11 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty11
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty11.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty11 is not found in the empty JSON string", SegmentOptionsProperty11.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty11.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty11' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty11> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty11.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty11>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty11 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty11 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty11 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty11 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty11
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty11
  */
  public static SegmentOptionsProperty11 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty11.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty11 to an JSON string
  *
  * @return JSON string
  */
