...
public class ListProperty4 {
  ...
  public ListProperty4 listId(String listId) {
  ...
  **/
  ...
  public ListProperty4 listName(String listName) {
  ...
  **/
  ...
  public ListProperty4 segmentOpts(SegmentOptionsProperty2 segmentOpts) {
  ...
  **/
  ...
  public ListProperty4 storeId(String storeId) {
  ...
  **/
   ...
   * @return the ListProperty4 instance itself
   */
  public ListProperty4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty4 listProperty4 = (ListProperty4) o;
    return Objects.equals(this.listId, listProperty4.listId) &&
        Objects.equals(this.listIsActive, listProperty4.listIsActive) &&
        Objects.equals(this.listName, listProperty4.listName) &&
        Objects.equals(this.segmentOpts, listProperty4.segmentOpts) &&
        Objects.equals(this.storeId, listProperty4.storeId)&&
        Objects.equals(this.additionalProperties, listProperty4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty4 is not found in the empty JSON string", ListProperty4.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty4.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty4>() {
           @Override
           public void write(JsonWriter out, ListProperty4 value) throws IOException {
           ...
           @Override
           public ListProperty4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty4
  * @throws IOException if the JSON string is invalid with respect to ListProperty4
  */
  public static ListProperty4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty4.class);
  }

 /**
  * Convert an instance of ListProperty4 to an JSON string
  *
  * @return JSON string
  */
