...
import com.konfigthis.client.model.ECommerceCustomerProperty7;
...
public class ECommerceCart1 {
  ...
  private ECommerceCustomerProperty7 customer;
  ...
  **/
  ...
  public ECommerceCart1 customer(ECommerceCustomerProperty7 customer) {
  ...
  **/
  ...
  public ECommerceCustomerProperty7 getCustomer() {
    return customer;
  }


  public void setCustomer(ECommerceCustomerProperty7 customer) {
  ...
  **/
  ...
  public ECommerceCart1 orderTotal(Double orderTotal) {
  ...
  public ECommerceCart1 orderTotal(Integer orderTotal) {
  ...
  **/
  ...
  public ECommerceCart1 taxTotal(Double taxTotal) {
  ...
  public ECommerceCart1 taxTotal(Integer taxTotal) {
  ...
  **/
  ...
  public ECommerceCart1 lines(List<ECommerceCartLineItem2> lines) {
  ...
  public ECommerceCart1 addLinesItem(ECommerceCartLineItem2 linesItem) {
    if (this.lines == null) {
  ...
  **/
   ...
   * @return the ECommerceCart1 instance itself
   */
  public ECommerceCart1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eCommerceCart1.id) &&
        ...
        Objects.equals(this.links, eCommerceCart1.links)&&
        Objects.equals(this.additionalProperties, eCommerceCart1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceCart1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceCart1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceCart1 is not found in the empty JSON string", ECommerceCart1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("customer") != null && !jsonObj.get("customer").isJsonNull()) {
        ECommerceCustomerProperty7.validateJsonObject(jsonObj.getAsJsonObject("customer"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceCart1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceCart1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceCart1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceCart1.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceCart1>() {
           @Override
           public void write(JsonWriter out, ECommerceCart1 value) throws IOException {
           ...
           @Override
           public ECommerceCart1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceCart1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceCart1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceCart1
  * @throws IOException if the JSON string is invalid with respect to ECommerceCart1
  */
  public static ECommerceCart1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceCart1.class);
  }

 /**
  * Convert an instance of ECommerceCart1 to an JSON string
  *
  * @return JSON string
  */
