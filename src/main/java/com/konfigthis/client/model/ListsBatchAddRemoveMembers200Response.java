...
public class ListsBatchAddRemoveMembers200Response {
  ...
  public ListsBatchAddRemoveMembers200Response() {
  }
  ...
  public ListsBatchAddRemoveMembers200Response membersAdded(List<ListMembers> membersAdded) {
  ...
  public ListsBatchAddRemoveMembers200Response addMembersAddedItem(ListMembers membersAddedItem) {
  ...
  **/
  ...
  public ListsBatchAddRemoveMembers200Response membersRemoved(List<ListMembers> membersRemoved) {
  ...
  public ListsBatchAddRemoveMembers200Response addMembersRemovedItem(ListMembers membersRemovedItem) {
  ...
  **/
  ...
  public ListsBatchAddRemoveMembers200Response errors(List<ErrorsPropertyInner1> errors) {
  ...
  public ListsBatchAddRemoveMembers200Response addErrorsItem(ErrorsPropertyInner1 errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public ListsBatchAddRemoveMembers200Response totalAdded(Integer totalAdded) {
  ...
  **/
  ...
  public ListsBatchAddRemoveMembers200Response totalRemoved(Integer totalRemoved) {
  ...
  **/
  ...
  public ListsBatchAddRemoveMembers200Response errorCount(Integer errorCount) {
  ...
  **/
   ...
   * @return the ListsBatchAddRemoveMembers200Response instance itself
   */
  public ListsBatchAddRemoveMembers200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListsBatchAddRemoveMembers200Response listsBatchAddRemoveMembers200Response = (ListsBatchAddRemoveMembers200Response) o;
    return Objects.equals(this.membersAdded, listsBatchAddRemoveMembers200Response.membersAdded) &&
        Objects.equals(this.membersRemoved, listsBatchAddRemoveMembers200Response.membersRemoved) &&
        Objects.equals(this.errors, listsBatchAddRemoveMembers200Response.errors) &&
        Objects.equals(this.totalAdded, listsBatchAddRemoveMembers200Response.totalAdded) &&
        Objects.equals(this.totalRemoved, listsBatchAddRemoveMembers200Response.totalRemoved) &&
        Objects.equals(this.errorCount, listsBatchAddRemoveMembers200Response.errorCount) &&
        Objects.equals(this.links, listsBatchAddRemoveMembers200Response.links)&&
        Objects.equals(this.additionalProperties, listsBatchAddRemoveMembers200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListsBatchAddRemoveMembers200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListsBatchAddRemoveMembers200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListsBatchAddRemoveMembers200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListsBatchAddRemoveMembers200Response is not found in the empty JSON string", ListsBatchAddRemoveMembers200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListsBatchAddRemoveMembers200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListsBatchAddRemoveMembers200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListsBatchAddRemoveMembers200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListsBatchAddRemoveMembers200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ListsBatchAddRemoveMembers200Response>() {
           @Override
           public void write(JsonWriter out, ListsBatchAddRemoveMembers200Response value) throws IOException {
           ...
           @Override
           public ListsBatchAddRemoveMembers200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListsBatchAddRemoveMembers200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListsBatchAddRemoveMembers200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListsBatchAddRemoveMembers200Response
  * @throws IOException if the JSON string is invalid with respect to ListsBatchAddRemoveMembers200Response
  */
  public static ListsBatchAddRemoveMembers200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListsBatchAddRemoveMembers200Response.class);
  }

 /**
  * Convert an instance of ListsBatchAddRemoveMembers200Response to an JSON string
  *
  * @return JSON string
  */
