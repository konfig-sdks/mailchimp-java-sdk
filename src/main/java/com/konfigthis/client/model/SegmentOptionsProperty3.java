...
public class SegmentOptionsProperty3 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty3() {
  }

  public SegmentOptionsProperty3 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty3 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty3 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty3 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty3 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty3 instance itself
   */
  public SegmentOptionsProperty3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty3 segmentOptionsProperty3 = (SegmentOptionsProperty3) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty3.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty3.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty3.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty3.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty3.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty3 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty3 is not found in the empty JSON string", SegmentOptionsProperty3.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty3.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty3>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty3 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty3
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty3
  */
  public static SegmentOptionsProperty3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty3.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty3 to an JSON string
  *
  * @return JSON string
  */
