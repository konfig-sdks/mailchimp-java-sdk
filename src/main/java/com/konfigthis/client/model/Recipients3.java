...
import com.konfigthis.client.model.SegmentOptions3;
...
public class Recipients3 {
  ...
  private SegmentOptions3 segmentOpts;
  ...
  public Recipients3 listId(String listId) {
  ...
  **/
  ...
  public Recipients3 segmentOpts(SegmentOptions3 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptions3 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptions3 segmentOpts) {
   ...
   * @return the Recipients3 instance itself
   */
  public Recipients3 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    Recipients3 recipients3 = (Recipients3) o;
    return Objects.equals(this.listId, recipients3.listId) &&
        Objects.equals(this.listIsActive, recipients3.listIsActive) &&
        Objects.equals(this.listName, recipients3.listName) &&
        Objects.equals(this.segmentText, recipients3.segmentText) &&
        Objects.equals(this.recipientCount, recipients3.recipientCount) &&
        Objects.equals(this.segmentOpts, recipients3.segmentOpts)&&
        Objects.equals(this.additionalProperties, recipients3.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Recipients3
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Recipients3.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Recipients3 is not found in the empty JSON string", Recipients3.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptions3.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Recipients3.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Recipients3' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Recipients3> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Recipients3.class));

       return (TypeAdapter<T>) new TypeAdapter<Recipients3>() {
           @Override
           public void write(JsonWriter out, Recipients3 value) throws IOException {
           ...
           @Override
           public Recipients3 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Recipients3 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Recipients3 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Recipients3
  * @throws IOException if the JSON string is invalid with respect to Recipients3
  */
  public static Recipients3 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Recipients3.class);
  }

 /**
  * Convert an instance of Recipients3 to an JSON string
  *
  * @return JSON string
  */
