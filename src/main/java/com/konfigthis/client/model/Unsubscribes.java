...
public class Unsubscribes {
  ...
  **/
  ...
  public Unsubscribes mergeFields(Map<String, Object> mergeFields) {
  ...
  public Unsubscribes putMergeFieldsItem(String key, Object mergeFieldsItem) {
  ...
  **/
   ...
   * @return the Unsubscribes instance itself
   */
  public Unsubscribes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.emailId, unsubscribes.emailId) &&
        Objects.equals(this.emailAddress, unsubscribes.emailAddress) &&
        Objects.equals(this.mergeFields, unsubscribes.mergeFields) &&
        Objects.equals(this.vip, unsubscribes.vip) &&
        Objects.equals(this.timestamp, unsubscribes.timestamp) &&
        Objects.equals(this.reason, unsubscribes.reason) &&
        Objects.equals(this.campaignId, unsubscribes.campaignId) &&
        Objects.equals(this.listId, unsubscribes.listId) &&
        Objects.equals(this.listIsActive, unsubscribes.listIsActive) &&
        Objects.equals(this.links, unsubscribes.links)&&
        Objects.equals(this.additionalProperties, unsubscribes.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Unsubscribes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Unsubscribes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Unsubscribes is not found in the empty JSON string", Unsubscribes.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Unsubscribes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Unsubscribes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Unsubscribes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Unsubscribes.class));

       return (TypeAdapter<T>) new TypeAdapter<Unsubscribes>() {
           @Override
           public void write(JsonWriter out, Unsubscribes value) throws IOException {
           ...
           @Override
           public Unsubscribes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Unsubscribes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Unsubscribes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Unsubscribes
  * @throws IOException if the JSON string is invalid with respect to Unsubscribes
  */
  public static Unsubscribes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Unsubscribes.class);
  }

 /**
  * Convert an instance of Unsubscribes to an JSON string
  *
  * @return JSON string
  */
