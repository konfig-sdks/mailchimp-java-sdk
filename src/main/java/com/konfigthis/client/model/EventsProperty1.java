...
public class EventsProperty1 {
  ...
  public EventsProperty1() {
  }

  public EventsProperty1 subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty1 unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty1 profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty1 cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty1 upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty1 campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty1 instance itself
   */
  public EventsProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty1 eventsProperty1 = (EventsProperty1) o;
    return Objects.equals(this.subscribe, eventsProperty1.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty1.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty1.profile) &&
        Objects.equals(this.cleaned, eventsProperty1.cleaned) &&
        Objects.equals(this.upemail, eventsProperty1.upemail) &&
        Objects.equals(this.campaign, eventsProperty1.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty1 is not found in the empty JSON string", EventsProperty1.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty1>() {
           @Override
           public void write(JsonWriter out, EventsProperty1 value) throws IOException {
           ...
           @Override
           public EventsProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty1
  * @throws IOException if the JSON string is invalid with respect to EventsProperty1
  */
  public static EventsProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty1.class);
  }

 /**
  * Convert an instance of EventsProperty1 to an JSON string
  *
  * @return JSON string
  */
