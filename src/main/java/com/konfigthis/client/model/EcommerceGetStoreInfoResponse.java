...
import com.konfigthis.client.model.AddressProperty15;
import com.konfigthis.client.model.AutomationsProperty4;
import com.konfigthis.client.model.ConnectedSiteProperty4;
...
public class EcommerceGetStoreInfoResponse {
  ...
  public EcommerceGetStoreInfoResponse() {
  }
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse name(String name) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse platform(String platform) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse domain(String domain) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse isSyncing(Boolean isSyncing) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse emailAddress(String emailAddress) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse currencyCode(String currencyCode) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse moneyFormat(String moneyFormat) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse primaryLocale(String primaryLocale) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse timezone(String timezone) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse phone(String phone) {
  ...
  **/
  ...
  public EcommerceGetStoreInfoResponse address(AddressProperty15 address) {
  ...
  **/
  ...
  public AddressProperty15 getAddress() {
    return address;
  }


  public void setAddress(AddressProperty15 address) {
  ...
  public EcommerceGetStoreInfoResponse connectedSite(ConnectedSiteProperty4 connectedSite) {
  ...
  **/
  ...
  public ConnectedSiteProperty4 getConnectedSite() {
    return connectedSite;
  }


  public void setConnectedSite(ConnectedSiteProperty4 connectedSite) {
  ...
  public EcommerceGetStoreInfoResponse automations(AutomationsProperty4 automations) {
  ...
  **/
  ...
  public AutomationsProperty4 getAutomations() {
    return automations;
  }


  public void setAutomations(AutomationsProperty4 automations) {
  ...
  **/
   ...
   * @return the EcommerceGetStoreInfoResponse instance itself
   */
  public EcommerceGetStoreInfoResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceGetStoreInfoResponse ecommerceGetStoreInfoResponse = (EcommerceGetStoreInfoResponse) o;
    return Objects.equals(this.id, ecommerceGetStoreInfoResponse.id) &&
        Objects.equals(this.listId, ecommerceGetStoreInfoResponse.listId) &&
        Objects.equals(this.name, ecommerceGetStoreInfoResponse.name) &&
        Objects.equals(this.platform, ecommerceGetStoreInfoResponse.platform) &&
        Objects.equals(this.domain, ecommerceGetStoreInfoResponse.domain) &&
        Objects.equals(this.isSyncing, ecommerceGetStoreInfoResponse.isSyncing) &&
        Objects.equals(this.emailAddress, ecommerceGetStoreInfoResponse.emailAddress) &&
        Objects.equals(this.currencyCode, ecommerceGetStoreInfoResponse.currencyCode) &&
        Objects.equals(this.moneyFormat, ecommerceGetStoreInfoResponse.moneyFormat) &&
        Objects.equals(this.primaryLocale, ecommerceGetStoreInfoResponse.primaryLocale) &&
        Objects.equals(this.timezone, ecommerceGetStoreInfoResponse.timezone) &&
        Objects.equals(this.phone, ecommerceGetStoreInfoResponse.phone) &&
        Objects.equals(this.address, ecommerceGetStoreInfoResponse.address) &&
        Objects.equals(this.connectedSite, ecommerceGetStoreInfoResponse.connectedSite) &&
        Objects.equals(this.automations, ecommerceGetStoreInfoResponse.automations) &&
        Objects.equals(this.listIsActive, ecommerceGetStoreInfoResponse.listIsActive) &&
        Objects.equals(this.createdAt, ecommerceGetStoreInfoResponse.createdAt) &&
        Objects.equals(this.updatedAt, ecommerceGetStoreInfoResponse.updatedAt) &&
        Objects.equals(this.links, ecommerceGetStoreInfoResponse.links)&&
        Objects.equals(this.additionalProperties, ecommerceGetStoreInfoResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceGetStoreInfoResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceGetStoreInfoResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceGetStoreInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceGetStoreInfoResponse is not found in the empty JSON string", EcommerceGetStoreInfoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        AddressProperty15.validateJsonObject(jsonObj.getAsJsonObject("address"));
      }
      // validate the optional field `connected_site`
      if (jsonObj.get("connected_site") != null && !jsonObj.get("connected_site").isJsonNull()) {
        ConnectedSiteProperty4.validateJsonObject(jsonObj.getAsJsonObject("connected_site"));
      }
      // validate the optional field `automations`
      if (jsonObj.get("automations") != null && !jsonObj.get("automations").isJsonNull()) {
        AutomationsProperty4.validateJsonObject(jsonObj.getAsJsonObject("automations"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceGetStoreInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceGetStoreInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceGetStoreInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceGetStoreInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceGetStoreInfoResponse>() {
           @Override
           public void write(JsonWriter out, EcommerceGetStoreInfoResponse value) throws IOException {
           ...
           @Override
           public EcommerceGetStoreInfoResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceGetStoreInfoResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceGetStoreInfoResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceGetStoreInfoResponse
  * @throws IOException if the JSON string is invalid with respect to EcommerceGetStoreInfoResponse
  */
  public static EcommerceGetStoreInfoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceGetStoreInfoResponse.class);
  }

 /**
  * Convert an instance of EcommerceGetStoreInfoResponse to an JSON string
  *
  * @return JSON string
  */
