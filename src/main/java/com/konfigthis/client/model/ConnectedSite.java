...
import com.konfigthis.client.model.ScriptProperty;
...
public class ConnectedSite {
  ...
  private ScriptProperty siteScript;
  ...
  **/
  ...
  public ConnectedSite siteScript(ScriptProperty siteScript) {
  ...
  **/
  ...
  public ScriptProperty getSiteScript() {
    return siteScript;
  }


  public void setSiteScript(ScriptProperty siteScript) {
  ...
  **/
   ...
   * @return the ConnectedSite instance itself
   */
  public ConnectedSite putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.foreignId, connectedSite.foreignId) &&
        ...
        Objects.equals(this.additionalProperties, connectedSite.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ConnectedSite
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ConnectedSite.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ConnectedSite is not found in the empty JSON string", ConnectedSite.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("site_script") != null && !jsonObj.get("site_script").isJsonNull()) {
        ScriptProperty.validateJsonObject(jsonObj.getAsJsonObject("site_script"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ConnectedSite.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ConnectedSite' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ConnectedSite> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ConnectedSite.class));

       return (TypeAdapter<T>) new TypeAdapter<ConnectedSite>() {
           @Override
           public void write(JsonWriter out, ConnectedSite value) throws IOException {
           ...
           @Override
           public ConnectedSite read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ConnectedSite instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ConnectedSite given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ConnectedSite
  * @throws IOException if the JSON string is invalid with respect to ConnectedSite
  */
  public static ConnectedSite fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ConnectedSite.class);
  }

 /**
  * Convert an instance of ConnectedSite to an JSON string
  *
  * @return JSON string
  */
