...
public class ReportingGetSurveyReport200Response {
 ...
 public enum StatusEnum {
  ...
  public ReportingGetSurveyReport200Response() {
  }
  ...
  **/
   ...
   * @return the ReportingGetSurveyReport200Response instance itself
   */
  public ReportingGetSurveyReport200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ReportingGetSurveyReport200Response reportingGetSurveyReport200Response = (ReportingGetSurveyReport200Response) o;
    return Objects.equals(this.title, reportingGetSurveyReport200Response.title) &&
        Objects.equals(this.id, reportingGetSurveyReport200Response.id) &&
        Objects.equals(this.webId, reportingGetSurveyReport200Response.webId) &&
        Objects.equals(this.listId, reportingGetSurveyReport200Response.listId) &&
        Objects.equals(this.listName, reportingGetSurveyReport200Response.listName) &&
        Objects.equals(this.url, reportingGetSurveyReport200Response.url) &&
        Objects.equals(this.status, reportingGetSurveyReport200Response.status) &&
        Objects.equals(this.publishedAt, reportingGetSurveyReport200Response.publishedAt) &&
        Objects.equals(this.createdAt, reportingGetSurveyReport200Response.createdAt) &&
        Objects.equals(this.updatedAt, reportingGetSurveyReport200Response.updatedAt) &&
        Objects.equals(this.totalResponses, reportingGetSurveyReport200Response.totalResponses)&&
        Objects.equals(this.additionalProperties, reportingGetSurveyReport200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ReportingGetSurveyReport200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ReportingGetSurveyReport200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ReportingGetSurveyReport200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ReportingGetSurveyReport200Response is not found in the empty JSON string", ReportingGetSurveyReport200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ReportingGetSurveyReport200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ReportingGetSurveyReport200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ReportingGetSurveyReport200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ReportingGetSurveyReport200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<ReportingGetSurveyReport200Response>() {
           @Override
           public void write(JsonWriter out, ReportingGetSurveyReport200Response value) throws IOException {
           ...
           @Override
           public ReportingGetSurveyReport200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ReportingGetSurveyReport200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ReportingGetSurveyReport200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ReportingGetSurveyReport200Response
  * @throws IOException if the JSON string is invalid with respect to ReportingGetSurveyReport200Response
  */
  public static ReportingGetSurveyReport200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ReportingGetSurveyReport200Response.class);
  }

 /**
  * Convert an instance of ReportingGetSurveyReport200Response to an JSON string
  *
  * @return JSON string
  */
