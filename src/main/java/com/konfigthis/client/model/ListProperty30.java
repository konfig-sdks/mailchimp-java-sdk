...
import com.konfigthis.client.model.SegmentOptionsProperty24;
...
public class ListProperty30 {
  ...
  private SegmentOptionsProperty24 segmentOpts;

  public ListProperty30() {
  }
  ...
  public ListProperty30 listId(String listId) {
  ...
  **/
  ...
  public ListProperty30 segmentOpts(SegmentOptionsProperty24 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty24 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty24 segmentOpts) {
   ...
   * @return the ListProperty30 instance itself
   */
  public ListProperty30 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty30 listProperty30 = (ListProperty30) o;
    return Objects.equals(this.listId, listProperty30.listId) &&
        Objects.equals(this.listIsActive, listProperty30.listIsActive) &&
        Objects.equals(this.listName, listProperty30.listName) &&
        Objects.equals(this.segmentText, listProperty30.segmentText) &&
        Objects.equals(this.recipientCount, listProperty30.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty30.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty30.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty30 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty30
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty30.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty30 is not found in the empty JSON string", ListProperty30.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty24.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty30.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty30' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty30> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty30.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty30>() {
           @Override
           public void write(JsonWriter out, ListProperty30 value) throws IOException {
           ...
           @Override
           public ListProperty30 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty30 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty30 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty30
  * @throws IOException if the JSON string is invalid with respect to ListProperty30
  */
  public static ListProperty30 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty30.class);
  }

 /**
  * Convert an instance of ListProperty30 to an JSON string
  *
  * @return JSON string
  */
