...
public class AutomationDelayProperty6 {
 ...
 public enum ActionEnum {
  ...
  public AutomationDelayProperty6() {
  }
  ...
  **/
  ...
  public AutomationDelayProperty6 type(TypeEnum type) {
  ...
  **/
  ...
  public AutomationDelayProperty6 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public AutomationDelayProperty6 action(ActionEnum action) {
  ...
  **/
   ...
   * @return the AutomationDelayProperty6 instance itself
   */
  public AutomationDelayProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationDelayProperty6 automationDelayProperty6 = (AutomationDelayProperty6) o;
    return Objects.equals(this.amount, automationDelayProperty6.amount) &&
        Objects.equals(this.type, automationDelayProperty6.type) &&
        Objects.equals(this.direction, automationDelayProperty6.direction) &&
        Objects.equals(this.action, automationDelayProperty6.action) &&
        Objects.equals(this.actionDescription, automationDelayProperty6.actionDescription) &&
        Objects.equals(this.fullDescription, automationDelayProperty6.fullDescription)&&
        Objects.equals(this.additionalProperties, automationDelayProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationDelayProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationDelayProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationDelayProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationDelayProperty6 is not found in the empty JSON string", AutomationDelayProperty6.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationDelayProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationDelayProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationDelayProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationDelayProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationDelayProperty6>() {
           @Override
           public void write(JsonWriter out, AutomationDelayProperty6 value) throws IOException {
           ...
           @Override
           public AutomationDelayProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationDelayProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationDelayProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationDelayProperty6
  * @throws IOException if the JSON string is invalid with respect to AutomationDelayProperty6
  */
  public static AutomationDelayProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationDelayProperty6.class);
  }

 /**
  * Convert an instance of AutomationDelayProperty6 to an JSON string
  *
  * @return JSON string
  */
