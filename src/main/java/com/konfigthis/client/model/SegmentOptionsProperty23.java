...
public class SegmentOptionsProperty23 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty23() {
  }

  public SegmentOptionsProperty23 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty23 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty23 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty23 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty23 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty23 instance itself
   */
  public SegmentOptionsProperty23 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty23 segmentOptionsProperty23 = (SegmentOptionsProperty23) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty23.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty23.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty23.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty23.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty23.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty23 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty23
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty23.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty23 is not found in the empty JSON string", SegmentOptionsProperty23.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty23.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty23' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty23> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty23.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty23>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty23 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty23 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty23 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty23 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty23
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty23
  */
  public static SegmentOptionsProperty23 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty23.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty23 to an JSON string
  *
  * @return JSON string
  */
