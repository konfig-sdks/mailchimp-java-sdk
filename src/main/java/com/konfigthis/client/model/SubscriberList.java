...
public class SubscriberList {
  ...
  **/
  ...
  public SubscriberList contact(ListContactProperty2 contact) {
  ...
  **/
  ...
  public SubscriberList campaignDefaults(CampaignDefaultsProperty1 campaignDefaults) {
  ...
  **/
  ...
  public SubscriberList stats(StatisticsProperty stats) {
  ...
  * @throws IOException if the JSON Object is invalid with respect to SubscriberList
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SubscriberList.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SubscriberList is not found in the empty JSON string", SubscriberList.openapiRequiredFields.toString()));
        }
      }
