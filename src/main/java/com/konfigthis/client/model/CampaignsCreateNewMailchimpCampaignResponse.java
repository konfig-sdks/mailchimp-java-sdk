...
public class CampaignsCreateNewMailchimpCampaignResponse {
 ...
 public enum ContentTypeEnum {
  ...
  private ListProperty17 recipients;
  ...
  public CampaignsCreateNewMailchimpCampaignResponse() {
  }
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse contentType(ContentTypeEnum contentType) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse recipients(ListProperty17 recipients) {
  ...
  **/
  ...
  public ListProperty17 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty17 recipients) {
  ...
  public CampaignsCreateNewMailchimpCampaignResponse settings(CampaignSettingsProperty4 settings) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse variateSettings(ABTestOptionsProperty1 variateSettings) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse rssOpts(RSSOptionsProperty2 rssOpts) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse reportSummary(CampaignReportSummaryProperty2 reportSummary) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
  ...
  public CampaignsCreateNewMailchimpCampaignResponse resendShortcutEligibility(ResendShortcutEligibilityProperty resendShortcutEligibility) {
  ...
  **/
   ...
   * @return the CampaignsCreateNewMailchimpCampaignResponse instance itself
   */
  public CampaignsCreateNewMailchimpCampaignResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsCreateNewMailchimpCampaignResponse campaignsCreateNewMailchimpCampaignResponse = (CampaignsCreateNewMailchimpCampaignResponse) o;
    return Objects.equals(this.id, campaignsCreateNewMailchimpCampaignResponse.id) &&
        Objects.equals(this.webId, campaignsCreateNewMailchimpCampaignResponse.webId) &&
        Objects.equals(this.parentCampaignId, campaignsCreateNewMailchimpCampaignResponse.parentCampaignId) &&
        Objects.equals(this.type, campaignsCreateNewMailchimpCampaignResponse.type) &&
        Objects.equals(this.createTime, campaignsCreateNewMailchimpCampaignResponse.createTime) &&
        Objects.equals(this.archiveUrl, campaignsCreateNewMailchimpCampaignResponse.archiveUrl) &&
        Objects.equals(this.longArchiveUrl, campaignsCreateNewMailchimpCampaignResponse.longArchiveUrl) &&
        Objects.equals(this.status, campaignsCreateNewMailchimpCampaignResponse.status) &&
        Objects.equals(this.emailsSent, campaignsCreateNewMailchimpCampaignResponse.emailsSent) &&
        Objects.equals(this.sendTime, campaignsCreateNewMailchimpCampaignResponse.sendTime) &&
        Objects.equals(this.contentType, campaignsCreateNewMailchimpCampaignResponse.contentType) &&
        Objects.equals(this.needsBlockRefresh, campaignsCreateNewMailchimpCampaignResponse.needsBlockRefresh) &&
        Objects.equals(this.resendable, campaignsCreateNewMailchimpCampaignResponse.resendable) &&
        Objects.equals(this.recipients, campaignsCreateNewMailchimpCampaignResponse.recipients) &&
        Objects.equals(this.settings, campaignsCreateNewMailchimpCampaignResponse.settings) &&
        Objects.equals(this.variateSettings, campaignsCreateNewMailchimpCampaignResponse.variateSettings) &&
        Objects.equals(this.tracking, campaignsCreateNewMailchimpCampaignResponse.tracking) &&
        Objects.equals(this.rssOpts, campaignsCreateNewMailchimpCampaignResponse.rssOpts) &&
        Objects.equals(this.abSplitOpts, campaignsCreateNewMailchimpCampaignResponse.abSplitOpts) &&
        Objects.equals(this.socialCard, campaignsCreateNewMailchimpCampaignResponse.socialCard) &&
        Objects.equals(this.reportSummary, campaignsCreateNewMailchimpCampaignResponse.reportSummary) &&
        Objects.equals(this.deliveryStatus, campaignsCreateNewMailchimpCampaignResponse.deliveryStatus) &&
        Objects.equals(this.resendShortcutEligibility, campaignsCreateNewMailchimpCampaignResponse.resendShortcutEligibility) &&
        Objects.equals(this.links, campaignsCreateNewMailchimpCampaignResponse.links)&&
        Objects.equals(this.additionalProperties, campaignsCreateNewMailchimpCampaignResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsCreateNewMailchimpCampaignResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsCreateNewMailchimpCampaignResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsCreateNewMailchimpCampaignResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsCreateNewMailchimpCampaignResponse is not found in the empty JSON string", CampaignsCreateNewMailchimpCampaignResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty17.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsCreateNewMailchimpCampaignResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsCreateNewMailchimpCampaignResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsCreateNewMailchimpCampaignResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsCreateNewMailchimpCampaignResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsCreateNewMailchimpCampaignResponse>() {
           @Override
           public void write(JsonWriter out, CampaignsCreateNewMailchimpCampaignResponse value) throws IOException {
           ...
           @Override
           public CampaignsCreateNewMailchimpCampaignResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsCreateNewMailchimpCampaignResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsCreateNewMailchimpCampaignResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsCreateNewMailchimpCampaignResponse
  * @throws IOException if the JSON string is invalid with respect to CampaignsCreateNewMailchimpCampaignResponse
  */
  public static CampaignsCreateNewMailchimpCampaignResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsCreateNewMailchimpCampaignResponse.class);
  }

 /**
  * Convert an instance of CampaignsCreateNewMailchimpCampaignResponse to an JSON string
  *
  * @return JSON string
  */
