...
import com.konfigthis.client.model.SegmentOptionsProperty7;
...
public class ListProperty13 {
  ...
  private SegmentOptionsProperty7 segmentOpts;

  public ListProperty13() {
  }
  ...
  public ListProperty13 listId(String listId) {
  ...
  **/
  ...
  public ListProperty13 segmentOpts(SegmentOptionsProperty7 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty7 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty7 segmentOpts) {
   ...
   * @return the ListProperty13 instance itself
   */
  public ListProperty13 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty13 listProperty13 = (ListProperty13) o;
    return Objects.equals(this.listId, listProperty13.listId) &&
        Objects.equals(this.listIsActive, listProperty13.listIsActive) &&
        Objects.equals(this.listName, listProperty13.listName) &&
        Objects.equals(this.segmentText, listProperty13.segmentText) &&
        Objects.equals(this.recipientCount, listProperty13.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty13.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty13.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty13 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty13
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty13.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty13 is not found in the empty JSON string", ListProperty13.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty7.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty13.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty13>() {
           @Override
           public void write(JsonWriter out, ListProperty13 value) throws IOException {
           ...
           @Override
           public ListProperty13 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty13 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty13 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty13
  * @throws IOException if the JSON string is invalid with respect to ListProperty13
  */
  public static ListProperty13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty13.class);
  }

 /**
  * Convert an instance of ListProperty13 to an JSON string
  *
  * @return JSON string
  */
