...
public class ListProperty28 {
  ...
  private SegmentOptionsProperty22 segmentOpts;

  public ListProperty28() {
  }
  ...
  public ListProperty28 listId(String listId) {
  ...
  **/
  ...
  public ListProperty28 segmentOpts(SegmentOptionsProperty22 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty22 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty22 segmentOpts) {
   ...
   * @return the ListProperty28 instance itself
   */
  public ListProperty28 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty28 listProperty28 = (ListProperty28) o;
    return Objects.equals(this.listId, listProperty28.listId) &&
        Objects.equals(this.listName, listProperty28.listName) &&
        Objects.equals(this.segmentText, listProperty28.segmentText) &&
        Objects.equals(this.recipientCount, listProperty28.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty28.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty28.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty28 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty28
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty28.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty28 is not found in the empty JSON string", ListProperty28.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListProperty28.openapiRequiredFields) {
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty22.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty28.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty28' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty28> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty28.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty28>() {
           @Override
           public void write(JsonWriter out, ListProperty28 value) throws IOException {
           ...
           @Override
           public ListProperty28 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty28 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty28 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty28
  * @throws IOException if the JSON string is invalid with respect to ListProperty28
  */
  public static ListProperty28 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty28.class);
  }

 /**
  * Convert an instance of ListProperty28 to an JSON string
  *
  * @return JSON string
  */
