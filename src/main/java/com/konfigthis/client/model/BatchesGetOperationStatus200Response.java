...
public class BatchesGetOperationStatus200Response {
 ...
 public enum StatusEnum {
  ...
  public BatchesGetOperationStatus200Response() {
  }
  ...
  **/
   ...
   * @return the BatchesGetOperationStatus200Response instance itself
   */
  public BatchesGetOperationStatus200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BatchesGetOperationStatus200Response batchesGetOperationStatus200Response = (BatchesGetOperationStatus200Response) o;
    return Objects.equals(this.id, batchesGetOperationStatus200Response.id) &&
        Objects.equals(this.status, batchesGetOperationStatus200Response.status) &&
        Objects.equals(this.totalOperations, batchesGetOperationStatus200Response.totalOperations) &&
        Objects.equals(this.finishedOperations, batchesGetOperationStatus200Response.finishedOperations) &&
        Objects.equals(this.erroredOperations, batchesGetOperationStatus200Response.erroredOperations) &&
        Objects.equals(this.submittedAt, batchesGetOperationStatus200Response.submittedAt) &&
        Objects.equals(this.completedAt, batchesGetOperationStatus200Response.completedAt) &&
        Objects.equals(this.responseBodyUrl, batchesGetOperationStatus200Response.responseBodyUrl) &&
        Objects.equals(this.links, batchesGetOperationStatus200Response.links)&&
        Objects.equals(this.additionalProperties, batchesGetOperationStatus200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchesGetOperationStatus200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchesGetOperationStatus200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchesGetOperationStatus200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchesGetOperationStatus200Response is not found in the empty JSON string", BatchesGetOperationStatus200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchesGetOperationStatus200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchesGetOperationStatus200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchesGetOperationStatus200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchesGetOperationStatus200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchesGetOperationStatus200Response>() {
           @Override
           public void write(JsonWriter out, BatchesGetOperationStatus200Response value) throws IOException {
           ...
           @Override
           public BatchesGetOperationStatus200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BatchesGetOperationStatus200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BatchesGetOperationStatus200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BatchesGetOperationStatus200Response
  * @throws IOException if the JSON string is invalid with respect to BatchesGetOperationStatus200Response
  */
  public static BatchesGetOperationStatus200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchesGetOperationStatus200Response.class);
  }

 /**
  * Convert an instance of BatchesGetOperationStatus200Response to an JSON string
  *
  * @return JSON string
  */
