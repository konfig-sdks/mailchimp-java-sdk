...
public class AutomationDelayProperty1 {
 ...
 public enum ActionEnum {
  ...
  public AutomationDelayProperty1() {
  }
  ...
  **/
  ...
  public AutomationDelayProperty1 type(TypeEnum type) {
  ...
  **/
  ...
  public AutomationDelayProperty1 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public AutomationDelayProperty1 action(ActionEnum action) {
  ...
  **/
   ...
   * @return the AutomationDelayProperty1 instance itself
   */
  public AutomationDelayProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationDelayProperty1 automationDelayProperty1 = (AutomationDelayProperty1) o;
    return Objects.equals(this.amount, automationDelayProperty1.amount) &&
        Objects.equals(this.type, automationDelayProperty1.type) &&
        Objects.equals(this.direction, automationDelayProperty1.direction) &&
        Objects.equals(this.action, automationDelayProperty1.action) &&
        Objects.equals(this.actionDescription, automationDelayProperty1.actionDescription) &&
        Objects.equals(this.fullDescription, automationDelayProperty1.fullDescription)&&
        Objects.equals(this.additionalProperties, automationDelayProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationDelayProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationDelayProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationDelayProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationDelayProperty1 is not found in the empty JSON string", AutomationDelayProperty1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationDelayProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationDelayProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationDelayProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationDelayProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationDelayProperty1>() {
           @Override
           public void write(JsonWriter out, AutomationDelayProperty1 value) throws IOException {
           ...
           @Override
           public AutomationDelayProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationDelayProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationDelayProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationDelayProperty1
  * @throws IOException if the JSON string is invalid with respect to AutomationDelayProperty1
  */
  public static AutomationDelayProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationDelayProperty1.class);
  }

 /**
  * Convert an instance of AutomationDelayProperty1 to an JSON string
  *
  * @return JSON string
  */
