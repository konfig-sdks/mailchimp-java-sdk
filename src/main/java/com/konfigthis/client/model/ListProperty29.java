...
import com.konfigthis.client.model.SegmentOptionsProperty23;
...
public class ListProperty29 {
  ...
  private SegmentOptionsProperty23 segmentOpts;

  public ListProperty29() {
  }
  ...
  public ListProperty29 listId(String listId) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "A description of the [segment](https://mailchimp.com/help/create-and-send-to-a-segment/) used for the campaign. Formatted as a string marked up with HTML.")
  ...
  **/
  ...
  public ListProperty29 segmentOpts(SegmentOptionsProperty23 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty23 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty23 segmentOpts) {
   ...
   * @return the ListProperty29 instance itself
   */
  public ListProperty29 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty29 listProperty29 = (ListProperty29) o;
    return Objects.equals(this.listId, listProperty29.listId) &&
        Objects.equals(this.listIsActive, listProperty29.listIsActive) &&
        Objects.equals(this.listName, listProperty29.listName) &&
        Objects.equals(this.segmentText, listProperty29.segmentText) &&
        Objects.equals(this.recipientCount, listProperty29.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty29.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty29.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty29 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty29
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty29.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty29 is not found in the empty JSON string", ListProperty29.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty23.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty29.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty29' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty29> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty29.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty29>() {
           @Override
           public void write(JsonWriter out, ListProperty29 value) throws IOException {
           ...
           @Override
           public ListProperty29 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty29 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty29 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty29
  * @throws IOException if the JSON string is invalid with respect to ListProperty29
  */
  public static ListProperty29 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty29.class);
  }

 /**
  * Convert an instance of ListProperty29 to an JSON string
  *
  * @return JSON string
  */
