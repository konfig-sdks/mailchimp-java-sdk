...
public class ECommercePromoRule1 {
  ...
  **/
   ...
   * @return the ECommercePromoRule1 instance itself
   */
  public ECommercePromoRule1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, eCommercePromoRule1.title) &&
        Objects.equals(this.description, eCommercePromoRule1.description) &&
        Objects.equals(this.id, eCommercePromoRule1.id) &&
        ...
        Objects.equals(this.links, eCommercePromoRule1.links)&&
        Objects.equals(this.additionalProperties, eCommercePromoRule1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommercePromoRule1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommercePromoRule1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommercePromoRule1 is not found in the empty JSON string", ECommercePromoRule1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommercePromoRule1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommercePromoRule1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommercePromoRule1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommercePromoRule1.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommercePromoRule1>() {
           @Override
           public void write(JsonWriter out, ECommercePromoRule1 value) throws IOException {
           ...
           @Override
           public ECommercePromoRule1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommercePromoRule1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommercePromoRule1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommercePromoRule1
  * @throws IOException if the JSON string is invalid with respect to ECommercePromoRule1
  */
  public static ECommercePromoRule1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommercePromoRule1.class);
  }

 /**
  * Convert an instance of ECommercePromoRule1 to an JSON string
  *
  * @return JSON string
  */
