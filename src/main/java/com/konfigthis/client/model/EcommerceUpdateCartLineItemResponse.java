...
public class EcommerceUpdateCartLineItemResponse {
  ...
  public EcommerceUpdateCartLineItemResponse() {
  }
  ...
  **/
  ...
  public EcommerceUpdateCartLineItemResponse productId(String productId) {
  ...
  **/
  ...
  public EcommerceUpdateCartLineItemResponse productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceUpdateCartLineItemResponse quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceUpdateCartLineItemResponse price(Double price) {
  ...
  public EcommerceUpdateCartLineItemResponse price(Integer price) {
  ...
  **/
   ...
   * @return the EcommerceUpdateCartLineItemResponse instance itself
   */
  public EcommerceUpdateCartLineItemResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceUpdateCartLineItemResponse ecommerceUpdateCartLineItemResponse = (EcommerceUpdateCartLineItemResponse) o;
    return Objects.equals(this.id, ecommerceUpdateCartLineItemResponse.id) &&
        Objects.equals(this.productId, ecommerceUpdateCartLineItemResponse.productId) &&
        Objects.equals(this.productTitle, ecommerceUpdateCartLineItemResponse.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceUpdateCartLineItemResponse.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceUpdateCartLineItemResponse.productVariantTitle) &&
        Objects.equals(this.quantity, ecommerceUpdateCartLineItemResponse.quantity) &&
        Objects.equals(this.price, ecommerceUpdateCartLineItemResponse.price) &&
        Objects.equals(this.links, ecommerceUpdateCartLineItemResponse.links)&&
        Objects.equals(this.additionalProperties, ecommerceUpdateCartLineItemResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceUpdateCartLineItemResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceUpdateCartLineItemResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceUpdateCartLineItemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceUpdateCartLineItemResponse is not found in the empty JSON string", EcommerceUpdateCartLineItemResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceUpdateCartLineItemResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceUpdateCartLineItemResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceUpdateCartLineItemResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceUpdateCartLineItemResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceUpdateCartLineItemResponse>() {
           @Override
           public void write(JsonWriter out, EcommerceUpdateCartLineItemResponse value) throws IOException {
           ...
           @Override
           public EcommerceUpdateCartLineItemResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceUpdateCartLineItemResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceUpdateCartLineItemResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceUpdateCartLineItemResponse
  * @throws IOException if the JSON string is invalid with respect to EcommerceUpdateCartLineItemResponse
  */
  public static EcommerceUpdateCartLineItemResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceUpdateCartLineItemResponse.class);
  }

 /**
  * Convert an instance of EcommerceUpdateCartLineItemResponse to an JSON string
  *
  * @return JSON string
  */
