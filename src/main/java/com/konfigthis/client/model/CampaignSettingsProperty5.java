...
public class CampaignSettingsProperty5 {
  ...
  public CampaignSettingsProperty5() {
  }
  ...
  public CampaignSettingsProperty5 title(String title) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 subjectLine(String subjectLine) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 previewText(String previewText) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 fromName(String fromName) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The 'from' name on the campaign (not an email address).")
  ...
  public CampaignSettingsProperty5 replyTo(String replyTo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reply-to email address for the campaign.")
  ...
  public CampaignSettingsProperty5 useConversation(Boolean useConversation) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Use Mailchimp Conversation feature to manage replies.")
  ...
  public CampaignSettingsProperty5 toName(String toName) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 folderId(String folderId) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 authenticate(Boolean authenticate) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 autoFooter(Boolean autoFooter) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 inlineCss(Boolean inlineCss) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 autoTweet(Boolean autoTweet) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 autoFbPost(List<String> autoFbPost) {
  ...
  public CampaignSettingsProperty5 addAutoFbPostItem(String autoFbPostItem) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 fbComments(Boolean fbComments) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Send this campaign using [Timewarp](https://mailchimp.com/help/use-timewarp/).")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The id for the template used in this campaign.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether the campaign uses the drag-and-drop editor.")
   ...
   * @return the CampaignSettingsProperty5 instance itself
   */
  public CampaignSettingsProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignSettingsProperty5 campaignSettingsProperty5 = (CampaignSettingsProperty5) o;
    return Objects.equals(this.title, campaignSettingsProperty5.title) &&
        Objects.equals(this.subjectLine, campaignSettingsProperty5.subjectLine) &&
        Objects.equals(this.previewText, campaignSettingsProperty5.previewText) &&
        Objects.equals(this.fromName, campaignSettingsProperty5.fromName) &&
        Objects.equals(this.replyTo, campaignSettingsProperty5.replyTo) &&
        Objects.equals(this.useConversation, campaignSettingsProperty5.useConversation) &&
        Objects.equals(this.toName, campaignSettingsProperty5.toName) &&
        Objects.equals(this.folderId, campaignSettingsProperty5.folderId) &&
        Objects.equals(this.authenticate, campaignSettingsProperty5.authenticate) &&
        Objects.equals(this.autoFooter, campaignSettingsProperty5.autoFooter) &&
        Objects.equals(this.inlineCss, campaignSettingsProperty5.inlineCss) &&
        Objects.equals(this.autoTweet, campaignSettingsProperty5.autoTweet) &&
        Objects.equals(this.autoFbPost, campaignSettingsProperty5.autoFbPost) &&
        Objects.equals(this.fbComments, campaignSettingsProperty5.fbComments) &&
        Objects.equals(this.timewarp, campaignSettingsProperty5.timewarp) &&
        Objects.equals(this.templateId, campaignSettingsProperty5.templateId) &&
        Objects.equals(this.dragAndDrop, campaignSettingsProperty5.dragAndDrop)&&
        Objects.equals(this.additionalProperties, campaignSettingsProperty5.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, subjectLine, previewText, fromName, replyTo, useConversation, toName, folderId, authenticate, autoFooter, inlineCss, autoTweet, autoFbPost, fbComments, timewarp, templateId, dragAndDrop, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignSettingsProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignSettingsProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignSettingsProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignSettingsProperty5 is not found in the empty JSON string", CampaignSettingsProperty5.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignSettingsProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignSettingsProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignSettingsProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignSettingsProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignSettingsProperty5>() {
           @Override
           public void write(JsonWriter out, CampaignSettingsProperty5 value) throws IOException {
           ...
           @Override
           public CampaignSettingsProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignSettingsProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignSettingsProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignSettingsProperty5
  * @throws IOException if the JSON string is invalid with respect to CampaignSettingsProperty5
  */
  public static CampaignSettingsProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignSettingsProperty5.class);
  }

 /**
  * Convert an instance of CampaignSettingsProperty5 to an JSON string
  *
  * @return JSON string
  */
