...
public class ListsGetGrowthHistoryByMonthResponse {
  ...
  public ListsGetGrowthHistoryByMonthResponse() {
  }
  ...
  **/
   ...
   * @return the ListsGetGrowthHistoryByMonthResponse instance itself
   */
  public ListsGetGrowthHistoryByMonthResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListsGetGrowthHistoryByMonthResponse listsGetGrowthHistoryByMonthResponse = (ListsGetGrowthHistoryByMonthResponse) o;
    return Objects.equals(this.listId, listsGetGrowthHistoryByMonthResponse.listId) &&
        Objects.equals(this.month, listsGetGrowthHistoryByMonthResponse.month) &&
        Objects.equals(this.existing, listsGetGrowthHistoryByMonthResponse.existing) &&
        Objects.equals(this.imports, listsGetGrowthHistoryByMonthResponse.imports) &&
        Objects.equals(this.optins, listsGetGrowthHistoryByMonthResponse.optins) &&
        Objects.equals(this.subscribed, listsGetGrowthHistoryByMonthResponse.subscribed) &&
        Objects.equals(this.unsubscribed, listsGetGrowthHistoryByMonthResponse.unsubscribed) &&
        Objects.equals(this.reconfirm, listsGetGrowthHistoryByMonthResponse.reconfirm) &&
        Objects.equals(this.cleaned, listsGetGrowthHistoryByMonthResponse.cleaned) &&
        Objects.equals(this.pending, listsGetGrowthHistoryByMonthResponse.pending) &&
        Objects.equals(this.deleted, listsGetGrowthHistoryByMonthResponse.deleted) &&
        Objects.equals(this.transactional, listsGetGrowthHistoryByMonthResponse.transactional) &&
        Objects.equals(this.links, listsGetGrowthHistoryByMonthResponse.links)&&
        Objects.equals(this.additionalProperties, listsGetGrowthHistoryByMonthResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListsGetGrowthHistoryByMonthResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListsGetGrowthHistoryByMonthResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListsGetGrowthHistoryByMonthResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListsGetGrowthHistoryByMonthResponse is not found in the empty JSON string", ListsGetGrowthHistoryByMonthResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListsGetGrowthHistoryByMonthResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListsGetGrowthHistoryByMonthResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListsGetGrowthHistoryByMonthResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListsGetGrowthHistoryByMonthResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListsGetGrowthHistoryByMonthResponse>() {
           @Override
           public void write(JsonWriter out, ListsGetGrowthHistoryByMonthResponse value) throws IOException {
           ...
           @Override
           public ListsGetGrowthHistoryByMonthResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListsGetGrowthHistoryByMonthResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListsGetGrowthHistoryByMonthResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListsGetGrowthHistoryByMonthResponse
  * @throws IOException if the JSON string is invalid with respect to ListsGetGrowthHistoryByMonthResponse
  */
  public static ListsGetGrowthHistoryByMonthResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListsGetGrowthHistoryByMonthResponse.class);
  }

 /**
  * Convert an instance of ListsGetGrowthHistoryByMonthResponse to an JSON string
  *
  * @return JSON string
  */
