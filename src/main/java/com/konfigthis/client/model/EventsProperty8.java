...
public class EventsProperty8 {
  ...
  public EventsProperty8() {
  }

  public EventsProperty8 subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty8 unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty8 profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty8 cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty8 upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty8 campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty8 instance itself
   */
  public EventsProperty8 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty8 eventsProperty8 = (EventsProperty8) o;
    return Objects.equals(this.subscribe, eventsProperty8.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty8.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty8.profile) &&
        Objects.equals(this.cleaned, eventsProperty8.cleaned) &&
        Objects.equals(this.upemail, eventsProperty8.upemail) &&
        Objects.equals(this.campaign, eventsProperty8.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty8.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty8 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty8
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty8.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty8 is not found in the empty JSON string", EventsProperty8.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty8.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty8' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty8> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty8.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty8>() {
           @Override
           public void write(JsonWriter out, EventsProperty8 value) throws IOException {
           ...
           @Override
           public EventsProperty8 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty8 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty8 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty8
  * @throws IOException if the JSON string is invalid with respect to EventsProperty8
  */
  public static EventsProperty8 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty8.class);
  }

 /**
  * Convert an instance of EventsProperty8 to an JSON string
  *
  * @return JSON string
  */
