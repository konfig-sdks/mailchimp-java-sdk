...
import com.konfigthis.client.model.SegmentOptionsProperty16;
...
public class ListProperty22 {
  ...
  private SegmentOptionsProperty16 segmentOpts;

  public ListProperty22() {
  }
  ...
  public ListProperty22 listId(String listId) {
  ...
  **/
  ...
  public ListProperty22 segmentOpts(SegmentOptionsProperty16 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty16 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty16 segmentOpts) {
   ...
   * @return the ListProperty22 instance itself
   */
  public ListProperty22 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty22 listProperty22 = (ListProperty22) o;
    return Objects.equals(this.listId, listProperty22.listId) &&
        Objects.equals(this.listIsActive, listProperty22.listIsActive) &&
        Objects.equals(this.listName, listProperty22.listName) &&
        Objects.equals(this.segmentText, listProperty22.segmentText) &&
        Objects.equals(this.recipientCount, listProperty22.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty22.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty22.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty22 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty22
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty22.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty22 is not found in the empty JSON string", ListProperty22.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty16.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty22.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty22' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty22> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty22.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty22>() {
           @Override
           public void write(JsonWriter out, ListProperty22 value) throws IOException {
           ...
           @Override
           public ListProperty22 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty22 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty22 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty22
  * @throws IOException if the JSON string is invalid with respect to ListProperty22
  */
  public static ListProperty22 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty22.class);
  }

 /**
  * Convert an instance of ListProperty22 to an JSON string
  *
  * @return JSON string
  */
