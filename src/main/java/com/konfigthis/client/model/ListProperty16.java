...
import com.konfigthis.client.model.SegmentOptionsProperty10;
...
public class ListProperty16 {
  ...
  private SegmentOptionsProperty10 segmentOpts;

  public ListProperty16() {
  }
  ...
  public ListProperty16 listId(String listId) {
  ...
  **/
  ...
  public ListProperty16 segmentOpts(SegmentOptionsProperty10 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty10 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty10 segmentOpts) {
   ...
   * @return the ListProperty16 instance itself
   */
  public ListProperty16 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty16 listProperty16 = (ListProperty16) o;
    return Objects.equals(this.listId, listProperty16.listId) &&
        Objects.equals(this.listIsActive, listProperty16.listIsActive) &&
        Objects.equals(this.listName, listProperty16.listName) &&
        Objects.equals(this.segmentText, listProperty16.segmentText) &&
        Objects.equals(this.recipientCount, listProperty16.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty16.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty16.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty16 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty16
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty16.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty16 is not found in the empty JSON string", ListProperty16.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty10.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty16.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty16' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty16> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty16.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty16>() {
           @Override
           public void write(JsonWriter out, ListProperty16 value) throws IOException {
           ...
           @Override
           public ListProperty16 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty16 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty16 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty16
  * @throws IOException if the JSON string is invalid with respect to ListProperty16
  */
  public static ListProperty16 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty16.class);
  }

 /**
  * Convert an instance of ListProperty16 to an JSON string
  *
  * @return JSON string
  */
