...
public class EcommerceUpdatePromoRuleRequest {
 ...
 public enum TargetEnum {
  ...
  public EcommerceUpdatePromoRuleRequest() {
  }

  public EcommerceUpdatePromoRuleRequest title(String title) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest description(String description) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest startsAt(OffsetDateTime startsAt) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest endsAt(String endsAt) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest amount(Float amount) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest type(TypeEnum type) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest target(TargetEnum target) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest enabled(Boolean enabled) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest createdAtForeign(OffsetDateTime createdAtForeign) {
  ...
  **/
  ...
  public EcommerceUpdatePromoRuleRequest updatedAtForeign(OffsetDateTime updatedAtForeign) {
  ...
  **/
   ...
   * @return the EcommerceUpdatePromoRuleRequest instance itself
   */
  public EcommerceUpdatePromoRuleRequest putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceUpdatePromoRuleRequest ecommerceUpdatePromoRuleRequest = (EcommerceUpdatePromoRuleRequest) o;
    return Objects.equals(this.title, ecommerceUpdatePromoRuleRequest.title) &&
        Objects.equals(this.description, ecommerceUpdatePromoRuleRequest.description) &&
        Objects.equals(this.startsAt, ecommerceUpdatePromoRuleRequest.startsAt) &&
        Objects.equals(this.endsAt, ecommerceUpdatePromoRuleRequest.endsAt) &&
        Objects.equals(this.amount, ecommerceUpdatePromoRuleRequest.amount) &&
        Objects.equals(this.type, ecommerceUpdatePromoRuleRequest.type) &&
        Objects.equals(this.target, ecommerceUpdatePromoRuleRequest.target) &&
        Objects.equals(this.enabled, ecommerceUpdatePromoRuleRequest.enabled) &&
        Objects.equals(this.createdAtForeign, ecommerceUpdatePromoRuleRequest.createdAtForeign) &&
        Objects.equals(this.updatedAtForeign, ecommerceUpdatePromoRuleRequest.updatedAtForeign)&&
        Objects.equals(this.additionalProperties, ecommerceUpdatePromoRuleRequest.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, startsAt, endsAt, amount, type, target, enabled, createdAtForeign, updatedAtForeign, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class EcommerceUpdatePromoRuleRequest {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceUpdatePromoRuleRequest
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceUpdatePromoRuleRequest.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceUpdatePromoRuleRequest is not found in the empty JSON string", EcommerceUpdatePromoRuleRequest.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceUpdatePromoRuleRequest.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceUpdatePromoRuleRequest' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceUpdatePromoRuleRequest> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceUpdatePromoRuleRequest.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceUpdatePromoRuleRequest>() {
           @Override
           public void write(JsonWriter out, EcommerceUpdatePromoRuleRequest value) throws IOException {
           ...
           @Override
           public EcommerceUpdatePromoRuleRequest read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceUpdatePromoRuleRequest instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceUpdatePromoRuleRequest given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceUpdatePromoRuleRequest
  * @throws IOException if the JSON string is invalid with respect to EcommerceUpdatePromoRuleRequest
  */
  public static EcommerceUpdatePromoRuleRequest fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceUpdatePromoRuleRequest.class);
  }

 /**
  * Convert an instance of EcommerceUpdatePromoRuleRequest to an JSON string
  *
  * @return JSON string
  */
