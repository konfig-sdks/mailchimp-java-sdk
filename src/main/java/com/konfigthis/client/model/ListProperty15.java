...
import com.konfigthis.client.model.SegmentOptionsProperty9;
...
public class ListProperty15 {
  ...
  private SegmentOptionsProperty9 segmentOpts;

  public ListProperty15() {
  }
  ...
  public ListProperty15 listId(String listId) {
  ...
  **/
  ...
  public ListProperty15 segmentOpts(SegmentOptionsProperty9 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty9 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty9 segmentOpts) {
   ...
   * @return the ListProperty15 instance itself
   */
  public ListProperty15 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty15 listProperty15 = (ListProperty15) o;
    return Objects.equals(this.listId, listProperty15.listId) &&
        Objects.equals(this.listIsActive, listProperty15.listIsActive) &&
        Objects.equals(this.listName, listProperty15.listName) &&
        Objects.equals(this.segmentText, listProperty15.segmentText) &&
        Objects.equals(this.recipientCount, listProperty15.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty15.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty15.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty15 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty15
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty15.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty15 is not found in the empty JSON string", ListProperty15.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty9.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty15.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty15' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty15> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty15.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty15>() {
           @Override
           public void write(JsonWriter out, ListProperty15 value) throws IOException {
           ...
           @Override
           public ListProperty15 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty15 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty15 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty15
  * @throws IOException if the JSON string is invalid with respect to ListProperty15
  */
  public static ListProperty15 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty15.class);
  }

 /**
  * Convert an instance of ListProperty15 to an JSON string
  *
  * @return JSON string
  */
