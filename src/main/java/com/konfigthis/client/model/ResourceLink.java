...
public class ResourceLink {
  ...
  **/
   ...
   * @return the ResourceLink instance itself
   */
  public ResourceLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.rel, resourceLink.rel) &&
        ...
        Objects.equals(this.additionalProperties, resourceLink.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ResourceLink
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ResourceLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<ResourceLink>() {
           ...
           public ResourceLink read(JsonReader in) throws IOException {
             ...
             ResourceLink instance = thisAdapter.fromJsonTree(jsonObj);
