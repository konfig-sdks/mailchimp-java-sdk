...
public class SegmentOptionsProperty13 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty13() {
  }

  public SegmentOptionsProperty13 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty13 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty13 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty13 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty13 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty13 instance itself
   */
  public SegmentOptionsProperty13 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty13 segmentOptionsProperty13 = (SegmentOptionsProperty13) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty13.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty13.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty13.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty13.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty13.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty13 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty13
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty13.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty13 is not found in the empty JSON string", SegmentOptionsProperty13.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty13.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty13' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty13> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty13.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty13>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty13 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty13 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty13 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty13 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty13
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty13
  */
  public static SegmentOptionsProperty13 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty13.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty13 to an JSON string
  *
  * @return JSON string
  */
