...
public class SegmentOptionsProperty26 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty26() {
  }

  public SegmentOptionsProperty26 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty26 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty26 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty26 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty26 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty26 instance itself
   */
  public SegmentOptionsProperty26 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty26 segmentOptionsProperty26 = (SegmentOptionsProperty26) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty26.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty26.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty26.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty26.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty26.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty26 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty26
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty26.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty26 is not found in the empty JSON string", SegmentOptionsProperty26.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty26.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty26' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty26> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty26.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty26>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty26 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty26 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty26 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty26 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty26
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty26
  */
  public static SegmentOptionsProperty26 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty26.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty26 to an JSON string
  *
  * @return JSON string
  */
