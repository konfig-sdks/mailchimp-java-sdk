...
public class AutomationDelayProperty5 {
 ...
 public enum ActionEnum {
  ...
  public AutomationDelayProperty5() {
  }
  ...
  **/
  ...
  public AutomationDelayProperty5 type(TypeEnum type) {
  ...
  **/
  ...
  public AutomationDelayProperty5 direction(DirectionEnum direction) {
  ...
  **/
  ...
  public AutomationDelayProperty5 action(ActionEnum action) {
  ...
  **/
   ...
   * @return the AutomationDelayProperty5 instance itself
   */
  public AutomationDelayProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationDelayProperty5 automationDelayProperty5 = (AutomationDelayProperty5) o;
    return Objects.equals(this.amount, automationDelayProperty5.amount) &&
        Objects.equals(this.type, automationDelayProperty5.type) &&
        Objects.equals(this.direction, automationDelayProperty5.direction) &&
        Objects.equals(this.action, automationDelayProperty5.action) &&
        Objects.equals(this.actionDescription, automationDelayProperty5.actionDescription) &&
        Objects.equals(this.fullDescription, automationDelayProperty5.fullDescription)&&
        Objects.equals(this.additionalProperties, automationDelayProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationDelayProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationDelayProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationDelayProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationDelayProperty5 is not found in the empty JSON string", AutomationDelayProperty5.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationDelayProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationDelayProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationDelayProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationDelayProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationDelayProperty5>() {
           @Override
           public void write(JsonWriter out, AutomationDelayProperty5 value) throws IOException {
           ...
           @Override
           public AutomationDelayProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationDelayProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationDelayProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationDelayProperty5
  * @throws IOException if the JSON string is invalid with respect to AutomationDelayProperty5
  */
  public static AutomationDelayProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationDelayProperty5.class);
  }

 /**
  * Convert an instance of AutomationDelayProperty5 to an JSON string
  *
  * @return JSON string
  */
