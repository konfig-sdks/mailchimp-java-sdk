...
public class EcommerceAddCartLineItemResponse {
  ...
  public EcommerceAddCartLineItemResponse() {
  }
  ...
  **/
  ...
  public EcommerceAddCartLineItemResponse productId(String productId) {
  ...
  **/
  ...
  public EcommerceAddCartLineItemResponse productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceAddCartLineItemResponse quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceAddCartLineItemResponse price(Double price) {
  ...
  public EcommerceAddCartLineItemResponse price(Integer price) {
  ...
  **/
   ...
   * @return the EcommerceAddCartLineItemResponse instance itself
   */
  public EcommerceAddCartLineItemResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceAddCartLineItemResponse ecommerceAddCartLineItemResponse = (EcommerceAddCartLineItemResponse) o;
    return Objects.equals(this.id, ecommerceAddCartLineItemResponse.id) &&
        Objects.equals(this.productId, ecommerceAddCartLineItemResponse.productId) &&
        Objects.equals(this.productTitle, ecommerceAddCartLineItemResponse.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceAddCartLineItemResponse.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceAddCartLineItemResponse.productVariantTitle) &&
        Objects.equals(this.quantity, ecommerceAddCartLineItemResponse.quantity) &&
        Objects.equals(this.price, ecommerceAddCartLineItemResponse.price) &&
        Objects.equals(this.links, ecommerceAddCartLineItemResponse.links)&&
        Objects.equals(this.additionalProperties, ecommerceAddCartLineItemResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceAddCartLineItemResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceAddCartLineItemResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceAddCartLineItemResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceAddCartLineItemResponse is not found in the empty JSON string", EcommerceAddCartLineItemResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceAddCartLineItemResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceAddCartLineItemResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceAddCartLineItemResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceAddCartLineItemResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceAddCartLineItemResponse>() {
           @Override
           public void write(JsonWriter out, EcommerceAddCartLineItemResponse value) throws IOException {
           ...
           @Override
           public EcommerceAddCartLineItemResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceAddCartLineItemResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceAddCartLineItemResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceAddCartLineItemResponse
  * @throws IOException if the JSON string is invalid with respect to EcommerceAddCartLineItemResponse
  */
  public static EcommerceAddCartLineItemResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceAddCartLineItemResponse.class);
  }

 /**
  * Convert an instance of EcommerceAddCartLineItemResponse to an JSON string
  *
  * @return JSON string
  */
