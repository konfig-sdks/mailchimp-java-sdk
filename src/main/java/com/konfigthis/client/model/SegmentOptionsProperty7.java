...
public class SegmentOptionsProperty7 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty7() {
  }

  public SegmentOptionsProperty7 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty7 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty7 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty7 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty7 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty7 instance itself
   */
  public SegmentOptionsProperty7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty7 segmentOptionsProperty7 = (SegmentOptionsProperty7) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty7.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty7.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty7.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty7.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty7.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty7 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty7 is not found in the empty JSON string", SegmentOptionsProperty7.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty7.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty7>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty7 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty7
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty7
  */
  public static SegmentOptionsProperty7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty7.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty7 to an JSON string
  *
  * @return JSON string
  */
