...
public class ECommerceProductImage2 {
  ...
  **/
   ...
   * @return the ECommerceProductImage2 instance itself
   */
  public ECommerceProductImage2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eCommerceProductImage2.id) &&
        ...
        Objects.equals(this.links, eCommerceProductImage2.links)&&
        Objects.equals(this.additionalProperties, eCommerceProductImage2.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceProductImage2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceProductImage2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceProductImage2 is not found in the empty JSON string", ECommerceProductImage2.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceProductImage2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceProductImage2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceProductImage2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceProductImage2.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceProductImage2>() {
           @Override
           public void write(JsonWriter out, ECommerceProductImage2 value) throws IOException {
           ...
           @Override
           public ECommerceProductImage2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceProductImage2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceProductImage2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceProductImage2
  * @throws IOException if the JSON string is invalid with respect to ECommerceProductImage2
  */
  public static ECommerceProductImage2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceProductImage2.class);
  }

 /**
  * Convert an instance of ECommerceProductImage2 to an JSON string
  *
  * @return JSON string
  */
