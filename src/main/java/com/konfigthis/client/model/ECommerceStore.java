...
import com.konfigthis.client.model.AddressProperty11;
import com.konfigthis.client.model.AutomationsProperty;
import com.konfigthis.client.model.ConnectedSiteProperty;
...
public class ECommerceStore {
  ...
  **/
  ...
  public ECommerceStore address(AddressProperty11 address) {
  ...
  **/
  ...
  public AddressProperty11 getAddress() {
    return address;
  }


  public void setAddress(AddressProperty11 address) {
  ...
  public ECommerceStore connectedSite(ConnectedSiteProperty connectedSite) {
  ...
  **/
  ...
  public ConnectedSiteProperty getConnectedSite() {
    return connectedSite;
  }


  public void setConnectedSite(ConnectedSiteProperty connectedSite) {
  ...
  public ECommerceStore automations(AutomationsProperty automations) {
  ...
  **/
  ...
  public AutomationsProperty getAutomations() {
    return automations;
  }


  public void setAutomations(AutomationsProperty automations) {
  ...
  **/
   ...
   * @return the ECommerceStore instance itself
   */
  public ECommerceStore putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eCommerceStore.id) &&
        ...
        Objects.equals(this.additionalProperties, eCommerceStore.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceStore
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceStore.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceStore is not found in the empty JSON string", ECommerceStore.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        AddressProperty11.validateJsonObject(jsonObj.getAsJsonObject("address"));
      }
      // validate the optional field `connected_site`
      if (jsonObj.get("connected_site") != null && !jsonObj.get("connected_site").isJsonNull()) {
        ConnectedSiteProperty.validateJsonObject(jsonObj.getAsJsonObject("connected_site"));
      }
      // validate the optional field `automations`
      if (jsonObj.get("automations") != null && !jsonObj.get("automations").isJsonNull()) {
        AutomationsProperty.validateJsonObject(jsonObj.getAsJsonObject("automations"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceStore.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceStore' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceStore> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceStore.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceStore>() {
           @Override
           public void write(JsonWriter out, ECommerceStore value) throws IOException {
           ...
           @Override
           public ECommerceStore read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceStore instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceStore given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceStore
  * @throws IOException if the JSON string is invalid with respect to ECommerceStore
  */
  public static ECommerceStore fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceStore.class);
  }

 /**
  * Convert an instance of ECommerceStore to an JSON string
  *
  * @return JSON string
  */
