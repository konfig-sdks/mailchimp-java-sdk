...
import com.konfigthis.client.model.Recipients;
...
public class FacebookAdsGetInfoResponse {
 ...
 public enum StatusEnum {
  ...
  public FacebookAdsGetInfoResponse() {
  }
  ...
  public FacebookAdsGetInfoResponse id(String id) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse webId(Integer webId) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse name(String name) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse type(TypeEnum type) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse status(StatusEnum status) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse showReport(Boolean showReport) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse createTime(OffsetDateTime createTime) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse startTime(OffsetDateTime startTime) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse canceledAt(OffsetDateTime canceledAt) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse publishedTime(OffsetDateTime publishedTime) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse hasSegment(Boolean hasSegment) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse reportSummary(ReportSummary reportSummary) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse recipients(Recipients recipients) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse thumbnail(String thumbnail) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse emailSourceName(String emailSourceName) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse pausedAt(OffsetDateTime pausedAt) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse endTime(OffsetDateTime endTime) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse needsAttention(Boolean needsAttention) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse wasCanceledByFacebook(Boolean wasCanceledByFacebook) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse isConnected(Boolean isConnected) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse hasAudience(Boolean hasAudience) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse hasContent(Boolean hasContent) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse channel(FacebookAdsGetInfoResponseAllOf2Channel channel) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse feedback(FacebookAdsGetInfoResponseAllOf2Feedback feedback) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse site(FacebookAdsGetInfoResponseAllOf2Site site) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse audience(FacebookAdsGetInfoResponseAllOf2Audience audience) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse budget(FacebookAdsGetInfoResponseAllOf2Budget budget) {
  ...
  **/
  ...
  public FacebookAdsGetInfoResponse content(FacebookAdsGetInfoResponseAllOf2Content content) {
  ...
  **/
   ...
   * @return the FacebookAdsGetInfoResponse instance itself
   */
  public FacebookAdsGetInfoResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    FacebookAdsGetInfoResponse facebookAdsGetInfoResponse = (FacebookAdsGetInfoResponse) o;
    return Objects.equals(this.id, facebookAdsGetInfoResponse.id) &&
        Objects.equals(this.webId, facebookAdsGetInfoResponse.webId) &&
        Objects.equals(this.name, facebookAdsGetInfoResponse.name) &&
        Objects.equals(this.type, facebookAdsGetInfoResponse.type) &&
        Objects.equals(this.status, facebookAdsGetInfoResponse.status) &&
        Objects.equals(this.showReport, facebookAdsGetInfoResponse.showReport) &&
        Objects.equals(this.createTime, facebookAdsGetInfoResponse.createTime) &&
        Objects.equals(this.startTime, facebookAdsGetInfoResponse.startTime) &&
        Objects.equals(this.updatedAt, facebookAdsGetInfoResponse.updatedAt) &&
        Objects.equals(this.canceledAt, facebookAdsGetInfoResponse.canceledAt) &&
        Objects.equals(this.publishedTime, facebookAdsGetInfoResponse.publishedTime) &&
        Objects.equals(this.hasSegment, facebookAdsGetInfoResponse.hasSegment) &&
        Objects.equals(this.reportSummary, facebookAdsGetInfoResponse.reportSummary) &&
        Objects.equals(this.recipients, facebookAdsGetInfoResponse.recipients) &&
        Objects.equals(this.thumbnail, facebookAdsGetInfoResponse.thumbnail) &&
        Objects.equals(this.emailSourceName, facebookAdsGetInfoResponse.emailSourceName) &&
        Objects.equals(this.pausedAt, facebookAdsGetInfoResponse.pausedAt) &&
        Objects.equals(this.endTime, facebookAdsGetInfoResponse.endTime) &&
        Objects.equals(this.needsAttention, facebookAdsGetInfoResponse.needsAttention) &&
        Objects.equals(this.wasCanceledByFacebook, facebookAdsGetInfoResponse.wasCanceledByFacebook) &&
        Objects.equals(this.isConnected, facebookAdsGetInfoResponse.isConnected) &&
        Objects.equals(this.hasAudience, facebookAdsGetInfoResponse.hasAudience) &&
        Objects.equals(this.hasContent, facebookAdsGetInfoResponse.hasContent) &&
        Objects.equals(this.channel, facebookAdsGetInfoResponse.channel) &&
        Objects.equals(this.feedback, facebookAdsGetInfoResponse.feedback) &&
        Objects.equals(this.site, facebookAdsGetInfoResponse.site) &&
        Objects.equals(this.audience, facebookAdsGetInfoResponse.audience) &&
        Objects.equals(this.budget, facebookAdsGetInfoResponse.budget) &&
        Objects.equals(this.content, facebookAdsGetInfoResponse.content) &&
        Objects.equals(this.links, facebookAdsGetInfoResponse.links)&&
        Objects.equals(this.additionalProperties, facebookAdsGetInfoResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class FacebookAdsGetInfoResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to FacebookAdsGetInfoResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!FacebookAdsGetInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in FacebookAdsGetInfoResponse is not found in the empty JSON string", FacebookAdsGetInfoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        Recipients.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!FacebookAdsGetInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'FacebookAdsGetInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<FacebookAdsGetInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(FacebookAdsGetInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<FacebookAdsGetInfoResponse>() {
           @Override
           public void write(JsonWriter out, FacebookAdsGetInfoResponse value) throws IOException {
           ...
           @Override
           public FacebookAdsGetInfoResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             FacebookAdsGetInfoResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of FacebookAdsGetInfoResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of FacebookAdsGetInfoResponse
  * @throws IOException if the JSON string is invalid with respect to FacebookAdsGetInfoResponse
  */
  public static FacebookAdsGetInfoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, FacebookAdsGetInfoResponse.class);
  }

 /**
  * Convert an instance of FacebookAdsGetInfoResponse to an JSON string
  *
  * @return JSON string
  */
