...
import com.konfigthis.client.model.SegmentOptionsProperty15;
...
public class ListProperty21 {
  ...
  private SegmentOptionsProperty15 segmentOpts;

  public ListProperty21() {
  }
  ...
  public ListProperty21 listId(String listId) {
  ...
  **/
  ...
  public ListProperty21 segmentOpts(SegmentOptionsProperty15 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty15 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty15 segmentOpts) {
   ...
   * @return the ListProperty21 instance itself
   */
  public ListProperty21 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty21 listProperty21 = (ListProperty21) o;
    return Objects.equals(this.listId, listProperty21.listId) &&
        Objects.equals(this.listIsActive, listProperty21.listIsActive) &&
        Objects.equals(this.listName, listProperty21.listName) &&
        Objects.equals(this.segmentText, listProperty21.segmentText) &&
        Objects.equals(this.recipientCount, listProperty21.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty21.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty21.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty21 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty21
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty21.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty21 is not found in the empty JSON string", ListProperty21.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty15.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty21.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty21' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty21> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty21.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty21>() {
           @Override
           public void write(JsonWriter out, ListProperty21 value) throws IOException {
           ...
           @Override
           public ListProperty21 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty21 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty21 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty21
  * @throws IOException if the JSON string is invalid with respect to ListProperty21
  */
  public static ListProperty21 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty21.class);
  }

 /**
  * Convert an instance of ListProperty21 to an JSON string
  *
  * @return JSON string
  */
