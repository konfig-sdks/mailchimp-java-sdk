...
public class SegmentOptionsProperty5 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty5() {
  }

  public SegmentOptionsProperty5 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty5 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty5 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty5 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty5 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty5 instance itself
   */
  public SegmentOptionsProperty5 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty5 segmentOptionsProperty5 = (SegmentOptionsProperty5) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty5.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty5.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty5.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty5.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty5.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty5 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty5
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty5.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty5 is not found in the empty JSON string", SegmentOptionsProperty5.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty5.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty5' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty5> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty5.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty5>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty5 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty5 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty5 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty5 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty5
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty5
  */
  public static SegmentOptionsProperty5 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty5.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty5 to an JSON string
  *
  * @return JSON string
  */
