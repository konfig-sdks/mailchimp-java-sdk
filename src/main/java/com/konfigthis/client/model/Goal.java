 ...
 */
@ApiModel(description = "A single instance of a goal activity.")@javax.annotation.Generated(value = "Generated by https://konfigthis.com")
public class Goal {
  ...
  public static final String SERIALIZED_NAME_LAST_VISITED_AT = "last_visited_at";
  ...
  **/
  ...
  @ApiModelProperty(value = "The id for a Goal event.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The name/type of Goal event triggered.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The date and time the user last triggered the Goal event in ISO 8601 format.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Any extra data passed with the Goal event.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(goalId, event, lastVisitedAt, data, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("last_visited_at");
