...
public class SegmentOptionsProperty21 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty21() {
  }

  public SegmentOptionsProperty21 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty21 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty21 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty21 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty21 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty21 instance itself
   */
  public SegmentOptionsProperty21 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty21 segmentOptionsProperty21 = (SegmentOptionsProperty21) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty21.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty21.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty21.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty21.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty21.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty21 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty21
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty21.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty21 is not found in the empty JSON string", SegmentOptionsProperty21.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty21.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty21' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty21> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty21.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty21>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty21 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty21 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty21 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty21 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty21
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty21
  */
  public static SegmentOptionsProperty21 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty21.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty21 to an JSON string
  *
  * @return JSON string
  */
