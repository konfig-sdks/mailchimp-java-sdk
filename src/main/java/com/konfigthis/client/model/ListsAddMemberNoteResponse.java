...
public class ListsAddMemberNoteResponse {
  ...
  public ListsAddMemberNoteResponse() {
  }
  ...
  **/
  ...
  public ListsAddMemberNoteResponse note(String note) {
  ...
  **/
   ...
   * @return the ListsAddMemberNoteResponse instance itself
   */
  public ListsAddMemberNoteResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListsAddMemberNoteResponse listsAddMemberNoteResponse = (ListsAddMemberNoteResponse) o;
    return Objects.equals(this.id, listsAddMemberNoteResponse.id) &&
        Objects.equals(this.createdAt, listsAddMemberNoteResponse.createdAt) &&
        Objects.equals(this.createdBy, listsAddMemberNoteResponse.createdBy) &&
        Objects.equals(this.updatedAt, listsAddMemberNoteResponse.updatedAt) &&
        Objects.equals(this.note, listsAddMemberNoteResponse.note) &&
        Objects.equals(this.listId, listsAddMemberNoteResponse.listId) &&
        Objects.equals(this.emailId, listsAddMemberNoteResponse.emailId) &&
        Objects.equals(this.contactId, listsAddMemberNoteResponse.contactId) &&
        Objects.equals(this.links, listsAddMemberNoteResponse.links)&&
        Objects.equals(this.additionalProperties, listsAddMemberNoteResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListsAddMemberNoteResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListsAddMemberNoteResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListsAddMemberNoteResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListsAddMemberNoteResponse is not found in the empty JSON string", ListsAddMemberNoteResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListsAddMemberNoteResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListsAddMemberNoteResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListsAddMemberNoteResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListsAddMemberNoteResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<ListsAddMemberNoteResponse>() {
           @Override
           public void write(JsonWriter out, ListsAddMemberNoteResponse value) throws IOException {
           ...
           @Override
           public ListsAddMemberNoteResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListsAddMemberNoteResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListsAddMemberNoteResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListsAddMemberNoteResponse
  * @throws IOException if the JSON string is invalid with respect to ListsAddMemberNoteResponse
  */
  public static ListsAddMemberNoteResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListsAddMemberNoteResponse.class);
  }

 /**
  * Convert an instance of ListsAddMemberNoteResponse to an JSON string
  *
  * @return JSON string
  */
