...
public class SegmentOptionsProperty10 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty10() {
  }

  public SegmentOptionsProperty10 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty10 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty10 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty10 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty10 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty10 instance itself
   */
  public SegmentOptionsProperty10 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty10 segmentOptionsProperty10 = (SegmentOptionsProperty10) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty10.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty10.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty10.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty10.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty10.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty10 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty10
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty10.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty10 is not found in the empty JSON string", SegmentOptionsProperty10.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty10.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty10' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty10> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty10.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty10>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty10 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty10 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty10 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty10 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty10
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty10
  */
  public static SegmentOptionsProperty10 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty10.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty10 to an JSON string
  *
  * @return JSON string
  */
