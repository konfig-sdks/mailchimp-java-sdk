...
public class SegmentOptionsProperty6 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty6() {
  }

  public SegmentOptionsProperty6 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty6 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty6 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty6 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty6 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty6 instance itself
   */
  public SegmentOptionsProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty6 segmentOptionsProperty6 = (SegmentOptionsProperty6) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty6.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty6.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty6.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty6.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty6 is not found in the empty JSON string", SegmentOptionsProperty6.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty6>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty6 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty6
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty6
  */
  public static SegmentOptionsProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty6.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty6 to an JSON string
  *
  * @return JSON string
  */
