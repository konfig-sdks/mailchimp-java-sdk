...
public class CampaignSettingsProperty1 {
  ...
  public CampaignSettingsProperty1() {
  }

  public CampaignSettingsProperty1 title(String title) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 subjectLine(String subjectLine) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 previewText(String previewText) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 fromName(String fromName) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 replyTo(String replyTo) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The reply-to email address for the campaign. Note: while this field is not required for campaign creation, it is required for sending.")
  ...
  public CampaignSettingsProperty1 useConversation(Boolean useConversation) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 toName(String toName) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 folderId(String folderId) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 authenticate(Boolean authenticate) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 autoFooter(Boolean autoFooter) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 inlineCss(Boolean inlineCss) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 autoTweet(Boolean autoTweet) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 autoFbPost(List<String> autoFbPost) {
  ...
  public CampaignSettingsProperty1 addAutoFbPostItem(String autoFbPostItem) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 fbComments(Boolean fbComments) {
  ...
  **/
  ...
  public CampaignSettingsProperty1 templateId(Integer templateId) {
  ...
  **/
   ...
   * @return the CampaignSettingsProperty1 instance itself
   */
  public CampaignSettingsProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignSettingsProperty1 campaignSettingsProperty1 = (CampaignSettingsProperty1) o;
    return Objects.equals(this.title, campaignSettingsProperty1.title) &&
        Objects.equals(this.subjectLine, campaignSettingsProperty1.subjectLine) &&
        Objects.equals(this.previewText, campaignSettingsProperty1.previewText) &&
        Objects.equals(this.fromName, campaignSettingsProperty1.fromName) &&
        Objects.equals(this.replyTo, campaignSettingsProperty1.replyTo) &&
        Objects.equals(this.useConversation, campaignSettingsProperty1.useConversation) &&
        Objects.equals(this.toName, campaignSettingsProperty1.toName) &&
        Objects.equals(this.folderId, campaignSettingsProperty1.folderId) &&
        Objects.equals(this.authenticate, campaignSettingsProperty1.authenticate) &&
        Objects.equals(this.autoFooter, campaignSettingsProperty1.autoFooter) &&
        Objects.equals(this.inlineCss, campaignSettingsProperty1.inlineCss) &&
        Objects.equals(this.autoTweet, campaignSettingsProperty1.autoTweet) &&
        Objects.equals(this.autoFbPost, campaignSettingsProperty1.autoFbPost) &&
        Objects.equals(this.fbComments, campaignSettingsProperty1.fbComments) &&
        Objects.equals(this.templateId, campaignSettingsProperty1.templateId)&&
        Objects.equals(this.additionalProperties, campaignSettingsProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignSettingsProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignSettingsProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignSettingsProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignSettingsProperty1 is not found in the empty JSON string", CampaignSettingsProperty1.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignSettingsProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignSettingsProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignSettingsProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignSettingsProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignSettingsProperty1>() {
           @Override
           public void write(JsonWriter out, CampaignSettingsProperty1 value) throws IOException {
           ...
           @Override
           public CampaignSettingsProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignSettingsProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignSettingsProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignSettingsProperty1
  * @throws IOException if the JSON string is invalid with respect to CampaignSettingsProperty1
  */
  public static CampaignSettingsProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignSettingsProperty1.class);
  }

 /**
  * Convert an instance of CampaignSettingsProperty1 to an JSON string
  *
  * @return JSON string
  */
