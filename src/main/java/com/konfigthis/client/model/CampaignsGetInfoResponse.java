...
import com.konfigthis.client.model.ListProperty19;
...
public class CampaignsGetInfoResponse {
 ...
 public enum ContentTypeEnum {
  ...
  private ListProperty19 recipients;
  ...
  public CampaignsGetInfoResponse() {
  }
  ...
  **/
  ...
  public CampaignsGetInfoResponse type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse contentType(ContentTypeEnum contentType) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse recipients(ListProperty19 recipients) {
  ...
  **/
  ...
  public ListProperty19 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty19 recipients) {
  ...
  public CampaignsGetInfoResponse settings(CampaignSettingsProperty4 settings) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse variateSettings(ABTestOptionsProperty1 variateSettings) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse rssOpts(RSSOptionsProperty2 rssOpts) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse reportSummary(CampaignReportSummaryProperty2 reportSummary) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
  ...
  public CampaignsGetInfoResponse resendShortcutEligibility(ResendShortcutEligibilityProperty resendShortcutEligibility) {
  ...
  **/
   ...
   * @return the CampaignsGetInfoResponse instance itself
   */
  public CampaignsGetInfoResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsGetInfoResponse campaignsGetInfoResponse = (CampaignsGetInfoResponse) o;
    return Objects.equals(this.id, campaignsGetInfoResponse.id) &&
        Objects.equals(this.webId, campaignsGetInfoResponse.webId) &&
        Objects.equals(this.parentCampaignId, campaignsGetInfoResponse.parentCampaignId) &&
        Objects.equals(this.type, campaignsGetInfoResponse.type) &&
        Objects.equals(this.createTime, campaignsGetInfoResponse.createTime) &&
        Objects.equals(this.archiveUrl, campaignsGetInfoResponse.archiveUrl) &&
        Objects.equals(this.longArchiveUrl, campaignsGetInfoResponse.longArchiveUrl) &&
        Objects.equals(this.status, campaignsGetInfoResponse.status) &&
        Objects.equals(this.emailsSent, campaignsGetInfoResponse.emailsSent) &&
        Objects.equals(this.sendTime, campaignsGetInfoResponse.sendTime) &&
        Objects.equals(this.contentType, campaignsGetInfoResponse.contentType) &&
        Objects.equals(this.needsBlockRefresh, campaignsGetInfoResponse.needsBlockRefresh) &&
        Objects.equals(this.resendable, campaignsGetInfoResponse.resendable) &&
        Objects.equals(this.recipients, campaignsGetInfoResponse.recipients) &&
        Objects.equals(this.settings, campaignsGetInfoResponse.settings) &&
        Objects.equals(this.variateSettings, campaignsGetInfoResponse.variateSettings) &&
        Objects.equals(this.tracking, campaignsGetInfoResponse.tracking) &&
        Objects.equals(this.rssOpts, campaignsGetInfoResponse.rssOpts) &&
        Objects.equals(this.abSplitOpts, campaignsGetInfoResponse.abSplitOpts) &&
        Objects.equals(this.socialCard, campaignsGetInfoResponse.socialCard) &&
        Objects.equals(this.reportSummary, campaignsGetInfoResponse.reportSummary) &&
        Objects.equals(this.deliveryStatus, campaignsGetInfoResponse.deliveryStatus) &&
        Objects.equals(this.resendShortcutEligibility, campaignsGetInfoResponse.resendShortcutEligibility) &&
        Objects.equals(this.links, campaignsGetInfoResponse.links)&&
        Objects.equals(this.additionalProperties, campaignsGetInfoResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsGetInfoResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsGetInfoResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsGetInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsGetInfoResponse is not found in the empty JSON string", CampaignsGetInfoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty19.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsGetInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsGetInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsGetInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsGetInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsGetInfoResponse>() {
           @Override
           public void write(JsonWriter out, CampaignsGetInfoResponse value) throws IOException {
           ...
           @Override
           public CampaignsGetInfoResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsGetInfoResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsGetInfoResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsGetInfoResponse
  * @throws IOException if the JSON string is invalid with respect to CampaignsGetInfoResponse
  */
  public static CampaignsGetInfoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsGetInfoResponse.class);
  }

 /**
  * Convert an instance of CampaignsGetInfoResponse to an JSON string
  *
  * @return JSON string
  */
