...
public class CampaignTrackingOptionsProperty1 {
  ...
  private CapsuleCRMTrackingProperty2 capsule;

  public CampaignTrackingOptionsProperty1() {
  }

  public CampaignTrackingOptionsProperty1 opens(Boolean opens) {
  ...
  **/
  ...
  public CampaignTrackingOptionsProperty1 htmlClicks(Boolean htmlClicks) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to [track clicks](https://mailchimp.com/help/enable-and-view-click-tracking/) in the HTML version of the campaign. Defaults to `true`.")
  ...
  public CampaignTrackingOptionsProperty1 textClicks(Boolean textClicks) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Whether to [track clicks](https://mailchimp.com/help/enable-and-view-click-tracking/) in the plain-text version of the campaign. Defaults to `true`.")
  ...
  public CampaignTrackingOptionsProperty1 goalTracking(Boolean goalTracking) {
  ...
  **/
  ...
  public CampaignTrackingOptionsProperty1 ecomm360(Boolean ecomm360) {
  ...
  **/
  ...
  public CampaignTrackingOptionsProperty1 googleAnalytics(String googleAnalytics) {
  ...
  **/
  ...
  public CampaignTrackingOptionsProperty1 clicktale(String clicktale) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The custom slug for [Click Tale](https://mailchimp.com/help/additional-tracking-options-for-campaigns/) tracking (max of 50 bytes).")
  ...
  public CampaignTrackingOptionsProperty1 salesforce(SalesforceCRMTrackingProperty1 salesforce) {
  ...
  **/
  ...
  public CampaignTrackingOptionsProperty1 capsule(CapsuleCRMTrackingProperty2 capsule) {
  ...
  **/
  ...
  public CapsuleCRMTrackingProperty2 getCapsule() {
    return capsule;
  }


  public void setCapsule(CapsuleCRMTrackingProperty2 capsule) {
   ...
   * @return the CampaignTrackingOptionsProperty1 instance itself
   */
  public CampaignTrackingOptionsProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignTrackingOptionsProperty1 campaignTrackingOptionsProperty1 = (CampaignTrackingOptionsProperty1) o;
    return Objects.equals(this.opens, campaignTrackingOptionsProperty1.opens) &&
        Objects.equals(this.htmlClicks, campaignTrackingOptionsProperty1.htmlClicks) &&
        Objects.equals(this.textClicks, campaignTrackingOptionsProperty1.textClicks) &&
        Objects.equals(this.goalTracking, campaignTrackingOptionsProperty1.goalTracking) &&
        Objects.equals(this.ecomm360, campaignTrackingOptionsProperty1.ecomm360) &&
        Objects.equals(this.googleAnalytics, campaignTrackingOptionsProperty1.googleAnalytics) &&
        Objects.equals(this.clicktale, campaignTrackingOptionsProperty1.clicktale) &&
        Objects.equals(this.salesforce, campaignTrackingOptionsProperty1.salesforce) &&
        Objects.equals(this.capsule, campaignTrackingOptionsProperty1.capsule)&&
        Objects.equals(this.additionalProperties, campaignTrackingOptionsProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignTrackingOptionsProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignTrackingOptionsProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignTrackingOptionsProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignTrackingOptionsProperty1 is not found in the empty JSON string", CampaignTrackingOptionsProperty1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("capsule") != null && !jsonObj.get("capsule").isJsonNull()) {
        CapsuleCRMTrackingProperty2.validateJsonObject(jsonObj.getAsJsonObject("capsule"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignTrackingOptionsProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignTrackingOptionsProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignTrackingOptionsProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignTrackingOptionsProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignTrackingOptionsProperty1>() {
           @Override
           public void write(JsonWriter out, CampaignTrackingOptionsProperty1 value) throws IOException {
           ...
           @Override
           public CampaignTrackingOptionsProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignTrackingOptionsProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignTrackingOptionsProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignTrackingOptionsProperty1
  * @throws IOException if the JSON string is invalid with respect to CampaignTrackingOptionsProperty1
  */
  public static CampaignTrackingOptionsProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignTrackingOptionsProperty1.class);
  }

 /**
  * Convert an instance of CampaignTrackingOptionsProperty1 to an JSON string
  *
  * @return JSON string
  */
