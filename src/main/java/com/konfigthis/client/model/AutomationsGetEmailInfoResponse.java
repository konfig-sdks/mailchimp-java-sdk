...
import com.konfigthis.client.model.AutomationDelayProperty3;
...
import com.konfigthis.client.model.ListProperty11;
...
public class AutomationsGetEmailInfoResponse {
  ...
  private AutomationDelayProperty3 delay;
 ...
 public enum StatusEnum {
  ...
  private ListProperty11 recipients;
  ...
  public AutomationsGetEmailInfoResponse() {
  }
  ...
  **/
  ...
  public AutomationsGetEmailInfoResponse delay(AutomationDelayProperty3 delay) {
  ...
  **/
  ...
  public AutomationDelayProperty3 getDelay() {
    return delay;
  }


  public void setDelay(AutomationDelayProperty3 delay) {
  ...
  **/
  ...
  public AutomationsGetEmailInfoResponse recipients(ListProperty11 recipients) {
  ...
  **/
  ...
  public ListProperty11 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty11 recipients) {
  ...
  public AutomationsGetEmailInfoResponse settings(CampaignSettingsProperty3 settings) {
  ...
  **/
  ...
  public AutomationsGetEmailInfoResponse tracking(CampaignTrackingOptionsProperty1 tracking) {
  ...
  **/
  ...
  public AutomationsGetEmailInfoResponse socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public AutomationsGetEmailInfoResponse triggerSettings(AutomationTriggerProperty1 triggerSettings) {
  ...
  **/
  ...
  public AutomationsGetEmailInfoResponse reportSummary(CampaignReportSummaryProperty1 reportSummary) {
  ...
  **/
   ...
   * @return the AutomationsGetEmailInfoResponse instance itself
   */
  public AutomationsGetEmailInfoResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationsGetEmailInfoResponse automationsGetEmailInfoResponse = (AutomationsGetEmailInfoResponse) o;
    return Objects.equals(this.id, automationsGetEmailInfoResponse.id) &&
        Objects.equals(this.webId, automationsGetEmailInfoResponse.webId) &&
        Objects.equals(this.workflowId, automationsGetEmailInfoResponse.workflowId) &&
        Objects.equals(this.position, automationsGetEmailInfoResponse.position) &&
        Objects.equals(this.delay, automationsGetEmailInfoResponse.delay) &&
        Objects.equals(this.createTime, automationsGetEmailInfoResponse.createTime) &&
        Objects.equals(this.startTime, automationsGetEmailInfoResponse.startTime) &&
        Objects.equals(this.archiveUrl, automationsGetEmailInfoResponse.archiveUrl) &&
        Objects.equals(this.status, automationsGetEmailInfoResponse.status) &&
        Objects.equals(this.emailsSent, automationsGetEmailInfoResponse.emailsSent) &&
        Objects.equals(this.sendTime, automationsGetEmailInfoResponse.sendTime) &&
        Objects.equals(this.contentType, automationsGetEmailInfoResponse.contentType) &&
        Objects.equals(this.needsBlockRefresh, automationsGetEmailInfoResponse.needsBlockRefresh) &&
        Objects.equals(this.hasLogoMergeTag, automationsGetEmailInfoResponse.hasLogoMergeTag) &&
        Objects.equals(this.recipients, automationsGetEmailInfoResponse.recipients) &&
        Objects.equals(this.settings, automationsGetEmailInfoResponse.settings) &&
        Objects.equals(this.tracking, automationsGetEmailInfoResponse.tracking) &&
        Objects.equals(this.socialCard, automationsGetEmailInfoResponse.socialCard) &&
        Objects.equals(this.triggerSettings, automationsGetEmailInfoResponse.triggerSettings) &&
        Objects.equals(this.reportSummary, automationsGetEmailInfoResponse.reportSummary) &&
        Objects.equals(this.links, automationsGetEmailInfoResponse.links)&&
        Objects.equals(this.additionalProperties, automationsGetEmailInfoResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationsGetEmailInfoResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationsGetEmailInfoResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationsGetEmailInfoResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationsGetEmailInfoResponse is not found in the empty JSON string", AutomationsGetEmailInfoResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("delay") != null && !jsonObj.get("delay").isJsonNull()) {
        AutomationDelayProperty3.validateJsonObject(jsonObj.getAsJsonObject("delay"));
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty11.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationsGetEmailInfoResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationsGetEmailInfoResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationsGetEmailInfoResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationsGetEmailInfoResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationsGetEmailInfoResponse>() {
           @Override
           public void write(JsonWriter out, AutomationsGetEmailInfoResponse value) throws IOException {
           ...
           @Override
           public AutomationsGetEmailInfoResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationsGetEmailInfoResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationsGetEmailInfoResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationsGetEmailInfoResponse
  * @throws IOException if the JSON string is invalid with respect to AutomationsGetEmailInfoResponse
  */
  public static AutomationsGetEmailInfoResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationsGetEmailInfoResponse.class);
  }

 /**
  * Convert an instance of AutomationsGetEmailInfoResponse to an JSON string
  *
  * @return JSON string
  */
