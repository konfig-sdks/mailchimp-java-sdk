...
import com.konfigthis.client.model.AddressProperty12;
import com.konfigthis.client.model.AutomationsProperty1;
import com.konfigthis.client.model.ConnectedSiteProperty1;
...
public class ECommerceStore1 {
  ...
  **/
  ...
  public ECommerceStore1 address(AddressProperty12 address) {
  ...
  **/
  ...
  public AddressProperty12 getAddress() {
    return address;
  }


  public void setAddress(AddressProperty12 address) {
  ...
  public ECommerceStore1 connectedSite(ConnectedSiteProperty1 connectedSite) {
  ...
  **/
  ...
  public ConnectedSiteProperty1 getConnectedSite() {
    return connectedSite;
  }


  public void setConnectedSite(ConnectedSiteProperty1 connectedSite) {
  ...
  public ECommerceStore1 automations(AutomationsProperty1 automations) {
  ...
  **/
  ...
  public AutomationsProperty1 getAutomations() {
    return automations;
  }


  public void setAutomations(AutomationsProperty1 automations) {
  ...
  **/
   ...
   * @return the ECommerceStore1 instance itself
   */
  public ECommerceStore1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, eCommerceStore1.id) &&
        ...
        Objects.equals(this.links, eCommerceStore1.links)&&
        Objects.equals(this.additionalProperties, eCommerceStore1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceStore1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceStore1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceStore1 is not found in the empty JSON string", ECommerceStore1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("address") != null && !jsonObj.get("address").isJsonNull()) {
        AddressProperty12.validateJsonObject(jsonObj.getAsJsonObject("address"));
      }
      // validate the optional field `connected_site`
      if (jsonObj.get("connected_site") != null && !jsonObj.get("connected_site").isJsonNull()) {
        ConnectedSiteProperty1.validateJsonObject(jsonObj.getAsJsonObject("connected_site"));
      }
      // validate the optional field `automations`
      if (jsonObj.get("automations") != null && !jsonObj.get("automations").isJsonNull()) {
        AutomationsProperty1.validateJsonObject(jsonObj.getAsJsonObject("automations"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceStore1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceStore1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceStore1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceStore1.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceStore1>() {
           @Override
           public void write(JsonWriter out, ECommerceStore1 value) throws IOException {
           ...
           @Override
           public ECommerceStore1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceStore1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceStore1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceStore1
  * @throws IOException if the JSON string is invalid with respect to ECommerceStore1
  */
  public static ECommerceStore1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceStore1.class);
  }

 /**
  * Convert an instance of ECommerceStore1 to an JSON string
  *
  * @return JSON string
  */
