...
public class SegmentOptionsProperty14 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty14() {
  }

  public SegmentOptionsProperty14 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty14 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty14 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty14 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty14 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty14 instance itself
   */
  public SegmentOptionsProperty14 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty14 segmentOptionsProperty14 = (SegmentOptionsProperty14) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty14.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty14.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty14.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty14.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty14.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty14 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty14
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty14.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty14 is not found in the empty JSON string", SegmentOptionsProperty14.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty14.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty14' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty14> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty14.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty14>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty14 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty14 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty14 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty14 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty14
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty14
  */
  public static SegmentOptionsProperty14 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty14.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty14 to an JSON string
  *
  * @return JSON string
  */
