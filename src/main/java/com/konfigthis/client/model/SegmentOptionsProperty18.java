...
public class SegmentOptionsProperty18 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty18() {
  }

  public SegmentOptionsProperty18 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty18 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty18 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty18 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty18 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty18 instance itself
   */
  public SegmentOptionsProperty18 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty18 segmentOptionsProperty18 = (SegmentOptionsProperty18) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty18.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty18.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty18.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty18.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty18.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty18 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty18
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty18.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty18 is not found in the empty JSON string", SegmentOptionsProperty18.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty18.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty18' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty18> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty18.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty18>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty18 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty18 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty18 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty18 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty18
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty18
  */
  public static SegmentOptionsProperty18 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty18.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty18 to an JSON string
  *
  * @return JSON string
  */
