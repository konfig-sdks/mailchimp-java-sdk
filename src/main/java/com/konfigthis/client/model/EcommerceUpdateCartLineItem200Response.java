...
public class EcommerceUpdateCartLineItem200Response {
  ...
  public EcommerceUpdateCartLineItem200Response() {
  }
  ...
  **/
  ...
  public EcommerceUpdateCartLineItem200Response productId(String productId) {
  ...
  **/
  ...
  public EcommerceUpdateCartLineItem200Response productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceUpdateCartLineItem200Response quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceUpdateCartLineItem200Response price(Double price) {
  ...
  public EcommerceUpdateCartLineItem200Response price(Integer price) {
  ...
  **/
   ...
   * @return the EcommerceUpdateCartLineItem200Response instance itself
   */
  public EcommerceUpdateCartLineItem200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceUpdateCartLineItem200Response ecommerceUpdateCartLineItem200Response = (EcommerceUpdateCartLineItem200Response) o;
    return Objects.equals(this.id, ecommerceUpdateCartLineItem200Response.id) &&
        Objects.equals(this.productId, ecommerceUpdateCartLineItem200Response.productId) &&
        Objects.equals(this.productTitle, ecommerceUpdateCartLineItem200Response.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceUpdateCartLineItem200Response.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceUpdateCartLineItem200Response.productVariantTitle) &&
        Objects.equals(this.quantity, ecommerceUpdateCartLineItem200Response.quantity) &&
        Objects.equals(this.price, ecommerceUpdateCartLineItem200Response.price) &&
        Objects.equals(this.links, ecommerceUpdateCartLineItem200Response.links)&&
        Objects.equals(this.additionalProperties, ecommerceUpdateCartLineItem200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceUpdateCartLineItem200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceUpdateCartLineItem200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceUpdateCartLineItem200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceUpdateCartLineItem200Response is not found in the empty JSON string", EcommerceUpdateCartLineItem200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceUpdateCartLineItem200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceUpdateCartLineItem200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceUpdateCartLineItem200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceUpdateCartLineItem200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceUpdateCartLineItem200Response>() {
           @Override
           public void write(JsonWriter out, EcommerceUpdateCartLineItem200Response value) throws IOException {
           ...
           @Override
           public EcommerceUpdateCartLineItem200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceUpdateCartLineItem200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceUpdateCartLineItem200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceUpdateCartLineItem200Response
  * @throws IOException if the JSON string is invalid with respect to EcommerceUpdateCartLineItem200Response
  */
  public static EcommerceUpdateCartLineItem200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceUpdateCartLineItem200Response.class);
  }

 /**
  * Convert an instance of EcommerceUpdateCartLineItem200Response to an JSON string
  *
  * @return JSON string
  */
