...
import com.konfigthis.client.model.ListProperty21;
...
public class CampaignsUpdateSettingsResponse {
 ...
 public enum ContentTypeEnum {
  ...
  private ListProperty21 recipients;
  ...
  public CampaignsUpdateSettingsResponse() {
  }
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse type(TypeEnum type) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse contentType(ContentTypeEnum contentType) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse recipients(ListProperty21 recipients) {
  ...
  **/
  ...
  public ListProperty21 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty21 recipients) {
  ...
  public CampaignsUpdateSettingsResponse settings(CampaignSettingsProperty4 settings) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse variateSettings(ABTestOptionsProperty1 variateSettings) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse rssOpts(RSSOptionsProperty2 rssOpts) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse reportSummary(CampaignReportSummaryProperty2 reportSummary) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
  ...
  public CampaignsUpdateSettingsResponse resendShortcutEligibility(ResendShortcutEligibilityProperty resendShortcutEligibility) {
  ...
  **/
   ...
   * @return the CampaignsUpdateSettingsResponse instance itself
   */
  public CampaignsUpdateSettingsResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsUpdateSettingsResponse campaignsUpdateSettingsResponse = (CampaignsUpdateSettingsResponse) o;
    return Objects.equals(this.id, campaignsUpdateSettingsResponse.id) &&
        Objects.equals(this.webId, campaignsUpdateSettingsResponse.webId) &&
        Objects.equals(this.parentCampaignId, campaignsUpdateSettingsResponse.parentCampaignId) &&
        Objects.equals(this.type, campaignsUpdateSettingsResponse.type) &&
        Objects.equals(this.createTime, campaignsUpdateSettingsResponse.createTime) &&
        Objects.equals(this.archiveUrl, campaignsUpdateSettingsResponse.archiveUrl) &&
        Objects.equals(this.longArchiveUrl, campaignsUpdateSettingsResponse.longArchiveUrl) &&
        Objects.equals(this.status, campaignsUpdateSettingsResponse.status) &&
        Objects.equals(this.emailsSent, campaignsUpdateSettingsResponse.emailsSent) &&
        Objects.equals(this.sendTime, campaignsUpdateSettingsResponse.sendTime) &&
        Objects.equals(this.contentType, campaignsUpdateSettingsResponse.contentType) &&
        Objects.equals(this.needsBlockRefresh, campaignsUpdateSettingsResponse.needsBlockRefresh) &&
        Objects.equals(this.resendable, campaignsUpdateSettingsResponse.resendable) &&
        Objects.equals(this.recipients, campaignsUpdateSettingsResponse.recipients) &&
        Objects.equals(this.settings, campaignsUpdateSettingsResponse.settings) &&
        Objects.equals(this.variateSettings, campaignsUpdateSettingsResponse.variateSettings) &&
        Objects.equals(this.tracking, campaignsUpdateSettingsResponse.tracking) &&
        Objects.equals(this.rssOpts, campaignsUpdateSettingsResponse.rssOpts) &&
        Objects.equals(this.abSplitOpts, campaignsUpdateSettingsResponse.abSplitOpts) &&
        Objects.equals(this.socialCard, campaignsUpdateSettingsResponse.socialCard) &&
        Objects.equals(this.reportSummary, campaignsUpdateSettingsResponse.reportSummary) &&
        Objects.equals(this.deliveryStatus, campaignsUpdateSettingsResponse.deliveryStatus) &&
        Objects.equals(this.resendShortcutEligibility, campaignsUpdateSettingsResponse.resendShortcutEligibility) &&
        Objects.equals(this.links, campaignsUpdateSettingsResponse.links)&&
        Objects.equals(this.additionalProperties, campaignsUpdateSettingsResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class CampaignsUpdateSettingsResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsUpdateSettingsResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsUpdateSettingsResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsUpdateSettingsResponse is not found in the empty JSON string", CampaignsUpdateSettingsResponse.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty21.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsUpdateSettingsResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsUpdateSettingsResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsUpdateSettingsResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsUpdateSettingsResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsUpdateSettingsResponse>() {
           @Override
           public void write(JsonWriter out, CampaignsUpdateSettingsResponse value) throws IOException {
           ...
           @Override
           public CampaignsUpdateSettingsResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsUpdateSettingsResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsUpdateSettingsResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsUpdateSettingsResponse
  * @throws IOException if the JSON string is invalid with respect to CampaignsUpdateSettingsResponse
  */
  public static CampaignsUpdateSettingsResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsUpdateSettingsResponse.class);
  }

 /**
  * Convert an instance of CampaignsUpdateSettingsResponse to an JSON string
  *
  * @return JSON string
  */
