...
public class Operations {
  ...
  **/
  ...
  @ApiModelProperty(example = "POST", required = true, value = "The HTTP method to use for the operation.")
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "/lists", required = true, value = "The relative path to use for the operation.")
  ...
  **/
  ...
  @ApiModelProperty(example = "{\"count\":10,\"offset\":0}", value = "Any request query parameters. Example parameters: {\"count\":10, \"offset\":0}")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "{\"title\":\"Test\"}", value = "A string containing the JSON body to use with the request.")
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(example = "my-id-123", value = "An optional client-supplied id returned with the operation results.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(method, path, params, body, operationId, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Operations.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
