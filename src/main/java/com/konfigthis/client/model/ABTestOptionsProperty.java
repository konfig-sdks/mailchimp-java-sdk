...
public class ABTestOptionsProperty {
  /**
 ...
 public enum WinnerCriteriaEnum {
  ...
  public ABTestOptionsProperty() {
  }

  public ABTestOptionsProperty winnerCriteria(WinnerCriteriaEnum winnerCriteria) {
  ...
  **/
  ...
  public ABTestOptionsProperty waitTime(Integer waitTime) {
  ...
  **/
  ...
  public ABTestOptionsProperty testSize(Integer testSize) {
  ...
  **/
  ...
  public ABTestOptionsProperty subjectLines(List<String> subjectLines) {
  ...
  public ABTestOptionsProperty addSubjectLinesItem(String subjectLinesItem) {
  ...
  **/
  ...
  public ABTestOptionsProperty sendTimes(List<OffsetDateTime> sendTimes) {
  ...
  public ABTestOptionsProperty addSendTimesItem(OffsetDateTime sendTimesItem) {
  ...
  **/
  ...
  public ABTestOptionsProperty fromNames(List<String> fromNames) {
  ...
  public ABTestOptionsProperty addFromNamesItem(String fromNamesItem) {
  ...
  **/
  ...
  public ABTestOptionsProperty replyToAddresses(List<String> replyToAddresses) {
  ...
  public ABTestOptionsProperty addReplyToAddressesItem(String replyToAddressesItem) {
  ...
  **/
   ...
   * @return the ABTestOptionsProperty instance itself
   */
  public ABTestOptionsProperty putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ABTestOptionsProperty aBTestOptionsProperty = (ABTestOptionsProperty) o;
    return Objects.equals(this.winnerCriteria, aBTestOptionsProperty.winnerCriteria) &&
        Objects.equals(this.waitTime, aBTestOptionsProperty.waitTime) &&
        Objects.equals(this.testSize, aBTestOptionsProperty.testSize) &&
        Objects.equals(this.subjectLines, aBTestOptionsProperty.subjectLines) &&
        Objects.equals(this.sendTimes, aBTestOptionsProperty.sendTimes) &&
        Objects.equals(this.fromNames, aBTestOptionsProperty.fromNames) &&
        Objects.equals(this.replyToAddresses, aBTestOptionsProperty.replyToAddresses)&&
        Objects.equals(this.additionalProperties, aBTestOptionsProperty.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(winnerCriteria, waitTime, testSize, subjectLines, sendTimes, fromNames, replyToAddresses, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ABTestOptionsProperty {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ABTestOptionsProperty
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ABTestOptionsProperty.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ABTestOptionsProperty is not found in the empty JSON string", ABTestOptionsProperty.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ABTestOptionsProperty.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ABTestOptionsProperty.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ABTestOptionsProperty' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ABTestOptionsProperty> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ABTestOptionsProperty.class));

       return (TypeAdapter<T>) new TypeAdapter<ABTestOptionsProperty>() {
           @Override
           public void write(JsonWriter out, ABTestOptionsProperty value) throws IOException {
           ...
           @Override
           public ABTestOptionsProperty read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ABTestOptionsProperty instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ABTestOptionsProperty given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ABTestOptionsProperty
  * @throws IOException if the JSON string is invalid with respect to ABTestOptionsProperty
  */
  public static ABTestOptionsProperty fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ABTestOptionsProperty.class);
  }

 /**
  * Convert an instance of ABTestOptionsProperty to an JSON string
  *
  * @return JSON string
  */
