...
public class ABTestOptionsProperty2 {
  ...
  **/
  ...
  public ABTestOptionsProperty2 winnerCriteria(WinnerCriteriaEnum winnerCriteria) {
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The combination that performs the best. This may be determined automatically by click rate, open rate, or total revenue -- or you may choose manually based on the reporting data you find the most valuable. For Multivariate Campaigns testing send_time, winner_criteria is ignored. For Multivariate Campaigns with 'manual' as the winner_criteria, the winner must be chosen in the Mailchimp web application.")
  ...
  public ABTestOptionsProperty2 waitTime(Integer waitTime) {
  ...
  **/
  ...
  public ABTestOptionsProperty2 testSize(Integer testSize) {
  ...
  **/
  ...
  public ABTestOptionsProperty2 subjectLines(List<String> subjectLines) {
  ...
  public ABTestOptionsProperty2 addSubjectLinesItem(String subjectLinesItem) {
  ...
  **/
  ...
  public ABTestOptionsProperty2 sendTimes(List<OffsetDateTime> sendTimes) {
  ...
  public ABTestOptionsProperty2 addSendTimesItem(OffsetDateTime sendTimesItem) {
  ...
  **/
  ...
  public ABTestOptionsProperty2 fromNames(List<String> fromNames) {
  ...
  public ABTestOptionsProperty2 addFromNamesItem(String fromNamesItem) {
  ...
  **/
  ...
  public ABTestOptionsProperty2 replyToAddresses(List<String> replyToAddresses) {
  ...
  public ABTestOptionsProperty2 addReplyToAddressesItem(String replyToAddressesItem) {
  ...
  **/
   ...
   * @return the ABTestOptionsProperty2 instance itself
   */
  public ABTestOptionsProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ABTestOptionsProperty2 aBTestOptionsProperty2 = (ABTestOptionsProperty2) o;
    return Objects.equals(this.winningCombinationId, aBTestOptionsProperty2.winningCombinationId) &&
        Objects.equals(this.winningCampaignId, aBTestOptionsProperty2.winningCampaignId) &&
        Objects.equals(this.winnerCriteria, aBTestOptionsProperty2.winnerCriteria) &&
        Objects.equals(this.waitTime, aBTestOptionsProperty2.waitTime) &&
        Objects.equals(this.testSize, aBTestOptionsProperty2.testSize) &&
        Objects.equals(this.subjectLines, aBTestOptionsProperty2.subjectLines) &&
        Objects.equals(this.sendTimes, aBTestOptionsProperty2.sendTimes) &&
        Objects.equals(this.fromNames, aBTestOptionsProperty2.fromNames) &&
        Objects.equals(this.replyToAddresses, aBTestOptionsProperty2.replyToAddresses) &&
        Objects.equals(this.contents, aBTestOptionsProperty2.contents) &&
        Objects.equals(this.combinations, aBTestOptionsProperty2.combinations)&&
        Objects.equals(this.additionalProperties, aBTestOptionsProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ABTestOptionsProperty2 {\n");
  ...
  static {
    ...
    openapiRequiredFields.add("winner_criteria");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ABTestOptionsProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ABTestOptionsProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ABTestOptionsProperty2 is not found in the empty JSON string", ABTestOptionsProperty2.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ABTestOptionsProperty2.openapiRequiredFields) {
      ...
      if (!jsonObj.get("winner_criteria").isJsonPrimitive()) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ABTestOptionsProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ABTestOptionsProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ABTestOptionsProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ABTestOptionsProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<ABTestOptionsProperty2>() {
           @Override
           public void write(JsonWriter out, ABTestOptionsProperty2 value) throws IOException {
           ...
           @Override
           public ABTestOptionsProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ABTestOptionsProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ABTestOptionsProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ABTestOptionsProperty2
  * @throws IOException if the JSON string is invalid with respect to ABTestOptionsProperty2
  */
  public static ABTestOptionsProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ABTestOptionsProperty2.class);
  }

 /**
  * Convert an instance of ABTestOptionsProperty2 to an JSON string
  *
  * @return JSON string
  */
