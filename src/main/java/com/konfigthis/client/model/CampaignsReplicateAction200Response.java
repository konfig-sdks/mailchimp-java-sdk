...
import com.konfigthis.client.model.ABTestOptionsProperty2;
...
import com.konfigthis.client.model.CampaignReportSummaryProperty3;
import com.konfigthis.client.model.CampaignSettingsProperty5;
...
import com.konfigthis.client.model.ListProperty24;
import com.konfigthis.client.model.RSSOptionsProperty3;
...
public class CampaignsReplicateAction200Response {
 ...
 public enum StatusEnum {
  ...
  private ListProperty24 recipients;

  public static final String SERIALIZED_NAME_SETTINGS = "settings";
  @SerializedName(SERIALIZED_NAME_SETTINGS)
  private CampaignSettingsProperty5 settings;
  ...
  private ABTestOptionsProperty2 variateSettings;
  ...
  private RSSOptionsProperty3 rssOpts;
  ...
  private CampaignReportSummaryProperty3 reportSummary;
  ...
  public CampaignsReplicateAction200Response() {
  }
  ...
  **/
  ...
  public CampaignsReplicateAction200Response type(TypeEnum type) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "The link to the campaign's archive version.")
  ...
  **/
  ...
  public CampaignsReplicateAction200Response recipients(ListProperty24 recipients) {
  ...
  **/
  ...
  public ListProperty24 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty24 recipients) {
  ...
  public CampaignsReplicateAction200Response settings(CampaignSettingsProperty5 settings) {
  ...
  **/
  ...
  public CampaignSettingsProperty5 getSettings() {
    return settings;
  }


  public void setSettings(CampaignSettingsProperty5 settings) {
  ...
  public CampaignsReplicateAction200Response variateSettings(ABTestOptionsProperty2 variateSettings) {
  ...
  **/
  ...
  public ABTestOptionsProperty2 getVariateSettings() {
    return variateSettings;
  }


  public void setVariateSettings(ABTestOptionsProperty2 variateSettings) {
  ...
  public CampaignsReplicateAction200Response tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public CampaignsReplicateAction200Response rssOpts(RSSOptionsProperty3 rssOpts) {
  ...
  **/
  ...
  public RSSOptionsProperty3 getRssOpts() {
    return rssOpts;
  }


  public void setRssOpts(RSSOptionsProperty3 rssOpts) {
  ...
  public CampaignsReplicateAction200Response abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public CampaignsReplicateAction200Response socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public CampaignsReplicateAction200Response reportSummary(CampaignReportSummaryProperty3 reportSummary) {
  ...
  **/
  ...
  public CampaignReportSummaryProperty3 getReportSummary() {
    return reportSummary;
  }


  public void setReportSummary(CampaignReportSummaryProperty3 reportSummary) {
  ...
  public CampaignsReplicateAction200Response deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
   ...
   * @return the CampaignsReplicateAction200Response instance itself
   */
  public CampaignsReplicateAction200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CampaignsReplicateAction200Response campaignsReplicateAction200Response = (CampaignsReplicateAction200Response) o;
    return Objects.equals(this.id, campaignsReplicateAction200Response.id) &&
        Objects.equals(this.webId, campaignsReplicateAction200Response.webId) &&
        Objects.equals(this.parentCampaignId, campaignsReplicateAction200Response.parentCampaignId) &&
        Objects.equals(this.type, campaignsReplicateAction200Response.type) &&
        Objects.equals(this.createTime, campaignsReplicateAction200Response.createTime) &&
        Objects.equals(this.archiveUrl, campaignsReplicateAction200Response.archiveUrl) &&
        Objects.equals(this.longArchiveUrl, campaignsReplicateAction200Response.longArchiveUrl) &&
        Objects.equals(this.status, campaignsReplicateAction200Response.status) &&
        Objects.equals(this.emailsSent, campaignsReplicateAction200Response.emailsSent) &&
        Objects.equals(this.sendTime, campaignsReplicateAction200Response.sendTime) &&
        Objects.equals(this.contentType, campaignsReplicateAction200Response.contentType) &&
        Objects.equals(this.needsBlockRefresh, campaignsReplicateAction200Response.needsBlockRefresh) &&
        Objects.equals(this.resendable, campaignsReplicateAction200Response.resendable) &&
        Objects.equals(this.recipients, campaignsReplicateAction200Response.recipients) &&
        Objects.equals(this.settings, campaignsReplicateAction200Response.settings) &&
        Objects.equals(this.variateSettings, campaignsReplicateAction200Response.variateSettings) &&
        Objects.equals(this.tracking, campaignsReplicateAction200Response.tracking) &&
        Objects.equals(this.rssOpts, campaignsReplicateAction200Response.rssOpts) &&
        Objects.equals(this.abSplitOpts, campaignsReplicateAction200Response.abSplitOpts) &&
        Objects.equals(this.socialCard, campaignsReplicateAction200Response.socialCard) &&
        Objects.equals(this.reportSummary, campaignsReplicateAction200Response.reportSummary) &&
        Objects.equals(this.deliveryStatus, campaignsReplicateAction200Response.deliveryStatus) &&
        Objects.equals(this.links, campaignsReplicateAction200Response.links)&&
        Objects.equals(this.additionalProperties, campaignsReplicateAction200Response.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, webId, parentCampaignId, type, createTime, archiveUrl, longArchiveUrl, status, emailsSent, sendTime, contentType, needsBlockRefresh, resendable, recipients, settings, variateSettings, tracking, rssOpts, abSplitOpts, socialCard, reportSummary, deliveryStatus, links, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CampaignsReplicateAction200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CampaignsReplicateAction200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CampaignsReplicateAction200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CampaignsReplicateAction200Response is not found in the empty JSON string", CampaignsReplicateAction200Response.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : CampaignsReplicateAction200Response.openapiRequiredFields) {
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty24.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
      // validate the optional field `settings`
      if (jsonObj.get("settings") != null && !jsonObj.get("settings").isJsonNull()) {
        CampaignSettingsProperty5.validateJsonObject(jsonObj.getAsJsonObject("settings"));
      }
      // validate the optional field `variate_settings`
      if (jsonObj.get("variate_settings") != null && !jsonObj.get("variate_settings").isJsonNull()) {
        ABTestOptionsProperty2.validateJsonObject(jsonObj.getAsJsonObject("variate_settings"));
      }
      ...
      if (jsonObj.get("rss_opts") != null && !jsonObj.get("rss_opts").isJsonNull()) {
        RSSOptionsProperty3.validateJsonObject(jsonObj.getAsJsonObject("rss_opts"));
      }
      ...
      if (jsonObj.get("report_summary") != null && !jsonObj.get("report_summary").isJsonNull()) {
        CampaignReportSummaryProperty3.validateJsonObject(jsonObj.getAsJsonObject("report_summary"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CampaignsReplicateAction200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CampaignsReplicateAction200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CampaignsReplicateAction200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CampaignsReplicateAction200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<CampaignsReplicateAction200Response>() {
           @Override
           public void write(JsonWriter out, CampaignsReplicateAction200Response value) throws IOException {
           ...
           @Override
           public CampaignsReplicateAction200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CampaignsReplicateAction200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CampaignsReplicateAction200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CampaignsReplicateAction200Response
  * @throws IOException if the JSON string is invalid with respect to CampaignsReplicateAction200Response
  */
  public static CampaignsReplicateAction200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CampaignsReplicateAction200Response.class);
  }

 /**
  * Convert an instance of CampaignsReplicateAction200Response to an JSON string
  *
  * @return JSON string
  */
