...
public class SegmentOptionsProperty17 {
 ...
 public enum MatchEnum {
  ...
  public SegmentOptionsProperty17() {
  }

  public SegmentOptionsProperty17 savedSegmentId(Integer savedSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty17 prebuiltSegmentId(String prebuiltSegmentId) {
  ...
  **/
  ...
  public SegmentOptionsProperty17 match(MatchEnum match) {
  ...
  **/
  ...
  public SegmentOptionsProperty17 conditions(List<Object> conditions) {
  ...
  public SegmentOptionsProperty17 addConditionsItem(Object conditionsItem) {
  ...
  **/
   ...
   * @return the SegmentOptionsProperty17 instance itself
   */
  public SegmentOptionsProperty17 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    SegmentOptionsProperty17 segmentOptionsProperty17 = (SegmentOptionsProperty17) o;
    return Objects.equals(this.savedSegmentId, segmentOptionsProperty17.savedSegmentId) &&
        Objects.equals(this.prebuiltSegmentId, segmentOptionsProperty17.prebuiltSegmentId) &&
        Objects.equals(this.match, segmentOptionsProperty17.match) &&
        Objects.equals(this.conditions, segmentOptionsProperty17.conditions)&&
        Objects.equals(this.additionalProperties, segmentOptionsProperty17.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class SegmentOptionsProperty17 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to SegmentOptionsProperty17
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!SegmentOptionsProperty17.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in SegmentOptionsProperty17 is not found in the empty JSON string", SegmentOptionsProperty17.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!SegmentOptionsProperty17.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'SegmentOptionsProperty17' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<SegmentOptionsProperty17> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(SegmentOptionsProperty17.class));

       return (TypeAdapter<T>) new TypeAdapter<SegmentOptionsProperty17>() {
           @Override
           public void write(JsonWriter out, SegmentOptionsProperty17 value) throws IOException {
           ...
           @Override
           public SegmentOptionsProperty17 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             SegmentOptionsProperty17 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of SegmentOptionsProperty17 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of SegmentOptionsProperty17
  * @throws IOException if the JSON string is invalid with respect to SegmentOptionsProperty17
  */
  public static SegmentOptionsProperty17 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, SegmentOptionsProperty17.class);
  }

 /**
  * Convert an instance of SegmentOptionsProperty17 to an JSON string
  *
  * @return JSON string
  */
