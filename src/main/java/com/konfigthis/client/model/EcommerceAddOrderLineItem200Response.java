...
public class EcommerceAddOrderLineItem200Response {
  ...
  public EcommerceAddOrderLineItem200Response() {
  }
  ...
  **/
  ...
  public EcommerceAddOrderLineItem200Response productId(String productId) {
  ...
  **/
  ...
  public EcommerceAddOrderLineItem200Response productVariantId(String productVariantId) {
  ...
  **/
  ...
  public EcommerceAddOrderLineItem200Response quantity(Integer quantity) {
  ...
  **/
  ...
  public EcommerceAddOrderLineItem200Response price(Double price) {
  ...
  public EcommerceAddOrderLineItem200Response price(Integer price) {
  ...
  **/
  ...
  public EcommerceAddOrderLineItem200Response discount(Double discount) {
  ...
  public EcommerceAddOrderLineItem200Response discount(Integer discount) {
  ...
  **/
   ...
   * @return the EcommerceAddOrderLineItem200Response instance itself
   */
  public EcommerceAddOrderLineItem200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EcommerceAddOrderLineItem200Response ecommerceAddOrderLineItem200Response = (EcommerceAddOrderLineItem200Response) o;
    return Objects.equals(this.id, ecommerceAddOrderLineItem200Response.id) &&
        Objects.equals(this.productId, ecommerceAddOrderLineItem200Response.productId) &&
        Objects.equals(this.productTitle, ecommerceAddOrderLineItem200Response.productTitle) &&
        Objects.equals(this.productVariantId, ecommerceAddOrderLineItem200Response.productVariantId) &&
        Objects.equals(this.productVariantTitle, ecommerceAddOrderLineItem200Response.productVariantTitle) &&
        Objects.equals(this.imageUrl, ecommerceAddOrderLineItem200Response.imageUrl) &&
        Objects.equals(this.quantity, ecommerceAddOrderLineItem200Response.quantity) &&
        Objects.equals(this.price, ecommerceAddOrderLineItem200Response.price) &&
        Objects.equals(this.discount, ecommerceAddOrderLineItem200Response.discount) &&
        Objects.equals(this.links, ecommerceAddOrderLineItem200Response.links)&&
        Objects.equals(this.additionalProperties, ecommerceAddOrderLineItem200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EcommerceAddOrderLineItem200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EcommerceAddOrderLineItem200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EcommerceAddOrderLineItem200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EcommerceAddOrderLineItem200Response is not found in the empty JSON string", EcommerceAddOrderLineItem200Response.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EcommerceAddOrderLineItem200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EcommerceAddOrderLineItem200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EcommerceAddOrderLineItem200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EcommerceAddOrderLineItem200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<EcommerceAddOrderLineItem200Response>() {
           @Override
           public void write(JsonWriter out, EcommerceAddOrderLineItem200Response value) throws IOException {
           ...
           @Override
           public EcommerceAddOrderLineItem200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EcommerceAddOrderLineItem200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EcommerceAddOrderLineItem200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EcommerceAddOrderLineItem200Response
  * @throws IOException if the JSON string is invalid with respect to EcommerceAddOrderLineItem200Response
  */
  public static EcommerceAddOrderLineItem200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EcommerceAddOrderLineItem200Response.class);
  }

 /**
  * Convert an instance of EcommerceAddOrderLineItem200Response to an JSON string
  *
  * @return JSON string
  */
