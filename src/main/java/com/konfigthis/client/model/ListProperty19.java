...
import com.konfigthis.client.model.SegmentOptionsProperty13;
...
public class ListProperty19 {
  ...
  private SegmentOptionsProperty13 segmentOpts;

  public ListProperty19() {
  }
  ...
  public ListProperty19 listId(String listId) {
  ...
  **/
  ...
  public ListProperty19 segmentOpts(SegmentOptionsProperty13 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty13 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty13 segmentOpts) {
   ...
   * @return the ListProperty19 instance itself
   */
  public ListProperty19 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty19 listProperty19 = (ListProperty19) o;
    return Objects.equals(this.listId, listProperty19.listId) &&
        Objects.equals(this.listIsActive, listProperty19.listIsActive) &&
        Objects.equals(this.listName, listProperty19.listName) &&
        Objects.equals(this.segmentText, listProperty19.segmentText) &&
        Objects.equals(this.recipientCount, listProperty19.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty19.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty19.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty19 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty19
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty19.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty19 is not found in the empty JSON string", ListProperty19.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty13.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty19.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty19' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty19> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty19.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty19>() {
           @Override
           public void write(JsonWriter out, ListProperty19 value) throws IOException {
           ...
           @Override
           public ListProperty19 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty19 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty19 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty19
  * @throws IOException if the JSON string is invalid with respect to ListProperty19
  */
  public static ListProperty19 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty19.class);
  }

 /**
  * Convert an instance of ListProperty19 to an JSON string
  *
  * @return JSON string
  */
