...
public class EventsProperty2 {
  ...
  public EventsProperty2() {
  }

  public EventsProperty2 subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty2 unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty2 profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty2 cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty2 upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty2 campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty2 instance itself
   */
  public EventsProperty2 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty2 eventsProperty2 = (EventsProperty2) o;
    return Objects.equals(this.subscribe, eventsProperty2.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty2.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty2.profile) &&
        Objects.equals(this.cleaned, eventsProperty2.cleaned) &&
        Objects.equals(this.upemail, eventsProperty2.upemail) &&
        Objects.equals(this.campaign, eventsProperty2.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty2.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty2 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty2
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty2.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty2 is not found in the empty JSON string", EventsProperty2.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty2.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty2' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty2> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty2.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty2>() {
           @Override
           public void write(JsonWriter out, EventsProperty2 value) throws IOException {
           ...
           @Override
           public EventsProperty2 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty2 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty2 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty2
  * @throws IOException if the JSON string is invalid with respect to EventsProperty2
  */
  public static EventsProperty2 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty2.class);
  }

 /**
  * Convert an instance of EventsProperty2 to an JSON string
  *
  * @return JSON string
  */
