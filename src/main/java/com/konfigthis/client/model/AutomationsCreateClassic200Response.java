...
public class AutomationsCreateClassic200Response {
 ...
 public enum StatusEnum {
  ...
  private ListProperty6 recipients;
  ...
  public AutomationsCreateClassic200Response() {
  }
  ...
  **/
  ...
  public AutomationsCreateClassic200Response recipients(ListProperty6 recipients) {
  ...
  **/
  ...
  public ListProperty6 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty6 recipients) {
  ...
  public AutomationsCreateClassic200Response settings(AutomationCampaignSettingsProperty1 settings) {
  ...
  **/
  ...
  public AutomationsCreateClassic200Response tracking(AutomationTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public AutomationsCreateClassic200Response triggerSettings(AutomationTriggerProperty1 triggerSettings) {
  ...
  **/
  ...
  public AutomationsCreateClassic200Response reportSummary(CampaignReportSummaryProperty reportSummary) {
  ...
  **/
   ...
   * @return the AutomationsCreateClassic200Response instance itself
   */
  public AutomationsCreateClassic200Response putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AutomationsCreateClassic200Response automationsCreateClassic200Response = (AutomationsCreateClassic200Response) o;
    return Objects.equals(this.id, automationsCreateClassic200Response.id) &&
        Objects.equals(this.createTime, automationsCreateClassic200Response.createTime) &&
        Objects.equals(this.startTime, automationsCreateClassic200Response.startTime) &&
        Objects.equals(this.status, automationsCreateClassic200Response.status) &&
        Objects.equals(this.emailsSent, automationsCreateClassic200Response.emailsSent) &&
        Objects.equals(this.recipients, automationsCreateClassic200Response.recipients) &&
        Objects.equals(this.settings, automationsCreateClassic200Response.settings) &&
        Objects.equals(this.tracking, automationsCreateClassic200Response.tracking) &&
        Objects.equals(this.triggerSettings, automationsCreateClassic200Response.triggerSettings) &&
        Objects.equals(this.reportSummary, automationsCreateClassic200Response.reportSummary) &&
        Objects.equals(this.links, automationsCreateClassic200Response.links)&&
        Objects.equals(this.additionalProperties, automationsCreateClassic200Response.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class AutomationsCreateClassic200Response {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AutomationsCreateClassic200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AutomationsCreateClassic200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AutomationsCreateClassic200Response is not found in the empty JSON string", AutomationsCreateClassic200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty6.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AutomationsCreateClassic200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AutomationsCreateClassic200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AutomationsCreateClassic200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AutomationsCreateClassic200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<AutomationsCreateClassic200Response>() {
           @Override
           public void write(JsonWriter out, AutomationsCreateClassic200Response value) throws IOException {
           ...
           @Override
           public AutomationsCreateClassic200Response read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AutomationsCreateClassic200Response instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AutomationsCreateClassic200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AutomationsCreateClassic200Response
  * @throws IOException if the JSON string is invalid with respect to AutomationsCreateClassic200Response
  */
  public static AutomationsCreateClassic200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AutomationsCreateClassic200Response.class);
  }

 /**
  * Convert an instance of AutomationsCreateClassic200Response to an JSON string
  *
  * @return JSON string
  */
