...
import com.konfigthis.client.model.SegmentOptionsProperty19;
...
public class ListProperty25 {
  ...
  private SegmentOptionsProperty19 segmentOpts;

  public ListProperty25() {
  }
  ...
  public ListProperty25 listId(String listId) {
  ...
  **/
  ...
  public ListProperty25 segmentOpts(SegmentOptionsProperty19 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty19 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty19 segmentOpts) {
   ...
   * @return the ListProperty25 instance itself
   */
  public ListProperty25 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty25 listProperty25 = (ListProperty25) o;
    return Objects.equals(this.listId, listProperty25.listId) &&
        Objects.equals(this.listName, listProperty25.listName) &&
        Objects.equals(this.segmentText, listProperty25.segmentText) &&
        Objects.equals(this.recipientCount, listProperty25.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty25.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty25.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty25 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty25
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty25.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty25 is not found in the empty JSON string", ListProperty25.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : ListProperty25.openapiRequiredFields) {
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty19.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty25.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty25' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty25> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty25.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty25>() {
           @Override
           public void write(JsonWriter out, ListProperty25 value) throws IOException {
           ...
           @Override
           public ListProperty25 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty25 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty25 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty25
  * @throws IOException if the JSON string is invalid with respect to ListProperty25
  */
  public static ListProperty25 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty25.class);
  }

 /**
  * Convert an instance of ListProperty25 to an JSON string
  *
  * @return JSON string
  */
