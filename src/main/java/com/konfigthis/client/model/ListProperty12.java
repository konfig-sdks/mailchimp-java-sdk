...
import com.konfigthis.client.model.SegmentOptionsProperty6;
...
public class ListProperty12 {
  ...
  private SegmentOptionsProperty6 segmentOpts;

  public ListProperty12() {
  }
  ...
  public ListProperty12 listId(String listId) {
  ...
  **/
  ...
  public ListProperty12 segmentOpts(SegmentOptionsProperty6 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty6 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty6 segmentOpts) {
   ...
   * @return the ListProperty12 instance itself
   */
  public ListProperty12 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListProperty12 listProperty12 = (ListProperty12) o;
    return Objects.equals(this.listId, listProperty12.listId) &&
        Objects.equals(this.listIsActive, listProperty12.listIsActive) &&
        Objects.equals(this.listName, listProperty12.listName) &&
        Objects.equals(this.segmentText, listProperty12.segmentText) &&
        Objects.equals(this.recipientCount, listProperty12.recipientCount) &&
        Objects.equals(this.segmentOpts, listProperty12.segmentOpts)&&
        Objects.equals(this.additionalProperties, listProperty12.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class ListProperty12 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListProperty12
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListProperty12.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListProperty12 is not found in the empty JSON string", ListProperty12.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty6.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListProperty12.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListProperty12' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListProperty12> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListProperty12.class));

       return (TypeAdapter<T>) new TypeAdapter<ListProperty12>() {
           @Override
           public void write(JsonWriter out, ListProperty12 value) throws IOException {
           ...
           @Override
           public ListProperty12 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListProperty12 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListProperty12 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListProperty12
  * @throws IOException if the JSON string is invalid with respect to ListProperty12
  */
  public static ListProperty12 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListProperty12.class);
  }

 /**
  * Convert an instance of ListProperty12 to an JSON string
  *
  * @return JSON string
  */
