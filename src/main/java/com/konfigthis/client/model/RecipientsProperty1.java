...
import com.konfigthis.client.model.SegmentOptionsProperty26;
...
public class RecipientsProperty1 {
  ...
  private SegmentOptionsProperty26 segmentOpts;

  public RecipientsProperty1() {
  }
  ...
  public RecipientsProperty1 listId(String listId) {
  ...
  **/
  ...
  public RecipientsProperty1 segmentOpts(SegmentOptionsProperty26 segmentOpts) {
  ...
  **/
  ...
  public SegmentOptionsProperty26 getSegmentOpts() {
    return segmentOpts;
  }


  public void setSegmentOpts(SegmentOptionsProperty26 segmentOpts) {
   ...
   * @return the RecipientsProperty1 instance itself
   */
  public RecipientsProperty1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    RecipientsProperty1 recipientsProperty1 = (RecipientsProperty1) o;
    return Objects.equals(this.listId, recipientsProperty1.listId) &&
        Objects.equals(this.listIsActive, recipientsProperty1.listIsActive) &&
        Objects.equals(this.listName, recipientsProperty1.listName) &&
        Objects.equals(this.segmentText, recipientsProperty1.segmentText) &&
        Objects.equals(this.recipientCount, recipientsProperty1.recipientCount) &&
        Objects.equals(this.segmentOpts, recipientsProperty1.segmentOpts)&&
        Objects.equals(this.additionalProperties, recipientsProperty1.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class RecipientsProperty1 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to RecipientsProperty1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RecipientsProperty1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RecipientsProperty1 is not found in the empty JSON string", RecipientsProperty1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("segment_opts") != null && !jsonObj.get("segment_opts").isJsonNull()) {
        SegmentOptionsProperty26.validateJsonObject(jsonObj.getAsJsonObject("segment_opts"));
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RecipientsProperty1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RecipientsProperty1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RecipientsProperty1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RecipientsProperty1.class));

       return (TypeAdapter<T>) new TypeAdapter<RecipientsProperty1>() {
           @Override
           public void write(JsonWriter out, RecipientsProperty1 value) throws IOException {
           ...
           @Override
           public RecipientsProperty1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             RecipientsProperty1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of RecipientsProperty1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RecipientsProperty1
  * @throws IOException if the JSON string is invalid with respect to RecipientsProperty1
  */
  public static RecipientsProperty1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RecipientsProperty1.class);
  }

 /**
  * Convert an instance of RecipientsProperty1 to an JSON string
  *
  * @return JSON string
  */
