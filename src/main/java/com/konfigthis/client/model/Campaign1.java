...
import com.konfigthis.client.model.ListProperty16;
...
public class Campaign1 {
 ...
 public enum ContentTypeEnum {
  ...
  private ListProperty16 recipients;
  ...
  **/
  ...
  public Campaign1 recipients(ListProperty16 recipients) {
  ...
  **/
  ...
  public ListProperty16 getRecipients() {
    return recipients;
  }


  public void setRecipients(ListProperty16 recipients) {
  ...
  public Campaign1 settings(CampaignSettingsProperty4 settings) {
  ...
  **/
  ...
  public Campaign1 variateSettings(ABTestOptionsProperty1 variateSettings) {
  ...
  **/
  ...
  public Campaign1 tracking(CampaignTrackingOptionsProperty tracking) {
  ...
  **/
  ...
  public Campaign1 rssOpts(RSSOptionsProperty2 rssOpts) {
  ...
  **/
  ...
  public Campaign1 abSplitOpts(ABTestingOptionsProperty abSplitOpts) {
  ...
  **/
  ...
  public Campaign1 socialCard(CampaignSocialCardProperty socialCard) {
  ...
  **/
  ...
  public Campaign1 reportSummary(CampaignReportSummaryProperty2 reportSummary) {
  ...
  **/
  ...
  public Campaign1 deliveryStatus(CampaignDeliveryStatusProperty deliveryStatus) {
  ...
  **/
  ...
  public Campaign1 resendShortcutEligibility(ResendShortcutEligibilityProperty resendShortcutEligibility) {
  ...
  **/
   ...
   * @return the Campaign1 instance itself
   */
  public Campaign1 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.id, campaign1.id) &&
        ...
        Objects.equals(this.resendShortcutEligibility, campaign1.resendShortcutEligibility) &&
        Objects.equals(this.links, campaign1.links)&&
        Objects.equals(this.additionalProperties, campaign1.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to Campaign1
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!Campaign1.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in Campaign1 is not found in the empty JSON string", Campaign1.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("recipients") != null && !jsonObj.get("recipients").isJsonNull()) {
        ListProperty16.validateJsonObject(jsonObj.getAsJsonObject("recipients"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!Campaign1.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'Campaign1' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<Campaign1> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(Campaign1.class));

       return (TypeAdapter<T>) new TypeAdapter<Campaign1>() {
           @Override
           public void write(JsonWriter out, Campaign1 value) throws IOException {
           ...
           @Override
           public Campaign1 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             Campaign1 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of Campaign1 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of Campaign1
  * @throws IOException if the JSON string is invalid with respect to Campaign1
  */
  public static Campaign1 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, Campaign1.class);
  }

 /**
  * Convert an instance of Campaign1 to an JSON string
  *
  * @return JSON string
  */
