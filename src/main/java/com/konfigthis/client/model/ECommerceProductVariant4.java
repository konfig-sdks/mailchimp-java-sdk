...
public class ECommerceProductVariant4 {
  ...
  public ECommerceProductVariant4() {
  }
  ...
  **/
  ...
  public ECommerceProductVariant4 price(Double price) {
  ...
  public ECommerceProductVariant4 price(Integer price) {
  ...
  **/
   ...
   * @return the ECommerceProductVariant4 instance itself
   */
  public ECommerceProductVariant4 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, eCommerceProductVariant4.title) &&
        Objects.equals(this.id, eCommerceProductVariant4.id) &&
        ...
        Objects.equals(this.createdAt, eCommerceProductVariant4.createdAt) &&
        Objects.equals(this.updatedAt, eCommerceProductVariant4.updatedAt) &&
        Objects.equals(this.links, eCommerceProductVariant4.links)&&
        Objects.equals(this.additionalProperties, eCommerceProductVariant4.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommerceProductVariant4
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommerceProductVariant4.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommerceProductVariant4 is not found in the empty JSON string", ECommerceProductVariant4.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommerceProductVariant4.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommerceProductVariant4' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommerceProductVariant4> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommerceProductVariant4.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommerceProductVariant4>() {
           @Override
           public void write(JsonWriter out, ECommerceProductVariant4 value) throws IOException {
           ...
           @Override
           public ECommerceProductVariant4 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommerceProductVariant4 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommerceProductVariant4 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommerceProductVariant4
  * @throws IOException if the JSON string is invalid with respect to ECommerceProductVariant4
  */
  public static ECommerceProductVariant4 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommerceProductVariant4.class);
  }

 /**
  * Convert an instance of ECommerceProductVariant4 to an JSON string
  *
  * @return JSON string
  */
