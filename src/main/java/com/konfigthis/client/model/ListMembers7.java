...
import com.konfigthis.client.model.SubscriberStatsProperty14;
...
public class ListMembers7 {
 ...
 public enum SmsSubscriptionStatusEnum {
  ...
  private SubscriberStatsProperty14 stats;
  ...
  public ListMembers7 tags(List<TagsPropertyInner> tags) {
  ...
  public ListMembers7 addTagsItem(TagsPropertyInner tagsItem) {
    if (this.tags == null) {
  ...
  **/
  ...
  public ListMembers7 emailAddress(String emailAddress) {
  ...
  **/
  ...
  public ListMembers7 emailType(String emailType) {
  ...
  **/
  ...
  public ListMembers7 status(StatusEnum status) {
  ...
  **/
  ...
  public ListMembers7 unsubscribeReason(String unsubscribeReason) {
  ...
  **/
  ...
  public ListMembers7 smsPhoneNumber(String smsPhoneNumber) {
  ...
  **/
  ...
  public ListMembers7 smsSubscriptionStatus(SmsSubscriptionStatusEnum smsSubscriptionStatus) {
  ...
  **/
  ...
  public ListMembers7 smsSubscriptionLastUpdated(String smsSubscriptionLastUpdated) {
  ...
  **/
  ...
  public ListMembers7 mergeFields(Map<String, Object> mergeFields) {
  ...
  public ListMembers7 putMergeFieldsItem(String key, Object mergeFieldsItem) {
  ...
  **/
  ...
  public ListMembers7 interests(Map<String, Boolean> interests) {
  ...
  public ListMembers7 putInterestsItem(String key, Boolean interestsItem) {
  ...
  **/
  ...
  public ListMembers7 stats(SubscriberStatsProperty14 stats) {
  ...
  **/
  ...
  public SubscriberStatsProperty14 getStats() {
    return stats;
  }


  public void setStats(SubscriberStatsProperty14 stats) {
  ...
  **/
  ...
  public ListMembers7 language(String language) {
  ...
  **/
  ...
  public ListMembers7 vip(Boolean vip) {
  ...
  **/
  ...
  public ListMembers7 location(LocationProperty2 location) {
  ...
  **/
  ...
  public ListMembers7 marketingPermissions(List<MarketingPermission1> marketingPermissions) {
  ...
  public ListMembers7 addMarketingPermissionsItem(MarketingPermission1 marketingPermissionsItem) {
  ...
  **/
  ...
  public ListMembers7 lastNote(NotesProperty lastNote) {
  ...
  **/
   ...
   * @return the ListMembers7 instance itself
   */
  public ListMembers7 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    ListMembers7 listMembers7 = (ListMembers7) o;
    return Objects.equals(this.tags, listMembers7.tags) &&
        Objects.equals(this.id, listMembers7.id) &&
        Objects.equals(this.emailAddress, listMembers7.emailAddress) &&
        Objects.equals(this.uniqueEmailId, listMembers7.uniqueEmailId) &&
        Objects.equals(this.contactId, listMembers7.contactId) &&
        Objects.equals(this.fullName, listMembers7.fullName) &&
        Objects.equals(this.webId, listMembers7.webId) &&
        Objects.equals(this.emailType, listMembers7.emailType) &&
        Objects.equals(this.status, listMembers7.status) &&
        Objects.equals(this.unsubscribeReason, listMembers7.unsubscribeReason) &&
        Objects.equals(this.consentsToOneToOneMessaging, listMembers7.consentsToOneToOneMessaging) &&
        Objects.equals(this.smsPhoneNumber, listMembers7.smsPhoneNumber) &&
        Objects.equals(this.smsSubscriptionStatus, listMembers7.smsSubscriptionStatus) &&
        Objects.equals(this.smsSubscriptionLastUpdated, listMembers7.smsSubscriptionLastUpdated) &&
        Objects.equals(this.mergeFields, listMembers7.mergeFields) &&
        Objects.equals(this.interests, listMembers7.interests) &&
        Objects.equals(this.stats, listMembers7.stats) &&
        Objects.equals(this.ipSignup, listMembers7.ipSignup) &&
        Objects.equals(this.timestampSignup, listMembers7.timestampSignup) &&
        Objects.equals(this.ipOpt, listMembers7.ipOpt) &&
        Objects.equals(this.timestampOpt, listMembers7.timestampOpt) &&
        Objects.equals(this.memberRating, listMembers7.memberRating) &&
        Objects.equals(this.lastChanged, listMembers7.lastChanged) &&
        Objects.equals(this.language, listMembers7.language) &&
        Objects.equals(this.vip, listMembers7.vip) &&
        Objects.equals(this.emailClient, listMembers7.emailClient) &&
        Objects.equals(this.location, listMembers7.location) &&
        Objects.equals(this.marketingPermissions, listMembers7.marketingPermissions) &&
        Objects.equals(this.lastNote, listMembers7.lastNote) &&
        Objects.equals(this.source, listMembers7.source) &&
        Objects.equals(this.tagsCount, listMembers7.tagsCount) &&
        Objects.equals(this.listId, listMembers7.listId) &&
        Objects.equals(this.links, listMembers7.links)&&
        Objects.equals(this.additionalProperties, listMembers7.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ListMembers7
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ListMembers7.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ListMembers7 is not found in the empty JSON string", ListMembers7.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("stats") != null && !jsonObj.get("stats").isJsonNull()) {
        SubscriberStatsProperty14.validateJsonObject(jsonObj.getAsJsonObject("stats"));
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ListMembers7.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ListMembers7' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ListMembers7> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ListMembers7.class));

       return (TypeAdapter<T>) new TypeAdapter<ListMembers7>() {
           @Override
           public void write(JsonWriter out, ListMembers7 value) throws IOException {
           ...
           @Override
           public ListMembers7 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ListMembers7 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ListMembers7 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ListMembers7
  * @throws IOException if the JSON string is invalid with respect to ListMembers7
  */
  public static ListMembers7 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ListMembers7.class);
  }

 /**
  * Convert an instance of ListMembers7 to an JSON string
  *
  * @return JSON string
  */
