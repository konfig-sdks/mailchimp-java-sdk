...
public class ECommercePromoRule {
  ...
  **/
   ...
   * @return the ECommercePromoRule instance itself
   */
  public ECommercePromoRule putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.title, eCommercePromoRule.title) &&
        Objects.equals(this.description, eCommercePromoRule.description) &&
        Objects.equals(this.id, eCommercePromoRule.id) &&
        ...
        Objects.equals(this.additionalProperties, eCommercePromoRule.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to ECommercePromoRule
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!ECommercePromoRule.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in ECommercePromoRule is not found in the empty JSON string", ECommercePromoRule.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!ECommercePromoRule.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'ECommercePromoRule' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<ECommercePromoRule> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(ECommercePromoRule.class));

       return (TypeAdapter<T>) new TypeAdapter<ECommercePromoRule>() {
           @Override
           public void write(JsonWriter out, ECommercePromoRule value) throws IOException {
           ...
           @Override
           public ECommercePromoRule read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             ECommercePromoRule instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of ECommercePromoRule given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of ECommercePromoRule
  * @throws IOException if the JSON string is invalid with respect to ECommercePromoRule
  */
  public static ECommercePromoRule fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, ECommercePromoRule.class);
  }

 /**
  * Convert an instance of ECommercePromoRule to an JSON string
  *
  * @return JSON string
  */
