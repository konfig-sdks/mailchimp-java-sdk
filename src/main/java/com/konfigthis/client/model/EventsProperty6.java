...
public class EventsProperty6 {
  ...
  public EventsProperty6() {
  }

  public EventsProperty6 subscribe(Boolean subscribe) {
  ...
  **/
  ...
  public EventsProperty6 unsubscribe(Boolean unsubscribe) {
  ...
  **/
  ...
  public EventsProperty6 profile(Boolean profile) {
  ...
  **/
  ...
  public EventsProperty6 cleaned(Boolean cleaned) {
  ...
  **/
  ...
  public EventsProperty6 upemail(Boolean upemail) {
  ...
  **/
  ...
  public EventsProperty6 campaign(Boolean campaign) {
  ...
  **/
   ...
   * @return the EventsProperty6 instance itself
   */
  public EventsProperty6 putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    EventsProperty6 eventsProperty6 = (EventsProperty6) o;
    return Objects.equals(this.subscribe, eventsProperty6.subscribe) &&
        Objects.equals(this.unsubscribe, eventsProperty6.unsubscribe) &&
        Objects.equals(this.profile, eventsProperty6.profile) &&
        Objects.equals(this.cleaned, eventsProperty6.cleaned) &&
        Objects.equals(this.upemail, eventsProperty6.upemail) &&
        Objects.equals(this.campaign, eventsProperty6.campaign)&&
        Objects.equals(this.additionalProperties, eventsProperty6.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class EventsProperty6 {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to EventsProperty6
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!EventsProperty6.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in EventsProperty6 is not found in the empty JSON string", EventsProperty6.openapiRequiredFields.toString()));
        }
      }
  }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!EventsProperty6.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'EventsProperty6' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<EventsProperty6> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(EventsProperty6.class));

       return (TypeAdapter<T>) new TypeAdapter<EventsProperty6>() {
           @Override
           public void write(JsonWriter out, EventsProperty6 value) throws IOException {
           ...
           @Override
           public EventsProperty6 read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             EventsProperty6 instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of EventsProperty6 given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of EventsProperty6
  * @throws IOException if the JSON string is invalid with respect to EventsProperty6
  */
  public static EventsProperty6 fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, EventsProperty6.class);
  }

 /**
  * Convert an instance of EventsProperty6 to an JSON string
  *
  * @return JSON string
  */
