...
public class BatchesStartOperationProcessResponse {
 ...
 public enum StatusEnum {
  ...
  public BatchesStartOperationProcessResponse() {
  }
  ...
  **/
   ...
   * @return the BatchesStartOperationProcessResponse instance itself
   */
  public BatchesStartOperationProcessResponse putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    BatchesStartOperationProcessResponse batchesStartOperationProcessResponse = (BatchesStartOperationProcessResponse) o;
    return Objects.equals(this.id, batchesStartOperationProcessResponse.id) &&
        Objects.equals(this.status, batchesStartOperationProcessResponse.status) &&
        Objects.equals(this.totalOperations, batchesStartOperationProcessResponse.totalOperations) &&
        Objects.equals(this.finishedOperations, batchesStartOperationProcessResponse.finishedOperations) &&
        Objects.equals(this.erroredOperations, batchesStartOperationProcessResponse.erroredOperations) &&
        Objects.equals(this.submittedAt, batchesStartOperationProcessResponse.submittedAt) &&
        Objects.equals(this.completedAt, batchesStartOperationProcessResponse.completedAt) &&
        Objects.equals(this.responseBodyUrl, batchesStartOperationProcessResponse.responseBodyUrl) &&
        Objects.equals(this.links, batchesStartOperationProcessResponse.links)&&
        Objects.equals(this.additionalProperties, batchesStartOperationProcessResponse.additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("class BatchesStartOperationProcessResponse {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to BatchesStartOperationProcessResponse
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!BatchesStartOperationProcessResponse.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in BatchesStartOperationProcessResponse is not found in the empty JSON string", BatchesStartOperationProcessResponse.openapiRequiredFields.toString()));
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!BatchesStartOperationProcessResponse.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'BatchesStartOperationProcessResponse' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<BatchesStartOperationProcessResponse> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(BatchesStartOperationProcessResponse.class));

       return (TypeAdapter<T>) new TypeAdapter<BatchesStartOperationProcessResponse>() {
           @Override
           public void write(JsonWriter out, BatchesStartOperationProcessResponse value) throws IOException {
           ...
           @Override
           public BatchesStartOperationProcessResponse read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             BatchesStartOperationProcessResponse instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of BatchesStartOperationProcessResponse given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of BatchesStartOperationProcessResponse
  * @throws IOException if the JSON string is invalid with respect to BatchesStartOperationProcessResponse
  */
  public static BatchesStartOperationProcessResponse fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, BatchesStartOperationProcessResponse.class);
  }

 /**
  * Convert an instance of BatchesStartOperationProcessResponse to an JSON string
  *
  * @return JSON string
  */
